...
`;function Yt(e,t,i){return W`
  ...
  `}function Xt(e){return Jt(e,W`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
  ...
  `}(t,i,r,{lines:d,picked:c,colorOf:l,typeByLine:p})}
        ${!a&&d.length?function(e,t){return!e.singleLine&&oi(t.lines,t.picked).length>=2}(i,{lines:d,picked:c})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,d=oi(o,a),c=e.line_directions??{},h=e.direction??null,p=e=>c[e]??h,u=(t,r)=>{const n={};for(const e of d){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(c))d.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=ai(n,e),r=p(e),a=i.has("H"),o=i.has("R"),d=1===i.size,c=0===i.size,h=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):bt(ni(n,i,e),l(i)));return W`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${li({label:l("H").short,active:"H"===r||null===r&&d&&a,disabled:!c&&!a,compact:!0,title:ni(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:h("H"),onClick:()=>u(e,"H")})}
              ${li({label:l("R").short,active:"R"===r||null===r&&d&&o,disabled:!c&&!o,compact:!0,title:ni(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:h("R"),onClick:()=>u(e,"R")})}
              ${li({label:"",icon:"mdi:swap-horizontal",active:null===r&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:h(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:h,picked:c,lines:d,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=oi(o,a),d=1===l.length?l[0]:void 0,c=e.direction??null,h=ai(n,d),p=h.has("H"),u=h.has("R"),f=1===h.size,g="H"===c||null===c&&f&&p,_="R"===c||null===c&&f&&u,m=null===c&&!f,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===h.size||h.has(e)?bt(ni(n,e,d),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,v=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${li({label:b("H"),active:g,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${li({label:b("R"),active:_,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?I:li({label:t.t("dir_both"),active:m,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
      ${v?W`<span class="wl-note">${v}</span>`:I}
    </div>
  `}(t,i,r,{triplets:h,picked:c,lines:d,dirStrings:u}):I}
        ${a?I:function(e,t,i,r){const{attrs:n,picked:a,colorOf:o,lines:s,dirStrings:l}=r,d=e.line_directions??{},c=e.direction??null,h=yt(n,{lines:s,picked:a,lineDirections:d,stopDirection:c});return h.length?W`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${h.map(r=>{const n=wt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.length?r.termini.join(" / "):"H"===r.direction||"R"===r.direction?l(r.direction).full:"",d=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),c=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(ri,r))};return W`
...
(t,i,r,{attrs:n,picked:c,colorOf:l,lines:d,dirStrings:u})}
      </div>
    </section>
  `}function li(e){return W`<button
    type="button"
  ...
  `}
    ...
    `}_renderStopHero(e,t,i,r){return W`<div class="hero-host">
      ...
      >
        ...
        ${this._config.show_departures&&this._config.max_departures>0?_.length?W`${m>0?W`<div class="stale-note" role="status" aria-live="polite">
    ...
    `}_renderEmptyState(e,t){if(t>0){const t=e.stale_since?Nt(e.stale_since,this._lang()):"";return W`<div class="empty stale" role="status" aria-live="polite">
    ...
    `}_renderElevatorDetail(e){const t=e.description||e.station||"",i=function(e){return e.split(/\s+-\s+/).map(e=>e.trim().replace(/\.$/,"")).filter(Boolean)}(t),r=e.reason||"",n=function(e){for(const[t,i]of Ct)if(t.test(e))return i;return Tt}(r),a=Nt(e.time_end,this._lang()),o=Boolean(r||a),s=this._expandedElevator.has(e.name);return W`
      <div
    ...
    `}_toggleElevator(e){this._expandedElevator=$t(this._expandedElevator,e)}_onExpanderKeydown(e,t,i){t&&("Enter"!==e.key&&" "!==e.key||(e.preventDefault(),i()))}_renderTrafficBanner(e){const t=new Set,i=[];for(const r of e)for(const e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),i.push(e));for(const e of this._debugTraffic)t.has(e.name)||(t.add(e.name),i.push(e));if(!i.length)return I;const r=mt(this.hass,this._config.entities.map(e=>e.entity));return W`
      <div class="alert-list">
    ...
    `}_renderTrafficItem(e,t){const i=this._config.line_colors,r=Array.isArray(e.related_lines)?e.related_lines:[],n=Pt(e.description_html||e.description||""),a=n.blocks.length>0||n.facts.length>0,o=Nt(e.time_end,this._lang()),s=Nt(e.time_last_update,this._lang()),l=Nt(e.time_created,this._lang()),d=s&&s!==l?s:"",c=Boolean(e.location||o||d),h=Boolean(a||c),p=this._expandedTraffic.has(e.name),u={alert:!0,expanded:p,"no-detail":!h},f=e.title||this._t("traffic_label");return W`
      <div
        class=${be(u)}
        role=${h?"button":"group"}
        tabindex=${h?"0":"-1"}
    ...
    `;return"hero"===e?W`<div
      ...
      >
        ...
        <div class="towards">
          ${m?W`<ha-icon class="type-icon" icon=${m} aria-hidden="true"></ha-icon>`:I}
          <div class="towards-rows">
            <span class="towards-name">${Fe(e.towards)}</span>${g?W`<span class="delay">${g}</span>`:I}
          </div>
        </div>
        ${h||c?W`<span class="row-end">
              ${h?W`<span class="row-platform"
                    >${this._t(hi(e.type))} ${h}</span
                  >`:I}
    ...
    `}_renderDevPaletteRow(e){return W`
      <div class="dev-pal-row">
        ...
        ${["dark","light"].map(t=>{const i=Kt(e.hex,t),r=ci.DEV_GROUNDS[t];return W`
            <div class="dev-pal-scheme" style="background: ${r};">
              <span class="dev-pal-scheme-label">${t}</span>
              ${ci.DEV_SURFACES.map(t=>{const n=function(e,t,i){const r=It(e),n=It(t);if(!r||!n)return null;const a=[0,1,2].map(e=>jt(Ft(r[e])*i+Ft(n[e])*(1-i)));return"#"+a.map(e=>Math.round(255*e).toString(16).padStart(2,"0")).join("")}(e.hex,r,t.ratio)??r,a=i?function(e,t){const i=It(e),r=It(t);if(!i||!r)return null;const n=Gt(i),a=Gt(r);return(Math.max(n,a)+.05)/(Math.min(n,a)+.05)}(i,n):null,o=null!==a&&a>=4.5;return W`
