...
`;function ti(e,t,i){return F`
  ...
  `}function ii(e,t){return F`
    <section class="wl-section">
      <header class="wl-section-header">
        <span class="wl-section-title">${e.title}</span>
        ${e.hint?F`<span class="wl-section-hint">${e.hint}</span>`:V}
      </header>
      <div class="wl-section-body">${t}</div>
    </section>
  `}function ri(e){return ii(e,F`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
    ...
    ></ha-form>`)}const ni={},ai=me(class extends we{constructor(e){if(super(e),e.type!==ge&&e.type!==fe&&e.type!==_e)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===j||t===V)return t;const i=e.element,r=e.name;if(e.type===ge){if(t===i[r])return j}else if(e.type===_e){if(!!t===i.hasAttribute(r))return j}else if(e.type===fe&&i.getAttribute(r)===t+"")return j;return((e,t=ni)=>{e._$AH=t})(e),t}});function oi(e){"Escape"!==e.key&&"Tab"!==e.key&&e.stopPropagation()}function si(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}const li=120;function di(e,t,i){const r=new Set;for(const n of e)n.direction===t&&(i&&n.line!==i||n.towards&&r.add(n.towards));return[...r].sort()}function ci(e,t,i,r){const n=function(e,t){return e?.states?.[t]?.attributes}(e,t.entity),a=!n,o=n?.stop_name||t.entity,s=n?.line_colors??{},l=Ge(e),d=e=>$t(e,i.lineColorOverrides,s,l,"#5b6470"),c=new Set(t.lines??[]),h=Lt(n),p=c.size?[...new Set([...h,...c])].sort():h,u=function(e){const t=[],i=new Set;for(const r of e?.departures??[]){const e=String(r.direction??""),n=`${r.line}|${e}|${r.towards}`;i.has(n)||(i.add(n),t.push({line:r.line,direction:e,towards:r.towards,type:r.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(n),f=new Map;for(const e of n?.departures??[])e.line&&e.type&&!f.has(e.line)&&f.set(e.line,e.type);const g=e=>({full:i.t("H"===e?"dir_h":"dir_r"),short:i.t("H"===e?"dir_h_short":"dir_r_short")});return F`
    <section class="wl-section">
      <header class="wl-section-header">
        ${i.total>1?F`<span class="wl-index" aria-hidden="true">${i.index}</span>`:V}
        <span class="wl-section-title">${o}</span>
      </header>
      <div class="wl-stop-body">
        ${a?function(e,t,i){return F`
  ...
  `}(t,i,r):V}
        ${function(e,t,i,r){const{lines:n,picked:a,colorOf:o,typeByLine:s}=r,l=a.size?t.et("lines_selected").replace("{n}",String(a.size)).replace("{total}",String(n.length)):t.et("lines_empty_means_all");return F`
    <div class="wl-group">
      <div class="wl-group-head">
        <span class="wl-label wl-label--grow">${t.et("lines_label")}</span>
        ${n.length?F`<span class="wl-note">${l}</span>`:V}
      </div>
      ${n.length?F`<div class="wl-chips">
            ${n.map(r=>{const n=t.singleLine?a.has(r):0===a.size||a.has(r),l=Ie(s.get(r));return F`<button
                type="button"
                class="wl-chip"
  ...
  `}(t,i,r,{lines:p,picked:c,colorOf:d,typeByLine:f})}
        ${!a&&p.length?function(e,t){return!e.singleLine&&Ct(t.lines,t.picked).length>=2}(i,{lines:p,picked:c})?function(e,t,i,r){const{attrs:n,triplets:a,picked:o,lines:s,colorOf:l,dirStrings:d}=r,c=Ct(s,o),h=e.line_directions??{},p=e.direction??null,u=e=>h[e]??p,f=(t,r)=>{const n={};for(const e of c){const i=e===t?r:u(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(h))c.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return F`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${c.map(e=>{const i=Tt(n,e),r=u(e),o=i.available.has("H"),s=i.available.has("R"),c=null!==i.oneWay,h=i.unknown,p=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):Et(di(a,i,e),d(i)));return F`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe(si(l(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${hi({label:d("H").short,active:"H"===r||null===r&&"H"===i.oneWay,disabled:!h&&!o,compact:!0,title:di(a,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:p("H"),onClick:()=>f(e,"H")})}
              ${hi({label:d("R").short,active:"R"===r||null===r&&"R"===i.oneWay,disabled:!h&&!s,compact:!0,title:di(a,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:p("R"),onClick:()=>f(e,"R")})}
              ${hi({label:"",icon:"mdi:swap-horizontal",active:null===r&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:p(null),onClick:()=>f(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{attrs:n,triplets:u,picked:c,lines:p,colorOf:d,dirStrings:g}):function(e,t,i,r){const{attrs:n,triplets:a,picked:o,lines:s,dirStrings:l}=r,d=Ct(s,o),c=1===d.length?d[0]:void 0,h=e.direction??null,p=Tt(n,c),u=p.available.has("H"),f=p.available.has("R"),g=null!==p.oneWay,_="H"===h||null===h&&"H"===p.oneWay,m="R"===h||null===h&&"R"===p.oneWay,w=null===h&&!g,b=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))d.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},v=e=>p.unknown||p.available.has(e)?Et(di(a,e,c),l(e)):`${l(e).short}: ${t.et("direction_not_served")}`,y=null!==p.oneWay&&1===d.length?t.et("direction_note_one_way").replace("{line}",d[0]??""):"";return F`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${hi({label:v("H"),active:_,disabled:!p.unknown&&!u,title:u||p.unknown?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>b("H")})}
        ${hi({label:v("R"),active:m,disabled:!p.unknown&&!f,title:f||p.unknown?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>b("R")})}
        ${t.singleLine?V:hi({label:t.t("dir_both"),active:w,disabled:g,title:g?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>b(null)})}
      </div>
      ${y?F`<span class="wl-note">${y}</span>`:V}
    </div>
  `}(t,i,r,{attrs:n,triplets:u,picked:c,lines:p,dirStrings:g}):V}
        ${a?V:function(e,t,i,r){const{attrs:n,picked:a,colorOf:o,lines:s,dirStrings:l}=r,d=e.line_directions??{},c=e.direction??null,h=Rt(n,{lines:s,picked:a,lineDirections:d,stopDirection:c});return h.length?F`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${h.map(r=>{const n=zt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.length?r.termini.join(" / "):"H"===r.direction||"R"===r.direction?l(r.direction).full:"",d=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),c=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(li,r))};return F`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${xe(si(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:V}(t,i,r,{attrs:n,picked:c,colorOf:d,lines:p,dirStrings:g})}
      </div>
    </section>
  `}function hi(e){return F`<button
    type="button"
...
let ui=class extends se{constructor(){super(...arguments),this._tab="stops",this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(vt({...this._config,entities:pi(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>function(e,t,i){const r=t.et(i);return r!==i?r:e?.localize?.(`ui.panel.lovelace.editor.card.generic.${i}`)||i}(this.hass,this._i18n,e.name),this._computeHelper=e=>{const{et:t}=this._i18n,i=this._config;return function(e,t,i){const r=i?.[t];if(void 0!==r)return r;const n=`${t}_helper`,a=e.et(n);return a===n?void 0:a}(this._i18n,e.name,{...i?.show_accessibility?{}:{accessibility_only:t("accessibility_only_requires")},...i?.show_delay?{}:{show_delay_colors:t("show_delay_colors_requires")},...(i?.entities.length??0)>=2?{}:{layout:t("layout_requires")}})}}setConfig(e){this._config=vt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>We(`${e}.${t}`,i),et:t=>{const r=`${e}.editor.${t}`,n=We(r,i);if(n!==r)return n;const a=`common.editor.${t}`,o=We(a,i);return o===a?t:o}}}("modern",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(vt({...this._config,...e}))}get _stopCallbacks(){return function(e,t){const i=(i,r)=>{const n=e();n&&t(n.map(e=>e.entity===i?r({...e}):e))};return{toggleLine:(e,t)=>i(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>i(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>i(e,e=>{const i={...e.walk_times??{}};return null===r?delete i[t]:i[t]=r,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e}),remove:i=>{const r=e();r&&t(r.filter(e=>e.entity!==i))}}}(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return V;const{et:e}=this._i18n;return F`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderMisc()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return F`
      <ha-form
        .hass=${this.hass}
    ...
    `:V}_renderBody(e,t){if(!e.length)return this._renderEmpty();if(t){const t=e[this._activeTab]??e[0];return F`${this._renderStop(t,this._activeTab)}`}return F`${e.map(e=>this._renderStop(e))}`}_renderEmpty(){const e=kt(this.hass).length?"no_entities_picked":"no_entities_available";return F`<div class="empty" role="status" aria-live="polite">${this._t(e)}</div>`}_renderTabs(e,t){return F`
      <div class="tabbar">
        <div class="tabs" role="tablist">
        ${e.map((i,r)=>{const n=this._attrs(i.entity),a=n.stop_name||n.friendly_name||i.entity,o=r===t;return F`<button
            type="button"
            role="tab"
            id=${`wl-tab-${r}`}
    ...
    `}_renderStopHero(e,t,i,r){return F`<div class="hero-host">
      ...
      <section
        ...
        aria-label=${n}
      >
        ${this._config.hide_header?V:this._renderStopHeader(e,r,n,g,v,c,p)}
        ${p&&h&&u?this._renderQrPanel(e.entity,n,h,v,this._qrOpenFor===e.entity):V}

        ${this._config.show_hero_metric&&g?this._renderStopHero(e,f,$,k):V}
        ${d?this._renderElevatorDetails(l):V}
        ${this._config.show_departures&&this._config.max_departures>0?_.length?F`${m>0?F`<div class="stale-note" role="status" aria-live="polite">
                      ${this._t("stale_feed_partial")}
                    </div>`:V}
                <ul class="dep-list" role="list" aria-label=${this._t("departures_list")}>
                  ${_.map((t,i)=>this._renderRow(t,e.entity,i))}
                </ul>`:this._renderEmptyState(i,m):V}
      </section>
    `}_renderEmptyState(e,t){if(t>0){const t=e.stale_since?Qt(e.stale_since,this._lang()):"";return F`<div class="empty stale" role="status" aria-live="polite">
        <div class="empty-title">${this._t("stale_feed")}</div>
        <div class="empty-detail">${this._t("stale_feed_detail")}</div>
        ${t?F`<div class="empty-meta">
              ${this._t("stale_feed_since",{time:t})}
            </div>`:V}
      </div>`}return F`<div class="empty" role="status" aria-live="polite">
      ${this._t(e.server_time?"betriebsschluss":"no_data")}
    </div>`}_renderElevatorDetails(e){return F`
      <div class="alert-list">
        ${e.map(e=>this._renderElevatorDetail(e))}
      </div>
    `}_renderElevatorDetail(e){const t=e.description||e.station||"",i=function(e){return e.split(/\s+-\s+/).map(e=>e.trim().replace(/\.$/,"")).filter(Boolean)}(t),r=e.reason||"",n=function(e){for(const[t,i]of qt)if(t.test(e))return i;return Bt}(r),a=Qt(e.time_end,this._lang()),o=Boolean(r||a),s=this._expandedElevator.has(e.name);return F`
      <div
          ...
          <div class="alert-summary">
            <div class="alert-title">
              <span lang="de" class="lift-path"
                >${i.map((e,t)=>F`${t?F`<span class="lift-path-sep" aria-hidden="true">›</span>`:V}<span>${e}</span>`)}</span
              >
            </div>
          </div>
          ${o?F`<div class="alert-detail">
                <div class="alert-detail-inner">
                  ${r?F`<div class="alert-desc lift-reason">
                        <ha-icon icon=${n} aria-hidden="true"></ha-icon>
                        <span lang="de">${r}</span>
                      </div>`:V}
                  ${a?F`<div class="alert-meta">
                        <span>${this._t("elevator_until")} ${a}</span>
                      </div>`:V}
                </div>
              </div>`:V}
        </div>
        ${o?F`<ha-icon class="alert-chevron" icon="mdi:chevron-down" aria-hidden="true"></ha-icon>`:V}
      </div>
    `}_toggleElevator(e){this._expandedElevator=Mt(this._expandedElevator,e)}_onExpanderKeydown(e,t,i){t&&("Enter"!==e.key&&" "!==e.key||(e.preventDefault(),i()))}_renderTrafficBanner(e){const t=new Set,i=[];for(const r of e)for(const e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),i.push(e));for(const e of this._debugTraffic)t.has(e.name)||(t.add(e.name),i.push(e));if(!i.length)return V;const r=At(this.hass,this._config.entities.map(e=>e.entity));return F`
      <div class="alert-list">
        ${i.map(e=>this._renderTrafficItem(e,r))}
      </div>
    `}_renderTrafficNotice(e){const t=e.blocks.reduce((e,t)=>"heading"===t.kind?e+1:e,0),i=t>1?e.blocks:e.blocks.filter(e=>"heading"!==e.kind);return F`
      <div class="alert-desc" lang="de">
        ${i.map(e=>"heading"===e.kind?F`<p class="alert-desc-heading">${e.text}</p>`:F`<p>${e.text}</p>`)}
        ${e.facts.length?F`<dl class="alert-facts">
              ${e.facts.map(e=>F`<div class="alert-fact">
                  <dt>
    ...
    `}_renderTrafficItem(e,t){const i=this._config.line_colors,r=Array.isArray(e.related_lines)?e.related_lines:[],n=Kt(e.description_html||e.description||""),a=n.blocks.length>0||n.facts.length>0,o=Qt(e.time_end,this._lang()),s=Qt(e.time_last_update,this._lang()),l=Qt(e.time_created,this._lang()),d=s&&s!==l?s:"",c=Boolean(e.location||o||d),h=Boolean(a||c),p=this._expandedTraffic.has(e.name),u={alert:!0,expanded:p,"no-detail":!h},f=e.title||this._t("traffic_label");return F`
      <div
        class=${be(u)}
        role=${h?"button":"group"}
        tabindex=${h?"0":"-1"}
      ...
      >
        ...
        <div class="alert-body">
          ...
          ${h?F`<div class="alert-detail">
                <div class="alert-detail-inner">
                  ${a?this._renderTrafficNotice(n):V}
                  ${c?F`<div class="alert-meta">
                        ${e.location?F`<span class="alert-location-chip">
                              <ha-icon icon="mdi:map-marker" aria-hidden="true"></ha-icon>${je(e.location)}
                            </span>`:V}
                        ${o?F`<span>${this._t("traffic_until")} ${o}</span>`:V}
                        ${d?F`<span>${this._t("traffic_updated")} ${d}</span>`:V}
                      </div>`:V}
                </div>
              </div>`:V}
        </div>
        ${h?F`<ha-icon class="alert-chevron" icon="mdi:chevron-down" aria-hidden="true"></ha-icon>`:V}
      </div>
    ...
    `}_renderHeroPanelForEntry(e,t){const{hasStopsAhead:i,rowKey:r,expanded:n,panelId:a}=this._expandState(e,t,"hero");return i?this._renderStopsAheadPanel("hero",e.stops_ahead,a,n,e.line||"?",r,t):V}_renderStopsAheadPanel(e,t,i,r,n,a,o){const s="hero"===e?"hero-detail":"dep-row-detail",l=be({[s]:!0,expanded:r}),d=r?"false":"true",c=F`
      <div class="${s}-inner">
    ...
    `;return"hero"===e?F`<div
      ...
      >
        ...
        <div class="towards">
          ${m?F`<ha-icon class="type-icon" icon=${m} aria-hidden="true"></ha-icon>`:V}
          <div class="towards-rows">
            <span class="towards-name">${je(e.towards)}</span>${g?F`<span class="delay">${g}</span>`:V}
          </div>
        </div>
        ${h||c?F`<span class="row-end">
              ${h?F`<span class="row-platform"
                    >${this._t(gi(e.type))} ${h}</span
                  >`:V}
              ${c?F`<span class="row-flags">
    ...
    `;return w?[$,this._renderStopsAheadPanel("row",e.stops_ahead,y,v,a,b,t)]:$}_renderStopAhead(e,t,i,r,n){const a=e.lines??[],o=this._isNightlineHour(),s=[],l=[];for(const e of a)/^U\d/.test(e)||o&&/^N\d/.test(e)?s.push(e):l.push(e);const d=this._transferKey(i,t),c=this._expandedTransfers.has(d),h={"stops-ahead-stop":!0,terminus:!!e.is_terminus,"transfers-expanded":c},p=s.length?F`<span class="stops-ahead-metros">
        ...
        </button>`:V,f=l.length&&c?F`<div class="stops-ahead-others">
            ${l.map(e=>F`<span
                class="stops-ahead-line-chip stops-ahead-line-chip--other"
                style=${xe(yt(e,r,n))}
                >${e}</span
              >`)}
          </div>`:V,g=l.length>0,_=g?this._t(c?"stops_ahead_other_hide":"stops_ahead_other_show",{count:l.length,stop:e.name}):"";return F`
      <li class=${be(h)}>
        <div
          class="stops-ahead-row"
          role=${g?"button":V}
          tabindex=${g?"0":V}
          aria-expanded=${g?c?"true":"false":V}
          aria-label=${g?_:V}
    ...
    `}_isDevMode(){try{if((window.location.search||"").includes("wl_debug=1"))return!0;if("1"===window.localStorage?.getItem("wl_debug"))return!0}catch(e){console.warn("[wiener-linien-austria-card] dev-mode probe failed (SSR/restricted ctx?)",e)}return!1}_renderDevModePanel(){return this._isDevMode()?F`
      <div class="dev-strip">
    ...
    `}_renderDevPaletteRow(e){return F`
      <div class="dev-pal-row">
        ...
        ${["dark","light"].map(t=>{const i=et(e.hex,t),r=fi.DEV_GROUNDS[t];return F`
            <div class="dev-pal-scheme" style="background: ${r};">
              <span class="dev-pal-scheme-label">${t}</span>
              ${fi.DEV_SURFACES.map(t=>{const n=function(e,t,i){const r=Je(e),n=Je(t);if(!r||!n)return null;const a=[0,1,2].map(e=>Ke(Ze(r[e])*i+Ze(n[e])*(1-i)));return"#"+a.map(e=>Math.round(255*e).toString(16).padStart(2,"0")).join("")}(e.hex,r,t.ratio)??r,a=i?function(e,t){const i=Je(e),r=Je(t);if(!i||!r)return null;const n=Xe(i),a=Xe(r);return(Math.max(n,a)+.05)/(Math.min(n,a)+.05)}(i,n):null,o=null!==a&&a>=4.5;return F`
