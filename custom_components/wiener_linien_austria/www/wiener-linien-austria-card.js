...
`,Ae="1.3.0",Se="#1b1464";var Ee={no_data:"Keine Abfahrten verfügbar",betriebsschluss:"Betriebsschluss",min:"Min",now:"Jetzt",platform_short_rail:"Gleis",platform_short_bus:"Steig",version_update:"Wiener Linien Austria wurde auf v{v} aktualisiert — bitte neu laden",version_reload:"Neu laden",no_entities_picked:"Keine Haltestelle ausgewählt",no_entities_available:"Keine Wiener-Linien-Sensoren gefunden",departures_list:"Kommende Abfahrten",barrier_free_title:"Barrierefrei zugänglich",disturbance_title:"Verkehrsbehinderung gemeldet",stops_ahead_aria_show:"Streckenverlauf für {line} Richtung {towards} anzeigen",stops_ahead_aria_hide:"Streckenverlauf für {line} Richtung {towards} ausblenden",stops_ahead_transfer_aria:"Umsteigen auf {lines}",stops_ahead_other_show:"{count} weitere Linien bei {stop} anzeigen",stops_ahead_other_hide:"Weitere Linien bei {stop} ausblenden",dir_h:"H",dir_r:"R",dir_both:"Beide",traffic_label:"Störung",traffic_until:"Bis",traffic_updated:"aktualisiert",elevator_label:"Aufzug außer Betrieb",elevator_until:"Bis",open_in_maps:"In Karte öffnen",delay_singular:"1 Minute verspätet",delay_plural:"{n} Minuten verspätet",devmode_title:"DEV",devmode_traffic_btn:"Test Störung",devmode_elevator_btn:"Test Aufzug",devmode_clear_btn:"Löschen",editor:{lines_label:"Linien",direction_label:"Richtung",per_line_direction_label:"Richtung pro Linie",per_line_direction_hint:"Optional: Richtung pro Linie einzeln festlegen. Beide = haltestellenweite Richtung oben verwenden.",per_line_direction_aria:"Richtung für Linie {line}",direction_unavailable:"Keine Abfahrten in dieser Richtung",walk_time_label:"Fußweg (min)",walk_time_hint:"Abfahrten ausblenden, die bereits weg wären, bis du dort bist. Leer lassen = kein Filter.",walk_time_branching_hint:"Gilt für alle Endstationen in dieser Richtung",walk_time_placeholder:"–",walk_time_aria:"Fußweg in Minuten für Linie {line} Richtung {towards}",section_colors:"Linienfarben",colors_hint:"Optional: Farben überschreiben. U-Bahn-Standardwerte sind gesetzt.",reset_color:"Zurücksetzen",pick_color_for_line:"Farbe für Linie {line} wählen",section_display:"Anzeige",max_departures:"Anzahl Abfahrten pro Haltestelle",show_accessibility:"Barrierefrei-Symbol anzeigen",accessibility_only:"Nur barrierefreie Abfahrten anzeigen",show_type_icon:"Verkehrsmittel-Symbol anzeigen",show_platform:"Steig/Gleis anzeigen",show_traffic_info:"Störungen anzeigen",show_elevator_info:"Aufzugsinfo anzeigen",show_delay:"Verspätungen anzeigen",show_hero_metric:"Hauptbereich anzeigen",show_departures:"Abfahrtsliste anzeigen",hide_header:"Kopfzeile ausblenden",hide_attribution:"Datenquelle ausblenden",layout_stacked:"Gestapelt",layout_tabs:"Reiter",no_lines_available:"Linien erscheinen hier, sobald Haltestellen ausgewählt wurden."}},ze={no_entity:"Keine Haltestelle ausgewählt",no_data:"Keine Abfahrten",no_data_wrong_direction:"Keine Abfahrten in dieser Richtung",no_data_wrong_line:"Keine Abfahrten für diese Linie",betriebsschluss:"Betriebsschluss",dir_h:"H",dir_r:"R",gleis:"GLEIS",steig:"STEIG",version_update:"Retro-Karte wurde auf v{v} aktualisiert — bitte neu laden",version_reload:"Neu laden",departures_list:"Kommende Abfahrten",at_platform:"Einfahrt",countdown_minutes:"{n} Minuten",race_finished:"Barrierefreiheits-Rennen beendet",race_starting_in:"Rennen startet in {n}",race_winner_announce:"Rollstuhl {n} gewinnt das Barrierefreiheits-Rennen",barrier_free_title:"Barrierefrei zugänglich",editor:{section_display:"Darstellung",section_walk_time:"Fußweg zur Haltestelle",walk_time_hint:"Abfahrten ausblenden, die bereits weg wären, bis du dort bist. Leer lassen = kein Filter.",walk_time_branching_hint:"Gilt für alle Endstationen in dieser Richtung",walk_time_no_data:"Keine Abfahrten in dieser Richtung. Richtung wechseln oder warten, bis der Sensor Linien meldet.",walk_time_placeholder:"–",walk_time_aria:"Fußweg in Minuten für Linie {line} Richtung {towards}",show_platform:"Gleis/Steig anzeigen",show_station_name:"Stationsnamen anzeigen",section_station:"Stationsnamen-Schild",station_bg_default:"Standard",station_bg_white:"Weiß",station_bg_black:"Schwarz",size_small:"Klein",size_medium:"Mittel",size_regular:"Normal",style_classic:"Klassisch",style_warm:"Warm",style_pixel:"Punktmatrix",accessibility_only:"Nur barrierefreie Abfahrten anzeigen"}},Te={modern:Ee,retro:ze},Ce={no_data:"No departures available",betriebsschluss:"End of service",min:"min",now:"Now",platform_short_rail:"Track",platform_short_bus:"Bay",version_update:"Wiener Linien Austria updated to v{v} — please reload",version_reload:"Reload",no_entities_picked:"No stop selected",no_entities_available:"No Wiener Linien sensors found",departures_list:"Upcoming departures",barrier_free_title:"Step-free access",disturbance_title:"Traffic disruption reported",stops_ahead_aria_show:"Show stops ahead for {line} towards {towards}",stops_ahead_aria_hide:"Hide stops ahead for {line} towards {towards}",stops_ahead_transfer_aria:"Change to {lines}",stops_ahead_other_show:"Show {count} more lines at {stop}",stops_ahead_other_hide:"Hide other lines at {stop}",dir_h:"H",dir_r:"R",dir_both:"Both",traffic_label:"Disruption",traffic_until:"Until",traffic_updated:"updated",elevator_label:"Elevator out of service",elevator_until:"Until",open_in_maps:"Open in maps",delay_singular:"1 minute late",delay_plural:"{n} minutes late",devmode_title:"DEV",devmode_traffic_btn:"Test disruption",devmode_elevator_btn:"Test elevator",devmode_clear_btn:"Clear",editor:{lines_label:"Lines",direction_label:"Direction",per_line_direction_label:"Per-line direction",per_line_direction_hint:"Optional: pick the direction for each line individually. Both = use the stop-wide direction above.",per_line_direction_aria:"Direction for line {line}",direction_unavailable:"No departures in this direction",walk_time_label:"Walking time (min)",walk_time_hint:"Hide departures that would already be gone by the time you reach the platform. Leave blank for no filter.",walk_time_branching_hint:"Applies to all termini in this direction",walk_time_placeholder:"–",walk_time_aria:"Walk time in minutes for line {line} towards {towards}",section_colors:"Line colours",colors_hint:"Optional overrides. Metro defaults are already set.",reset_color:"Reset",pick_color_for_line:"Pick colour for line {line}",section_display:"Display",max_departures:"Departures per stop",show_accessibility:"Show step-free icon",accessibility_only:"Only show step-free departures",show_type_icon:"Show vehicle-type icon",show_platform:"Show platform / track",show_traffic_info:"Show disruption alerts",show_elevator_info:"Show elevator outages",show_delay:"Show delays",show_hero_metric:"Show hero block",show_departures:"Show departure list",hide_header:"Hide header",hide_attribution:"Hide data source",layout_stacked:"Stacked",layout_tabs:"Tabs",no_lines_available:"Lines appear here once stops are selected."}},Re={no_entity:"No stop selected",no_data:"No departures",no_data_wrong_direction:"No departures in this direction",no_data_wrong_line:"No departures for this line",betriebsschluss:"End of service",dir_h:"H",dir_r:"R",gleis:"PLATF.",steig:"STAND",version_update:"Retro card updated to v{v} — please reload",version_reload:"Reload",departures_list:"Upcoming departures",at_platform:"At platform",countdown_minutes:"{n} minutes",race_finished:"Accessibility race finished",race_starting_in:"Race starting in {n}",race_winner_announce:"Wheelchair {n} wins the accessibility race",barrier_free_title:"Step-free access",editor:{section_display:"Display",section_walk_time:"Walking time to stop",walk_time_hint:"Hide departures that would already be gone by the time you reach the platform. Leave blank for no filter.",walk_time_branching_hint:"Applies to all termini in this direction",walk_time_no_data:"No departures in this direction. Switch direction or wait until the sensor reports lines.",walk_time_placeholder:"–",walk_time_aria:"Walk time in minutes for line {line} towards {towards}",show_platform:"Show platform",show_station_name:"Show station name",section_station:"Station name sign",station_bg_default:"Default",station_bg_white:"White",station_bg_black:"Black",size_small:"Small",size_medium:"Medium",size_regular:"Regular",style_classic:"Classic",style_warm:"Warm",style_pixel:"Dot matrix",accessibility_only:"Only show step-free departures"}},He={modern:Ce,retro:Re};const Ne={de:Object.freeze({__proto__:null,default:Te,modern:Ee,retro:ze}),en:Object.freeze({__proto__:null,default:He,modern:Ce,retro:Re})},Me=Ne.de??{};function De(e,t){const i=function(e,t){return e.split(".").reduce((e,t)=>{if(e&&"object"==typeof e&&t in e)return e[t]},t)}(e,t);return"string"==typeof i?i:void 0}function Pe(e,t,i){const r=function(e){return"en"===((e.configLanguage||e.hassLanguage||"de").replace("-","_").split("_")[0]??"de")?"en":"de"}(t);let n=De(e,Ne[r]??Me);if(void 0===n&&(n=De(e,Me)),void 0===n)return e;if(i)for(const[e,t]of Object.entries(i))n=n.replace(`{${e}}`,String(t));return n}function Le(){try{window.caches?.keys?.().then(e=>{e.forEach(e=>window.caches?.delete?.(e))})}catch{}window.location.reload()}function Ue(e,t,i="banner"){if(!e)return K;const r=t("version_update").replace("{v}",e),n=t("version_reload");return I`
  ...
  `}const Oe="ptMetro";function je(e){switch(e){case Oe:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}function Be(e){if("string"==typeof e)return e.startsWith("sensor.")?{entity:e}:null;if(!e||"object"!=typeof e)return null;const t=e,i="string"==typeof t.entity?t.entity:null;if(!i?.startsWith("sensor."))return null;const r={entity:i};if(Array.isArray(t.lines)){const e=t.lines.filter(e=>"string"==typeof e&&e.length>0);e.length&&(r.lines=e)}"H"!==t.direction&&"R"!==t.direction||(r.direction=t.direction);const n=function(e){if(!e||"object"!=typeof e)return;const t={};for(const[i,r]of Object.entries(e))"string"==typeof i&&i.length&&("H"!==r&&"R"!==r||(t[i]=r));return Object.keys(t).length?t:void 0}(t.line_directions);n&&(r.line_directions=n);const s=function(e){if(!e||"object"!=typeof e)return;const t={};for(const[i,r]of Object.entries(e)){const e="number"==typeof r?r:"string"==typeof r?Number(r):NaN;if(!Number.isFinite(e))continue;if(e<0||e>120)continue;const n=i.split("|"),s=n.length>=3?`${n[0]}|${n[1]}`:i,a=Math.round(e),o=t[s];t[s]=void 0===o?a:Math.max(o,a)}return Object.keys(t).length?t:void 0}(t.walk_times);return s&&(r.walk_times=s),r}const We=6,Ie=!1,Fe=!1,Ke=!0,Ge=!0,Ve=!0,qe=!1,Ye=!0,Ze=!0,Je=!0,Qe=!1,Xe=!1;function et(e){let t=[];Array.isArray(e.entities)?t=e.entities:"string"==typeof e.entity&&(t=[{entity:e.entity,lines:e.lines,direction:e.direction,walk_times:e.walk_times}]);const i=[],r=new Set;for(const e of t){const t=Be(e);t&&(r.has(t.entity)||(r.add(t.entity),i.push(t)))}const n=Number(e.max_departures),s=Number.isFinite(n)?Math.max(0,Math.min(20,Math.round(n))):We,a={};if(e.line_colors&&"object"==typeof e.line_colors)for(const[t,i]of Object.entries(e.line_colors))"string"==typeof i&&/^#[0-9A-Fa-f]{3,8}$/.test(i.trim())&&(a[t.toUpperCase()]=i.trim());return{...e,type:e.type||"custom:wiener-linien-austria-card",entities:i,max_departures:s,line_colors:a,show_accessibility:e.show_accessibility??Ie,accessibility_only:e.accessibility_only??Fe,show_traffic_info:e.show_traffic_info??Ke,show_elevator_info:e.show_elevator_info??Ge,show_delay:e.show_delay??Ve,show_type_icon:e.show_type_icon??qe,show_platform:e.show_platform??Ye,show_hero_metric:e.show_hero_metric??Ze,show_departures:e.show_departures??Je,hide_header:e.hide_header??Qe,hide_attribution:e.hide_attribution??Xe,layout:"tabs"===e.layout?"tabs":"stacked"}}function tt(e,t,i={},r="var(--primary-color)"){const n=e.toUpperCase();if(void 0!==t[n])return t[n];const s=i[e]??i[n];return s?.bg?`#${s.bg}`:/^N\d/.test(n)?Se:r}function it(e,t,i={}){const r=e.toUpperCase();if(void 0!==t[r])return{background:t[r]};const n=i[e]??i[r];return n?.bg?n.fg?{background:`#${n.bg}`,color:`#${n.fg}`}:{background:`#${n.bg}`}:/^N\d/.test(r)?{background:Se,color:"#fef200"}:{background:"var(--primary-color)"}}function rt(e){if(!e)return[];const t=[];for(const[i,r]of Object.entries(e.states??{})){if(!i.startsWith("sensor."))continue;const e=r?.attributes??{};if("number"!=typeof e.diva)continue;if(!Array.isArray(e.departures))continue;(e.attribution??"").toLowerCase().includes("wiener linien")&&t.push(i)}return t.sort(),t}function nt(e,t,i){return`${e}|${t}|${i}`}function st(e,t){return`${e}|${t}`}function at(e){const t=new Set;for(const i of e?.departures??[])i.line&&t.add(i.line);return Array.from(t).sort()}function ot(e){return function(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}(e).replace(/&lt;br\s*\/?&gt;/gi,"<br>")}function lt(e,t="de"){if(!e)return"";const i=Date.parse(e);if(!Number.isFinite(i))return e;try{return new Date(i).toLocaleString("en"===t?"en-GB":"de-AT",{hour:"2-digit",minute:"2-digit",day:"2-digit",month:"2-digit"})}catch{return e}}const dt=a`
  :host {
    display: block;
  }
  .editor {
...
let ct=class extends oe{constructor(){super(...arguments),this._computeLabel=e=>{const t=`ui.panel.lovelace.editor.card.generic.${e.name}`,i=this.hass?.localize?.(t);if(i)return i;const r=this._et(e.name);return r!==`modern.editor.${e.name}`&&r!==e.name?r:e.name},this._computeHelper=e=>{const t=`${e.name}_helper`,i=this._et(t);if(i!==`modern.editor.${t}`&&i!==t)return i},this._onFormChanged=e=>{if(!this._config)return;const t=e.detail.value,i=t.entities,r=Array.isArray(i)?i.filter(e=>"string"==typeof e&&e.length>0):[],n=new Map;for(const e of this._config.entities)n.set(e.entity,e);const s=r.map(e=>n.get(e)??{entity:e}),a=et({...this._config,...t,entities:s});this._fire(a)}}setConfig(e){this._config=et(e)}_et(e){return Pe(`modern.editor.${e}`,{hassLanguage:this.hass?.language})}_t(e){return Pe(`modern.${e}`,{hassLanguage:this.hass?.language})}_fire(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_schema(){return[{name:"entities",required:!0,selector:{entity:{domain:"sensor",integration:"wiener_linien_austria",multiple:!0}}},{name:"layout",selector:{select:{mode:"dropdown",options:[{value:"stacked",label:this._et("layout_stacked")},{value:"tabs",label:this._et("layout_tabs")}]}}},{type:"expandable",name:"display",title:this._et("section_display"),flatten:!0,schema:[{name:"max_departures",selector:{number:{min:0,max:20,step:1,mode:"slider"}}},{name:"hide_header",selector:{boolean:{}}},{name:"show_hero_metric",selector:{boolean:{}}},{name:"show_departures",selector:{boolean:{}}},{name:"show_platform",selector:{boolean:{}}},{name:"show_accessibility",selector:{boolean:{}}},{name:"accessibility_only",selector:{boolean:{}}},{name:"show_type_icon",selector:{boolean:{}}},{name:"show_traffic_info",selector:{boolean:{}}},{name:"show_elevator_info",selector:{boolean:{}}},{name:"show_delay",selector:{boolean:{}}},{name:"hide_attribution",selector:{boolean:{}}}]}]}_formData(){if(!this._config)return{};const e=this._config.entities.map(e=>e.entity);return{...this._config,entities:e}}_updateStop(e,t){if(!this._config)return;const i=this._config.entities.map(i=>i.entity===e?t({...i}):i);this._fire({...this._config,entities:i})}_toggleLine(e,t){this._updateStop(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size>0?e.lines=[...i]:delete e.lines,e})}_setDirection(e,t){this._updateStop(e,e=>(null===t?delete e.direction:e.direction=t,e))}_setLineDirection(e,t,i){this._updateStop(e,e=>{const r={...e.line_directions??{}};return null===i?delete r[t]:r[t]=i,Object.keys(r).length?e.line_directions=r:delete e.line_directions,e})}_setWalkTime(e,t,i){const r=parseInt(i,10),n=Number.isFinite(r)&&r>0?Math.min(120,r):null;this._updateStop(e,e=>{const i={...e.walk_times??{}};return null===n?delete i[t]:i[t]=n,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e})}_setLineColor(e,t){if(!this._config)return;const i={...this._config.line_colors,[e.toUpperCase()]:t};this._fire({...this._config,line_colors:i})}_resetLineColor(e){if(!this._config)return;const t={...this._config.line_colors};delete t[e.toUpperCase()],this._fire({...this._config,line_colors:t})}_swallowKeys(e){e.stopPropagation()}_attrs(e){return this.hass?.states?.[e]?.attributes}render(){return this._config?I`
    ...
    `:K}_renderPerStopSections(){const e=this._config;return e.entities.length?I`${e.entities.map(e=>this._renderStopFilter(e))}`:K}_renderStopFilter(e){const t=this._attrs(e.entity);if(!t)return I``;const i=t.stop_name||e.entity,r=this._config.line_colors,n=t.line_colors??{},s=[...new Set((t.departures??[]).map(e=>e.line).filter(e=>!!e))].sort(),a=new Set(e.lines??[]),o=e.direction??null,l=e.line_directions??{},d=a.size>0?s.filter(e=>a.has(e)):s,c=d.length>=2,h=function(e){const t=[],i=new Set;for(const r of e?.departures??[]){const e=nt(r.line,String(r.direction??""),r.towards);i.has(e)||(i.add(e),t.push({line:r.line,direction:String(r.direction??""),towards:r.towards,type:r.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(t),p=h.filter(e=>{if(a.size>0&&!a.has(e.line))return!1;const t=l[e.line]??o;return!t||e.direction===t}),u=new Set;for(const e of h)"H"!==e.direction&&"R"!==e.direction||u.add(e.direction);const f=u.has("H"),_=u.has("R"),g=1===u.size,m="H"===o||null===o&&g&&f,b="R"===o||null===o&&g&&_,w=null===o&&!g;return I`
      <div class="stop-filter">
        ...
        <div class="stop-filter-row">
          ...
          <div class="line-chips">
            ${s.length?s.map(t=>{const i=0===a.size||a.has(t),s=tt(t,r,n),o=i?{background:s,borderColor:s,color:"#fff"}:{};return I`<button
                    type="button"
                    class=${ve({chip:!0,selected:i})}
                    style=${xe(o)}
                    @click=${()=>this._toggleLine(e.entity,t)}
                  >${t}</button>`}):I`<div class="editor-hint">${this._et("no_lines_available")}</div>`}
          </div>
        </div>
        ...
        ${c?I`
              <div class="stop-filter-row">
                ...
                <div class="per-line-dir-list">
                  ${d.map(t=>{const i=tt(t,r,n),s=l[t]??null,a=(e=>{const t=new Set;for(const i of h)i.line===e&&("H"!==i.direction&&"R"!==i.direction||t.add(i.direction));return t})(t),o=a.has("H"),d=a.has("R"),c=1===a.size,p="H"===s||null===s&&c&&o,u="R"===s||null===s&&c&&d,f=null===s&&!c,_=this._et("per_line_direction_aria").replace("{line}",t),g=this._et("direction_unavailable");return I`
    ...
    `}_renderWalkTimes(e,t,i,r){const n=this._config.line_colors,s=this._attrs(e.entity),a=s?.line_colors??{},o=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),r=st(i.line,e);let n=t.get(r);n||(n={line:i.line,direction:e,type:i.type,termini:[]},t.set(r,n)),i.towards&&!n.termini.includes(i.towards)&&n.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(s),l=new Set(e.lines??[]),d=o.filter(e=>{if(l.size>0&&!l.has(e.line))return!1;const t=r[e.line]??i;return!t||e.direction===t});return d.length?I`
      <div class="stop-filter-row">
        ...
        <div class="walk-time-list">
          ${d.map(t=>{const i=tt(t.line,n,a),r=st(t.line,t.direction),s=e.walk_times?.[r],o=t.termini.join(" / "),l=o?`→ ${o}`:"",d=t.termini.length>1?this._et("walk_time_branching_hint"):"";return I`
    ...
    `:K}_renderColorsSection(){const e=this._config,t=function(e,t){const i=new Set;for(const r of t){const t=e?.states?.[r]?.attributes;for(const e of at(t))i.add(e)}return Array.from(i).sort()}(this.hass,e.entities.map(e=>e.entity)),i=e.line_colors;let r={};for(const t of e.entities){const e=this.hass?.states?.[t.entity]?.attributes;if(e?.line_colors&&Object.keys(e.line_colors).length){r=e.line_colors;break}}return I`
      <div class="editor-section">
        <div class="section-header">${this._et("section_colors")}</div>
        <div class="editor-hint">${this._et("colors_hint")}</div>
        ${t.length?t.map(e=>{const t=tt(e,i,r,"#888888"),n=t.startsWith("#")?t:"#888888",s=Boolean(i[e.toUpperCase()]),a=this._et("pick_color_for_line").replace("{line}",e);return I`
                <div class="color-row">
              ...
              `}):I`<div class="editor-hint">${this._et("no_lines_available")}</div>`}
      </div>
    `}static{this.styles=[dt,a`
    .stop-filter {
      background: var(--secondary-background-color, rgba(0, 0, 0, 0.04));
      border-radius: 12px;
      padding: 14px 16px;
  ...
  `]}};function ht(e,t){return e?I`<span lang="de">${e}</span>`:t??""}function pt(e){return e===Oe?"platform_short_rail":"platform_short_bus"}function ut(e,t){if(!e||!t)return{};const i=e.states[t]?.attributes;return i?.line_colors??{}}e([pe({attribute:!1})],ct.prototype,"hass",void 0),e([ue()],ct.prototype,"_config",void 0),ct=e([de("wiener-linien-austria-card-editor")],ct),console.info(`%c WIENER-LINIEN-AUSTRIA-CARD %c ${Ae} `,"color: white; background: #E3000F; font-weight: 700;","color: #E3000F; background: white; font-weight: 700;"),window.customCards=window.customCards??[],window.customCards.push({type:"wiener-linien-austria-card",name:"Wiener Linien Austria",description:"Abfahrtsmonitor mit Störungen und Aufzugsinfo",preview:!0});let ft=class extends oe{constructor(){super(...arguments),this._activeTab=0,this._versionMismatch=null,this._expandedTraffic=new Set,this._expandedElevator=new Set,this._expandedRows=new Set,this._expandedTransfers=new Set,this._debugTraffic=[],this._debugElevator=[],this._versionCheckDone=!1,this._devTestTraffic=()=>{const e=this._resolveStops(),t=[];for(const i of e)for(const e of this._attrs(i.entity).departures??[])e.line&&e.towards&&t.push(e);const i=this._randomFrom(t),r=i?.line||"U?",n=i?.towards||"Unbekannt",s=new Date;this._debugTraffic=[...this._debugTraffic,{name:`DEBUG-T-${Date.now()}`,title:`${r}: Testmeldung`,description:`Debug-Eintrag für Linie ${r} Richtung ${n}.`,description_html:`Debug-Eintrag für Linie ${r} Richtung ${n}.<br><br>Grund: Dev-Mode-Test.`,location:"Debug-Stelle",related_lines:[r],time_start:new Date(s.getTime()-18e5).toISOString(),time_end:new Date(s.getTime()+108e5).toISOString(),time_created:new Date(s.getTime()-18e5).toISOString(),time_last_update:s.toISOString(),status:"active"}]},this._devTestElevator=()=>{const e=this._resolveStops(),t=this._randomFrom(e);if(!t)return;const i=this._attrs(t.entity),r=i.stop_name||t.entity,n=i.departures??[],s=this._randomFrom(n)?.line||"",a=this._randomFrom(n)?.towards||"Unbekannt",o=new Date;this._debugElevator=[...this._debugElevator,{__debug_entity:t.entity,name:`DEBUG-E-${Date.now()}`,station:r,description:`${s||"Station"} Bahnsteig Richtung ${a} — Ausgang ${r}`,reason:"AUFZUGSERNEUERUNG Voraussichtlich bis Ende Mai außer Betrieb! (Dev-Mode-Test)",status:"außer Betrieb",related_lines:s?[s]:[],time_start:new Date(o.getTime()-27e5).toISOString(),time_end:new Date(o.getTime()+144e5).toISOString()}]},this._devClear=()=>{this._debugTraffic=[],this._debugElevator=[]}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-card: config must be an object");const t=Array.isArray(e.entities),i="string"==typeof e.entity;if(!t&&!i)throw new Error("wiener-linien-austria-card: 'entities' (array) or legacy 'entity' (string) is required");this._config=et(e)}getCardSize(){const e=this._config?.entities.length??1;return Math.min(12,3+3*e)}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-card-editor")}static getStubConfig(e){const t=rt(e);return{entities:t.length?[t[0]]:[],max_departures:6}}connectedCallback(){super.connectedCallback(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion())}willUpdate(e){if(this._config&&(e.has("_config")||e.has("hass"))){const e=this._resolveStops();e.length&&this._activeTab>=e.length&&(this._activeTab=0)}}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_activeTab")||e.has("_versionMismatch")||e.has("_expandedTraffic")||e.has("_expandedElevator")||e.has("_expandedRows")||e.has("_expandedTransfers")||e.has("_debugTraffic")||e.has("_debugElevator"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStops().map(e=>e.entity);return i.some(e=>t.states[e]!==this.hass.states[e])}_lang(){return this.hass?.language?.startsWith("de")?"de":"en"}_t(e,t){return Pe(`modern.${e}`,{hassLanguage:this.hass?.language},t)}async _checkCardVersion(){this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const r=await e.callWS({type:t});if(r?.version&&r.version!==i)return r.version}catch{}return null}(this.hass,"wiener_linien_austria/card_version",Ae)}_resolveStops(){const e=(this._config?.entities??[]).filter(e=>this.hass?.states?.[e.entity]);if(e.length)return e;const t=rt(this.hass)[0];return t?[{entity:t}]:[]}_attrs(e){return this.hass?.states?.[e]?.attributes??{}}render(){if(!this._config)return K;if(!this.hass)return I`<ha-card><div class="wrap"></div></ha-card>`;const e=this._config,t=this._resolveStops(),i="tabs"===e.layout&&t.length>=2,r=e.hide_attribution?"":t.map(e=>this._attrs(e.entity).attribution).find(e=>"string"==typeof e&&e.length>0)||"Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0";return I`
    ...
    `}_renderFooter(e){const t=this._isDevMode();return e||t?I`
      ${e?I`<div class="foot">
            <span class="timestamp">${e}</span>
          </div>`:K}
      ${t?this._renderDevModePanel():K}
    `:K}_renderBody(e,t){if(!e.length)return this._renderEmpty();if(t){const t=e[this._activeTab]??e[0];return I`${this._renderStop(t,this._activeTab)}`}return I`${e.map(e=>this._renderStop(e))}`}_renderEmpty(){const e=rt(this.hass).length?"no_entities_picked":"no_entities_available";return I`<div class="empty" role="status" aria-live="polite">${this._t(e)}</div>`}_renderTabs(e,t){return I`
      <div class="tabs" role="tablist">
        ${e.map((i,r)=>{const n=this._attrs(i.entity),s=n.stop_name||n.friendly_name||i.entity,a=r===t;return I`<button
            type="button"
            role="tab"
            id=${`wl-tab-${r}`}
    ...
    `}_setActiveTab(e){Number.isFinite(e)&&e!==this._activeTab&&(this._activeTab=e)}_onTabKeydown(e,t,i){let r=t;switch(e.key){case"ArrowRight":r=(t+1)%i;break;case"ArrowLeft":r=(t-1+i)%i;break;case"Home":r=0;break;case"End":r=i-1;break;default:return}e.preventDefault(),this._setActiveTab(r),this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelectorAll('.tabs [role="tab"]');e?.[r]?.focus()})}_renderStop(e,t){const i=this._attrs(e.entity),r=i.stop_name||i.friendly_name,n=r||e.entity,s=function(e,t){const{lines:i,direction:r,line_directions:n,walk_times:s,accessibility_only:a}=t,o=i&&i.length?new Set(i):null;return e.filter(e=>{if(o&&!o.has(e.line))return!1;const t=n?.[e.line]??r;if(t&&e.direction!==t)return!1;if(s){const t=s[st(e.line,String(e.direction??""))];if("number"==typeof t&&e.countdown<t)return!1}return!(a&&!e.barrier_free)})}(Array.isArray(i.departures)?i.departures:[],{...e,accessibility_only:this._config.accessibility_only}),a=Array.isArray(i.elevator_info)?i.elevator_info:[],o=this._debugElevator.filter(t=>t.__debug_entity===e.entity),l=[...a,...o],d=this._config.show_elevator_info&&l.length>0,c=this._stopMapUrl(n,i.latitude,i.longitude),h=this._t("open_in_maps"),p=this._computeHeroGroup(s),u=p[0],f=this._config.show_hero_metric?new Set(p):new Set,_=s.filter(e=>!f.has(e)),g=_.slice(0,this._config.max_departures),m=ut(this.hass,e.entity),b=u?tt(u.line||"",this._config.line_colors,m):"var(--primary-color)",w=(v=u?.type,je(v)??"mdi:bus-stop");var v;const y=u&&Number.isFinite(u.countdown)?u.countdown:null,$=null===y?"—":y<=0?this._t("now"):String(y),x=null!==y&&y>0?this._t("min"):"",k=void 0!==t;return I`
      <section
        ...
        aria-label=${n}
      >
        ${this._config.hide_header?K:I`<header class="head">
              <span class="icon-tile" aria-hidden="true">
                <ha-icon icon=${w}></ha-icon>
              </span>
              <div class="title-block">
                <h3 class="title">${ht(r,e.entity)}</h3>
                ${u?.line?I`<p class="subtitle">${ht(u.towards)}</p>`:K}
              </div>
              ${c?I`<div class="head-actions">
                    <a
                      class="icon-action"
                      href=${c}
                      target="_blank"
        ...
        ${this._config.show_hero_metric&&u?I`<div class="hero-host">
              <div class="hero">
                <div class="hero-time" aria-live="polite" aria-atomic="true">
                  <span class="hero-min">${$}</span>
                  ${x?I`<span class="hero-unit">${x}</span>`:K}
                </div>
                ${p.flatMap(t=>[this._renderHeroEntry(t,e.entity),this._renderHeroPanelForEntry(t,e.entity)])}
              </div>
            </div>`:K}
        ${d?this._renderElevatorDetails(l):K}
        ${this._config.show_departures&&this._config.max_departures>0?g.length?I`<ul class="dep-list" role="list" aria-label=${this._t("departures_list")}>
                ${g.map(t=>this._renderRow(t,e.entity))}
              </ul>`:I`<div class="empty" role="status" aria-live="polite">
                ${this._t(i.server_time?"betriebsschluss":"no_data")}
              </div>`:K}
      </section>
    `}_renderElevatorDetails(e){return I`
      <div class="alert-list">
        ${e.map(e=>this._renderElevatorDetail(e))}
      </div>
    `}_renderElevatorDetail(e){const t=e.description||e.station||"",i=e.reason||"",r=lt(e.time_end,this._lang()),n=Boolean(i||r),s=this._expandedElevator.has(e.name);return I`
      <div
      ...
      >
        ...
        <div class="alert-body">
          <div class="alert-summary">
            <div class="alert-title">${ht(t)}</div>
          </div>
          ${n?I`<div class="alert-detail">
                <div class="alert-detail-inner">
                  ${i?I`<div class="alert-desc">${ht(i)}</div>`:K}
                  ${r?I`<div class="alert-meta">
                        <span>${this._t("elevator_until")} ${r}</span>
                      </div>`:K}
                </div>
              </div>`:K}
        </div>
        ${n?I`<ha-icon class="alert-chevron" icon="mdi:chevron-down" aria-hidden="true"></ha-icon>`:K}
      </div>
    `}_toggleElevator(e){const t=new Set(this._expandedElevator);t.has(e)?t.delete(e):t.add(e),this._expandedElevator=t}_onExpanderKeydown(e,t,i){t&&("Enter"!==e.key&&" "!==e.key||(e.preventDefault(),i()))}_renderTrafficBanner(e){const t=new Set,i=[];for(const r of e)for(const e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),i.push(e));for(const e of this._debugTraffic)t.has(e.name)||(t.add(e.name),i.push(e));return i.length?I`
      <div class="alert-list">
        ${i.map(e=>this._renderTrafficItem(e))}
      </div>
    `:K}_renderTrafficItem(e){const t=this._config.line_colors,i=function(e,t){if(!e||!t)return{};for(const i of t.entities){const t=ut(e,i.entity);if(Object.keys(t).length)return t}return{}}(this.hass,this._config),r=Array.isArray(e.related_lines)?e.related_lines:[],n=e.description_html?ot(e.description_html):e.description?ot(e.description):"",s=lt(e.time_end,this._lang()),a=lt(e.time_last_update,this._lang()),o=lt(e.time_created,this._lang()),l=a&&a!==o?a:"",d=Boolean(e.location||s||l),c=Boolean(n||d),h=this._expandedTraffic.has(e.name),p={alert:!0,expanded:h,"no-detail":!c},u=e.title||this._t("traffic_label");return I`
      <div
        class=${ve(p)}
        role=${c?"button":"group"}
        tabindex=${c?"0":"-1"}
      ...
      >
        ...
        <div class="alert-body">
          <div class="alert-summary">
            ${r.length?I`<div class="alert-lines">
                  ${r.map(e=>I`<span
                      class="alert-line-badge"
                      style=${xe(it(e,t,i))}
                    >${e}</span>`)}
                </div>`:K}
            <div class="alert-title">${e.title?ht(e.title):this._t("traffic_label")}</div>
          </div>
          ${c?I`<div class="alert-detail">
                <div class="alert-detail-inner">
                  ${n?I`<div class="alert-desc">${we(n)}</div>`:K}
                  ${d?I`<div class="alert-meta">
                        ${e.location?I`<span class="alert-location-chip">
                              <ha-icon icon="mdi:map-marker" aria-hidden="true"></ha-icon>${ht(e.location)}
                            </span>`:K}
                        ${s?I`<span>${this._t("traffic_until")} ${s}</span>`:K}
                        ${l?I`<span>${this._t("traffic_updated")} ${l}</span>`:K}
                      </div>`:K}
                </div>
              </div>`:K}
        </div>
        ${c?I`<ha-icon class="alert-chevron" icon="mdi:chevron-down" aria-hidden="true"></ha-icon>`:K}
      </div>
    `}_toggleTraffic(e){const t=new Set(this._expandedTraffic);t.has(e)?t.delete(e):t.add(e),this._expandedTraffic=t}_computeHeroGroup(e){if(0===e.length)return[];const t=e=>Number.isFinite(e.countdown)?e.countdown:Number.POSITIVE_INFINITY;let i=Number.POSITIVE_INFINITY;for(const r of e){const e=t(r);e<i&&(i=e)}if(!Number.isFinite(i)){const t=e[0];return t?[t]:[]}return i<=0?e.filter(e=>t(e)<=0):e.filter(e=>t(e)===i)}_renderHeroEntry(e,t){const i=it(e.line||"",this._config.line_colors,ut(this.hass,t)),r=this._config.show_platform&&e.platform?String(e.platform):null,n=!!e.barrier_free&&this._config.show_accessibility,s=Array.isArray(e.stops_ahead)&&e.stops_ahead.length>0,a=e.time_planned??`cd${e.countdown}`,o=`${t}|${e.line}|${e.direction}|${e.towards??""}|${a}`,l=s&&this._expandedRows.has(o),d=`wl-hero-stopsahead-${t.replace(/[^a-z0-9_]/gi,"_")}-${e.line}-${e.direction}-${e.countdown}`,c=l?"stops_ahead_aria_hide":"stops_ahead_aria_show",h=s?this._t(c,{line:e.line||"?",towards:e.towards||""}):"",p={"hero-entry":!0,expandable:s,expanded:l},u=e.line||"?";return I`
      <div
        class=${ve(p)}
        role=${s?"button":K}
        tabindex=${s?"0":K}
      ...
      >
        <span
          ...
          style=${xe(i)}
        >${u}</span>
        <span class="hero-direction">${ht(e.towards)}</span>
        ${r?I`<span class="hero-platform"
              >${this._t(pt(e.type))} ${r}</span
            >`:K}
        ${n?I`<span
              class="hero-a11y"
              role="img"
    ...
    `}_renderHeroPanelForEntry(e,t){if(!(Array.isArray(e.stops_ahead)&&e.stops_ahead.length>0))return K;const i=e.time_planned??`cd${e.countdown}`,r=`${t}|${e.line}|${e.direction}|${e.towards??""}|${i}`,n=this._expandedRows.has(r),s=`wl-hero-stopsahead-${t.replace(/[^a-z0-9_]/gi,"_")}-${e.line}-${e.direction}-${e.countdown}`,a=e.line||"?";return this._renderHeroStopsAheadPanel(e.stops_ahead,s,n,a,r,t)}_renderHeroStopsAheadPanel(e,t,i,r,n,s){const a=this._config.line_colors,o=ut(this.hass,s);return I`
      <div
      ...
      >
        <div class="hero-detail-inner">
          <ol
            class="stops-ahead"
            style=${xe({"--stops-ahead-line":tt(r,a,o)})}
          >
            ${e.map((e,t)=>this._renderStopAhead(e,t,n,a,o))}
          </ol>
        </div>
      </div>
    `}_renderRow(e,t){const i=this._config.line_colors,r=ut(this.hass,t),n=e.line||"?",s=it(n,i,r),a=Number.isFinite(e.countdown)?e.countdown:null,o=null===a?"—":a<=0?this._t("now"):`${a} ${this._t("min")}`,l=function(e,t){if(!e||!t)return null;const i=Date.parse(e),r=Date.parse(t);return Number.isFinite(i)&&Number.isFinite(r)?Math.round((r-i)/6e4):null}(e.time_planned,e.time_real),d=this._config.show_delay&&null!==l&&l>=1?1===l?this._t("delay_singular"):this._t("delay_plural",{n:l}):"",c=null!==a&&a<=0?"now":null!==l&&l>=1?"late":null!==l&&l<=-1?"early":"",h=this._config.show_accessibility,p=Boolean(e.traffic_jam||h&&e.barrier_free),u=this._config.show_platform&&e.platform?String(e.platform):null,f=this._config.show_type_icon?je(e.type):null,_=Array.isArray(e.stops_ahead)&&e.stops_ahead.length>0,g=e.time_planned??`cd${e.countdown}`,m=`${t}|${e.line}|${e.direction}|${e.towards??""}|${g}`,b=_&&this._expandedRows.has(m),w=`wl-stopsahead-${t.replace(/[^a-z0-9_]/gi,"_")}-${e.line}-${e.direction}-${e.countdown}`,v=b?"stops_ahead_aria_hide":"stops_ahead_aria_show",y=_?this._t(v,{line:n,towards:e.towards||""}):"",$=I`
      <li
      ...
      >
        ...
        <div class="towards">
          ${f?I`<ha-icon class="type-icon" icon=${f} aria-hidden="true"></ha-icon>`:K}${ht(e.towards)}${d?I` <span class="delay">${d}</span>`:K}
        </div>
        ${u||p?I`<span class="row-end">
              ${u?I`<span class="row-platform"
                    >${this._t(pt(e.type))} ${u}</span
                  >`:K}
              ${p?I`<span class="row-flags">
                    ${e.traffic_jam?I`<ha-icon
                          class="disturbance"
    ...
    `;return _?[$,this._renderStopsAheadPanel(e.stops_ahead,w,b,n,m,t)]:$}_renderStopsAheadPanel(e,t,i,r,n,s){const a=this._config.line_colors,o=ut(this.hass,s);return I`
      <li
    ...
    `}_renderStopAhead(e,t,i,r,n){const s=e.lines??[],a=this._isNightlineHour(),o=[],l=[];for(const e of s)/^U\d/.test(e)||a&&/^N\d/.test(e)?o.push(e):l.push(e);const d=`${i}|${t}`,c=this._expandedTransfers.has(d),h={"stops-ahead-stop":!0,terminus:!!e.is_terminus,"transfers-expanded":c},p=o.length?I`<span class="stops-ahead-metros">
          ${o.map(e=>I`<span
              class="stops-ahead-line-chip"
              style=${xe(it(e,r,n))}
              >${e}</span
            >`)}
        </span>`:K,u=l.length?I`<button
          type="button"
        ...
        </button>`:K,f=l.length&&c?I`<div class="stops-ahead-others">
            ${l.map(e=>I`<span
