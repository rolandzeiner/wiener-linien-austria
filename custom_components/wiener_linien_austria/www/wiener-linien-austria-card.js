...
`;function Xt(e,t,i){return j`
  ...
  `}function ti(e){return ei(e,j`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
    ...
    ></ha-form>`)}const ii={},ri=me(class extends we{constructor(e){if(super(e),e.type!==ge&&e.type!==fe&&e.type!==_e)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===F||t===I)return t;const i=e.element,r=e.name;if(e.type===ge){if(t===i[r])return F}else if(e.type===_e){if(!!t===i.hasAttribute(r))return F}else if(e.type===fe&&i.getAttribute(r)===t+"")return F;return((e,t=ii)=>{e._$AH=t})(e),t}});function ni(e){"Escape"!==e.key&&"Tab"!==e.key&&e.stopPropagation()}const ai=120;function oi(e,t,i){const r=new Set;for(const n of e)n.direction===t&&(i&&n.line!==i||n.towards&&r.add(n.towards));return[...r].sort()}function si(e,t,i,r){const n=function(e,t){return e?.states?.[t]?.attributes}(e,t.entity),a=!n,o=n?.stop_name||t.entity,s=n?.line_colors??{},l=e=>ft(e,i.lineColorOverrides,s,"#5b6470"),d=new Set(t.lines??[]),c=xt(n),h=d.size?[...new Set([...c,...d])].sort():c,p=function(e){const t=[],i=new Set;for(const r of e?.departures??[]){const e=String(r.direction??""),n=`${r.line}|${e}|${r.towards}`;i.has(n)||(i.add(n),t.push({line:r.line,direction:e,towards:r.towards,type:r.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(n),u=new Map;for(const e of n?.departures??[])e.line&&e.type&&!u.has(e.line)&&u.set(e.line,e.type);const f=e=>({full:i.t("H"===e?"dir_h":"dir_r"),short:i.t("H"===e?"dir_h_short":"dir_r_short")});return j`
    <section class="wl-section">
      <header class="wl-section-header">
  ...
  `}(t,i,r,{lines:h,picked:d,colorOf:l,typeByLine:u})}
        ${!a&&h.length?function(e,t){return!e.singleLine&&yt(t.lines,t.picked).length>=2}(i,{lines:h,picked:d})?function(e,t,i,r){const{attrs:n,triplets:a,picked:o,lines:s,colorOf:l,dirStrings:d}=r,c=yt(s,o),h=e.line_directions??{},p=e.direction??null,u=e=>h[e]??p,f=(t,r)=>{const n={};for(const e of c){const i=e===t?r:u(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(h))c.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return j`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${c.map(e=>{const i=vt(n,e),r=u(e),o=i.available.has("H"),s=i.available.has("R"),c=null!==i.oneWay,h=i.unknown,p=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):bt(oi(a,i,e),d(i)));return j`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe({background:l(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${li({label:d("H").short,active:"H"===r||null===r&&"H"===i.oneWay,disabled:!h&&!o,compact:!0,title:oi(a,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:p("H"),onClick:()=>f(e,"H")})}
              ${li({label:d("R").short,active:"R"===r||null===r&&"R"===i.oneWay,disabled:!h&&!s,compact:!0,title:oi(a,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:p("R"),onClick:()=>f(e,"R")})}
              ${li({label:"",icon:"mdi:swap-horizontal",active:null===r&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:p(null),onClick:()=>f(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{attrs:n,triplets:p,picked:d,lines:h,colorOf:l,dirStrings:f}):function(e,t,i,r){const{attrs:n,triplets:a,picked:o,lines:s,dirStrings:l}=r,d=yt(s,o),c=1===d.length?d[0]:void 0,h=e.direction??null,p=vt(n,c),u=p.available.has("H"),f=p.available.has("R"),g=null!==p.oneWay,_="H"===h||null===h&&"H"===p.oneWay,m="R"===h||null===h&&"R"===p.oneWay,w=null===h&&!g,b=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))d.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},v=e=>p.unknown||p.available.has(e)?bt(oi(a,e,c),l(e)):`${l(e).short}: ${t.et("direction_not_served")}`,y=null!==p.oneWay&&1===d.length?t.et("direction_note_one_way").replace("{line}",d[0]??""):"";return j`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${li({label:v("H"),active:_,disabled:!p.unknown&&!u,title:u||p.unknown?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>b("H")})}
        ${li({label:v("R"),active:m,disabled:!p.unknown&&!f,title:f||p.unknown?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>b("R")})}
        ${t.singleLine?I:li({label:t.t("dir_both"),active:w,disabled:g,title:g?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>b(null)})}
      </div>
      ${y?j`<span class="wl-note">${y}</span>`:I}
    </div>
  `}(t,i,r,{attrs:n,triplets:p,picked:d,lines:h,dirStrings:f}):I}
        ${a?I:function(e,t,i,r){const{attrs:n,picked:a,colorOf:o,lines:s,dirStrings:l}=r,d=e.line_directions??{},c=e.direction??null,h=$t(n,{lines:s,picked:a,lineDirections:d,stopDirection:c});return h.length?j`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${h.map(r=>{const n=wt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.length?r.termini.join(" / "):"H"===r.direction||"R"===r.direction?l(r.direction).full:"",d=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),c=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(ai,r))};return j`
  ...
  `:I}(t,i,r,{attrs:n,picked:d,colorOf:l,lines:h,dirStrings:f})}
      </div>
    </section>
  `}function li(e){return j`<button
    type="button"
...
let ci=class extends se{constructor(){super(...arguments),this._tab="stops",this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(pt({...this._config,entities:di(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>function(e,t,i){const r=t.et(i);return r!==i?r:e?.localize?.(`ui.panel.lovelace.editor.card.generic.${i}`)||i}(this.hass,this._i18n,e.name),this._computeHelper=e=>{const{et:t}=this._i18n,i=this._config;return function(e,t,i){const r=i?.[t];if(void 0!==r)return r;const n=`${t}_helper`,a=e.et(n);return a===n?void 0:a}(this._i18n,e.name,{...i?.show_accessibility?{}:{accessibility_only:t("accessibility_only_requires")},...i?.show_delay?{}:{show_delay_colors:t("show_delay_colors_requires")},...(i?.entities.length??0)>=2?{}:{layout:t("layout_requires")}})}}setConfig(e){this._config=pt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>We(`${e}.${t}`,i),et:t=>{const r=`${e}.editor.${t}`,n=We(r,i);if(n!==r)return n;const a=`common.editor.${t}`,o=We(a,i);return o===a?t:o}}}("modern",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(pt({...this._config,...e}))}get _stopCallbacks(){return function(e,t){const i=(i,r)=>{const n=e();n&&t(n.map(e=>e.entity===i?r({...e}):e))};return{toggleLine:(e,t)=>i(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>i(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>i(e,e=>{const i={...e.walk_times??{}};return null===r?delete i[t]:i[t]=r,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e}),remove:i=>{const r=e();r&&t(r.filter(e=>e.entity!==i))}}}(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return I;const{et:e}=this._i18n;return j`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderMisc()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return j`
      ...
      ></ha-form>
      ${e.entities.map((r,n)=>si(this.hass,r,{index:n+1,total:e.entities.length,lineColorOverrides:e.line_colors,t:t,et:i},this._stopCallbacks))}
    ...
    `}_renderStopHero(e,t,i,r){return j`<div class="hero-host">
      ...
      <section
        ...
        aria-label=${n}
      >
        ${this._config.hide_header?I:this._renderStopHeader(e,r,n,g,v,c,p)}
        ${p&&h&&u?this._renderQrPanel(e.entity,n,h,v,this._qrOpenFor===e.entity):I}
        ...
        ${this._config.show_departures&&this._config.max_departures>0?_.length?j`${m>0?j`<div class="stale-note" role="status" aria-live="polite">
                ...
                </ul>`:this._renderEmptyState(i,m):I}
      </section>
    `}_renderEmptyState(e,t){if(t>0){const t=e.stale_since?Bt(e.stale_since,this._lang()):"";return j`<div class="empty stale" role="status" aria-live="polite">
    ...
    `}_renderElevatorDetail(e){const t=e.description||e.station||"",i=function(e){return e.split(/\s+-\s+/).map(e=>e.trim().replace(/\.$/,"")).filter(Boolean)}(t),r=e.reason||"",n=function(e){for(const[t,i]of Lt)if(t.test(e))return i;return Mt}(r),a=Bt(e.time_end,this._lang()),o=Boolean(r||a),s=this._expandedElevator.has(e.name);return j`
      <div
    ...
    `}_toggleElevator(e){this._expandedElevator=St(this._expandedElevator,e)}_onExpanderKeydown(e,t,i){t&&("Enter"!==e.key&&" "!==e.key||(e.preventDefault(),i()))}_renderTrafficBanner(e){const t=new Set,i=[];for(const r of e)for(const e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),i.push(e));for(const e of this._debugTraffic)t.has(e.name)||(t.add(e.name),i.push(e));if(!i.length)return I;const r=mt(this.hass,this._config.entities.map(e=>e.entity));return j`
      <div class="alert-list">
    ...
    `}_renderTrafficItem(e,t){const i=this._config.line_colors,r=Array.isArray(e.related_lines)?e.related_lines:[],n=Ut(e.description_html||e.description||""),a=n.blocks.length>0||n.facts.length>0,o=Bt(e.time_end,this._lang()),s=Bt(e.time_last_update,this._lang()),l=Bt(e.time_created,this._lang()),d=s&&s!==l?s:"",c=Boolean(e.location||o||d),h=Boolean(a||c),p=this._expandedTraffic.has(e.name),u={alert:!0,expanded:p,"no-detail":!h},f=e.title||this._t("traffic_label");return j`
      <div
        class=${be(u)}
        role=${h?"button":"group"}
        tabindex=${h?"0":"-1"}
    ...
    `}_renderHeroPanelForEntry(e,t){const{hasStopsAhead:i,rowKey:r,expanded:n,panelId:a}=this._expandState(e,t,"hero");return i?this._renderStopsAheadPanel("hero",e.stops_ahead,a,n,e.line||"?",r,t):I}_renderStopsAheadPanel(e,t,i,r,n,a,o){const s="hero"===e?"hero-detail":"dep-row-detail",l=be({[s]:!0,expanded:r}),d=r?"false":"true",c=j`
      <div class="${s}-inner">
    ...
    `;return"hero"===e?j`<div
        ...
        >
          ...
          ${c}
        </li>`}_colorScheme(){return!0===this.hass?.themes?.darkMode?"dark":!1===this.hass?.themes?.darkMode?"light":void 0}_rowAccentText(e){const t=this._colorScheme();return void 0===t?null:Zt(e,t)??"var(--primary-text-color)"}_renderRow(e,t,i=0){const r=this._config.line_colors,n=_t(this.hass,t),a=e.line||"?",o=ut(a,r,n),{countdown:s,signedDelay:l,cdState:d,hasFlags:c,platform:h}=qt(e,{showDelayColors:this._config.show_delay_colors,showAccessibility:this._config.show_accessibility,showCooling:this._config.show_cooling,showPlatform:this._config.show_platform}),p=this._config.show_accessibility,u=this._config.show_cooling,f=null===s?"—":s<=0?this._t("now"):`${s} ${this._t("min")}`,g=this._config.show_delay&&null!==l&&l>=1?1===l?this._t("delay_singular"):this._t("delay_plural",{n:l}):"",_="now"===d?this._rowAccentText(o.background):null,m=this._config.show_type_icon?Ve(e.type):null,{hasStopsAhead:w,rowKey:b,expanded:v,panelId:y,ariaLabel:x}=this._expandState(e,t,"row"),$=j`
      <li
      ...
      >
        ...
        <div class="towards">
          ${m?j`<ha-icon class="type-icon" icon=${m} aria-hidden="true"></ha-icon>`:I}
        ...
        >
          ...
          <ha-icon icon="mdi:chevron-down" aria-hidden="true"></ha-icon>
            ...
            ${l.map(e=>j`<span
                ...
                >${e}</span
              >`)}
          </div>`:I,g=l.length>0,_=g?this._t(c?"stops_ahead_other_hide":"stops_ahead_other_show",{count:l.length,stop:e.name}):"";return j`
      <li class=${be(h)}>
        <div
    ...
    `}_renderDevPaletteRow(e){return j`
      <div class="dev-pal-row">
        ...
        ${["dark","light"].map(t=>{const i=Zt(e.hex,t),r=hi.DEV_GROUNDS[t];return j`
            <div class="dev-pal-scheme" style="background: ${r};">
              <span class="dev-pal-scheme-label">${t}</span>
              ${hi.DEV_SURFACES.map(t=>{const n=function(e,t,i){const r=Gt(e),n=Gt(t);if(!r||!n)return null;const a=[0,1,2].map(e=>Ft(Vt(r[e])*i+Vt(n[e])*(1-i)));return"#"+a.map(e=>Math.round(255*e).toString(16).padStart(2,"0")).join("")}(e.hex,r,t.ratio)??r,a=i?function(e,t){const i=Gt(e),r=Gt(t);if(!i||!r)return null;const n=Qt(i),a=Qt(r);return(Math.max(n,a)+.05)/(Math.min(n,a)+.05)}(i,n):null,o=null!==a&&a>=4.5;return j`
