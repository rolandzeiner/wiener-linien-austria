...
(t,i,r,{attrs:n,picked:h,colorOf:l})}
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderColors()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return W`
      <ha-form
        .hass=${this.hass}
