...
--wl-ripple: color-mix(in srgb, var(--primary-color) 14%, transparent);
}`;function Fn(e,t){let n={hassLanguage:t};return{t:t=>U(`${e}.${t}`,n),et:t=>{let r=`${e}.editor.${t}`,i=U(r,n);if(i!==r)return i;let a=`common.editor.${t}`,o=U(a,n);return o===a?t:o}}}function In(e,t,n){let r=(t,r)=>{let i=t.key===`ArrowRight`?1:t.key===`ArrowLeft`?-1:0;if(!i)return;t.preventDefault();let a=(r+i+e.length)%e.length,o=e[a];if(!o)return;n(o.key);let s=t.currentTarget.parentElement?.children[a];s instanceof HTMLElement&&s.focus()};return N`
  ...
  `}function zn(e){return Rn(e,N`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
...
* SPDX-License-Identifier: BSD-3-Clause
*/const{I:Bn}=Te,Vn=e=>e.strings===void 0,Hn={},Un=(e,t=Hn)=>e._$AH=t,Wn=Pe(class extends Fe{constructor(e){
/**
* @license
* Copyright 2020 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
if(super(e),e.type!==B.PROPERTY&&e.type!==B.ATTRIBUTE&&e.type!==B.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Vn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===F)return t;let n=e.element,r=e.name;if(e.type===B.PROPERTY){if(t===n[r])return P}else if(e.type===B.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return P}else if(e.type===B.ATTRIBUTE&&n.getAttribute(r)===t+``)return P;return Un(e),t}});function Gn(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function Kn(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function qn(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Jn(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Yn(e,t){return e?.states?.[t]?.attributes}function Xn(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function Zn(e,t){return!e.singleLine&&Jt(t.lines,t.picked).length>=2}function Qn(e,t,n,r){let i=Yn(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=_t(e),l=e=>Rt(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=Yt(i),f=u.size?[...new Set([...d,...u])].sort():d,p=Wt(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return N`
    <section class="wl-section">
      <header class="wl-section-header">
      ...
      <div class="wl-stop-body">
        ...
        ${!a&&f.length?Zn(n,{lines:f,picked:u})?nr(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):tr(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):F}
        ${a?F:rr(t,n,r,{attrs:i,picked:u,colorOf:l,lines:f,dirStrings:h})}
      </div>
    </section>
  `}function $n(e,t,n){return N`
  ...
  `}function er(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return N`
    <div class="wl-group">
  ...
  `}function tr(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=Jt(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=qt(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>f.unknown||f.available.has(e)?Kt(Xn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,x=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return N`
    <div class="wl-group">
  ...
  </button>`}function nr(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=Jt(s,o),d=e.line_directions??{},f=e.direction??null,p=e=>d[e]??f,m=(t,r)=>{let i={};for(let e of u){let n=e===t?r:p(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return N`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=qt(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):Kt(Xn(a,n,e),l(n)));return N`
          <div class="wl-override-row">
            <span class="wl-badge" style=${H(Jn(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
  ...
  `}function rr(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=$t(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?N`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=Ut(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return N`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${H(Jn(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
              ...
              <span class="wl-stepper">
                ...
                <input
                  ...
                  aria-label=${l}
                  .value=${Wn(a===void 0?``:String(a))}
                  @keydown=${Gn}
                  @keyup=${Gn}
                  @keypress=${Gn}
                  @change=${t=>n.setWalkTime(e.entity,i,Kn(t.target.value,`${e.entity}/${i}`))}
                />
                <button
                  type="button"
                  class="wl-step-btn"
  ...
  `:F}function ir(e,t){let n=(n,r)=>{let i=e();i&&t(i.map(e=>e.entity===n?r({...e}):e))};return{toggleLine:(e,t)=>n(e,e=>{let n=new Set(e.lines??[]);return n.has(t)?n.delete(t):n.add(t),n.size?e.lines=[...n]:delete e.lines,e}),setDirections:(e,t)=>n(e,e=>(t.direction===null?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>n(e,e=>{let n={...e.walk_times??{}};return r===null?delete n[t]:n[t]=r,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:n=>{let r=e();r&&t(r.filter(e=>e.entity!==n))}}}function ar(e,t){let n=Array.isArray(t)?t.filter(e=>typeof e==`string`&&e.length>0):[],r=new Map(e.map(e=>[e.entity,e]));return n.map(e=>r.get(e)??{entity:e})}function or(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function sr(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let cr=class extends R{constructor(...e){super(...e),this._tab=`stops`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(It({...this._config,entities:ar(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>or(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n,n=this._config;return sr(this._i18n,e.name,{...n?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)},...n?.show_delay?{}:{show_delay_colors:t(`show_delay_colors_requires`)},...(n?.entities.length??0)>=2?{}:{layout:t(`layout_requires`)}})}}setConfig(e){this._config=It(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`))return!0;let t=e.get(`hass`);return!t||!this.hass||this._config.entities.map(e=>e.entity).some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return Fn(`modern`,this.hass?.language)}_commit(e){this._config=e,mt(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(It({...this._config,...e}))}get _stopCallbacks(){return ir(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return F;let{et:e}=this._i18n;return N`
      <div class="wl-editor">
        ${In([{key:`stops`,label:e(`tab_stops`)},{key:`display`,label:e(`tab_display`)},{key:`tweaks`,label:e(`tab_tweaks`)}],this._tab,e=>{this._tab=e})}
        ${Ln(this._tab,this._renderActiveTab())}
      </div>
    ...
    `}_renderTabActions(e,t){if(!this._config.hide_header)return F;let n=e[t]??e[0];if(!n)return F;let r=this._attrs(n.entity),i=r.stop_name||r.friendly_name||n.entity,a=nn(i,r.latitude,r.longitude),o=this._stopGeoUri(i,r.latitude,r.longitude),s=this._config.show_qr_button!==!1,c=s&&o!==null;return!a&&!c?F:N`<div
      class=${V({"tab-actions":!0,reserved:s})}
    >
      ${this._renderStopActions(n.entity,i,a,c)}
    </div>`}_setActiveTab(e){if(!Number.isFinite(e))return;let t=this._resolveStops(),n=Math.max(0,Math.min(t.length-1,Math.floor(e)));if(n===this._activeTab)return;let r=t[this._activeTab]?.entity,i=t[n]?.entity;r&&i&&this._qrOpenFor===r&&(this._qrOpenFor=i),this._activeTab=n}_syncTabStrip(e){let t=this.renderRoot.querySelector(`.tabs`),n=t!==this._observedTabs;n&&(this._tabResize?.disconnect(),this._observedTabs=t,t&&typeof ResizeObserver<`u`&&(this._tabResize??=new ResizeObserver(()=>this._measureTabs()),this._tabResize.observe(t))),t&&(this._measureTabs(),(n||e.has(`_activeTab`))&&this._revealActiveTab(t,!n))}_revealActiveTab(e,t){if(getComputedStyle(e).direction===`rtl`)return;let n=e.querySelectorAll(`[role="tab"]`)[this._activeTab];if(!n)return;let r=Tn(n.offsetLeft,n.offsetWidth,e.scrollLeft,e.clientWidth,e.scrollWidth,56);r!==null&&e.scrollTo({left:r,behavior:t?this._scrollBehavior():`auto`})}_scrollTabs(e){let t=this._observedTabs;if(!t)return;let n=getComputedStyle(t).direction===`rtl`,r=e===`start`!==n,i=En(t.clientWidth);t.scrollBy({left:r?-i:i,behavior:this._scrollBehavior()})}_scrollBehavior(){return window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches?`auto`:`smooth`}_onTabKeydown(e,t,n){let r=t;switch(e.key){case`ArrowRight`:r=(t+1)%n;break;case`ArrowLeft`:r=(t-1+n)%n;break;case`Home`:r=0;break;case`End`:r=n-1;break;default:return}e.preventDefault(),this._setActiveTab(r),this.updateComplete.then(()=>{(this.shadowRoot?.querySelectorAll(`.tabs [role="tab"]`))?.[r]?.focus()}).catch(e=>{console.warn(`[wiener-linien-austria-card] tab focus skipped`,e)})}_renderStopHeader(e,t,n,r,i,a,o){return N`<header class="head">
    ...
    </div>`}_renderStop(e,t){let n=this._attrs(e.entity),r=n.stop_name||n.friendly_name,i=r||e.entity,a=Zt(Array.isArray(n.departures)?n.departures:[],{...e,accessibility_only:this._config.accessibility_only}),o=Array.isArray(n.elevator_info)?n.elevator_info:[],s=this._debugElevator.filter(t=>t.__debug_entity===e.entity),c=[...o,...s],l=this._config.show_elevator_info&&c.length>0,u=nn(i,n.latitude,n.longitude),d=this._stopGeoUri(i,n.latitude,n.longitude),f=this._config.show_qr_button!==!1&&d!==null,p=!this._config.hide_header||t!==void 0,{heroGroup:m,heroLead:h,rows:g}=Mn(a,{showHeroMetric:this._config.show_hero_metric,maxDepartures:this._config.max_departures}),_=typeof n.stale_departures==`number`?n.stale_departures:0,v=Vt(this.hass,e.entity),y=h?Lt(h.line||``,this._config.line_colors,v):`var(--primary-color)`,b=gt(h?.type),x=h&&Number.isFinite(h.countdown)?h.countdown:null,S=x===null?`—`:x<=0?this._t(`now`):String(x),C=x!==null&&x>0?this._t(`min`):``,w=Et(y,this._colorScheme()),T=t!==void 0;return N`
      <section
        class="station"
    ...
    `}_renderEmptyState(e,t){if(t>0){let t=e.stale_since?On(e.stale_since,this._lang()):``;return N`<div class="empty stale" role="status" aria-live="polite">
    ...
    `}_renderElevatorDetail(e){let t=e.description||e.station||``,n=mn(t),r=e.reason||``,i=pn(r),a=On(e.time_end,this._lang()),o=!!(r||a),s=this._expandedElevator.has(e.name);return N`
      <div
    ...
    `}_toggleElevator(e){this._expandedElevator=tn(this._expandedElevator,e)}_onExpanderKeydown(e,t,n){t&&(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),n())}_renderTrafficBanner(e){let t=new Set,n=[];for(let r of e)for(let e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),n.push(e));for(let e of this._debugTraffic)t.has(e.name)||(t.add(e.name),n.push(e));if(!n.length)return F;let r=Ht(this.hass,this._config.entities.map(e=>e.entity));return N`
      <div class="alert-list">
    ...
    `}_renderHeroEntry(e,t){let n=Y(e.line||``,this._config.line_colors,Vt(this.hass,t)),r=this._config.show_type_icon?ht(e.type):null,{hasStopsAhead:i,rowKey:a,expanded:o,panelId:s,ariaLabel:c}=this._expandState(e,t,`hero`),l={"hero-entry":!0,expandable:i,expanded:o},u=e.line||`?`;return N`
      <div
        class=${V(l)}
    ...
    `}_toggleTransfers(e){this._expandedTransfers=tn(this._expandedTransfers,e)}_isNightlineHour(){if(this._nightlineHourMemo!==null)return this._nightlineHourMemo;let e=dr(`Europe/Vienna`).formatToParts(new Date),t=Number(e.find(e=>e.type===`hour`)?.value??`0`),n=Number(e.find(e=>e.type===`minute`)?.value??`0`),r=t*60+n,i=r>=1435||r<=315;return this._nightlineHourMemo=i,i}_rowKey(e,t){let n=e.time_planned??`cd${e.countdown}`;return`${t}|${e.line}|${e.direction}|${e.towards??``}|${n}`}_panelId(e,t,n){let r=en(t),i=n===`hero`?`wl-hero-stopsahead`:`wl-stopsahead`,a=(e.time_planned??`cd${e.countdown}`).replace(/[^a-z0-9_-]/gi,`_`);return`${i}-${r}-${e.line}-${e.direction}-${a}`}_toggleRow(e){this._expandedRows=tn(this._expandedRows,e)}_transferKey(e,t){return`${e}|${t}`}_stopGeoUri(e,t,n){return typeof t!=`number`||typeof n!=`number`?null:`geo:${t},${n}?q=${t},${n}${e?`(${encodeURIComponent(e)})`:``}`}_toggleQrFor(e){this._qrOpenFor=this._qrOpenFor===e?null:e}_renderQrPanel(e,t,n,r,i){let a=`wl-qr-${en(e)}`,o=this._t(`qr_dialog_title`),s=this._t(`qr_dialog_hint`);return N`
      <div
