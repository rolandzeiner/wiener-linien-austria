...
`;function Gt(e,t,i){return W`
  ...
  `}(t,i,r,{lines:d,picked:h,colorOf:l,typeByLine:p})}
        ${!a&&d.length?function(e,t){return!e.singleLine&&ii(t.lines,t.picked).length>=2}(i,{lines:d,picked:h})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,d=ii(o,a),h=e.line_directions??{},c=e.direction??null,p=e=>h[e]??c,u=(t,r)=>{const n={};for(const e of d){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(h))d.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=ti(n,e),r=p(e),a=i.has("H"),o=i.has("R"),d=1===i.size,h=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):bt(ei(n,i,e),l(i)));return W`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${ni({label:l("H").short,active:"H"===r||null===r&&d&&a,disabled:!a,compact:!0,title:ei(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:h("H"),onClick:()=>u(e,"H")})}
              ${ni({label:l("R").short,active:"R"===r||null===r&&d&&o,disabled:!o,compact:!0,title:ei(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:h("R"),onClick:()=>u(e,"R")})}
              ${ni({label:"",icon:"mdi:swap-horizontal",active:null===r&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:h(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:c,picked:h,lines:d,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=ii(o,a),d=1===l.length?l[0]:void 0,h=e.direction??null,c=ti(n,d),p=c.has("H"),u=c.has("R"),f=1===c.size,g="H"===h||null===h&&f&&p,_="R"===h||null===h&&f&&u,m=null===h&&!f,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===c.size||c.has(e)?bt(ei(n,e,d),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,v=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
...
(t,i,r,{attrs:n,picked:h,colorOf:l})}
  ...
  `}
      ...
      >
        ...
        <div class="towards">
          ...
          <div class="towards-rows">
            <span class="towards-name">${Fe(e.towards)}</span>${h?W`<span class="delay">${h}</span>`:I}
          </div>
        </div>
    ...
    `;return b?[k,this._renderStopsAheadPanel(e.stops_ahead,x,y,a,v,t)]:k}_renderStopsAheadPanel(e,t,i,r,n,a){return W`
      <li
    ...
    `}_renderStopAhead(e,t,i,r,n){const a=e.lines??[],o=this._isNightlineHour(),s=[],l=[];for(const e of a)/^U\d/.test(e)||o&&/^N\d/.test(e)?s.push(e):l.push(e);const d=this._transferKey(i,t),h=this._expandedTransfers.has(d),c={"stops-ahead-stop":!0,terminus:!!e.is_terminus,"transfers-expanded":h},p=s.length?W`<span class="stops-ahead-metros">
          ${s.map(e=>W`<span
