      ...
      <div class="stop-filter">
        ...
        <div class="stop-filter-row">
          ...
          <div class="line-chips">
            ${n.length?n.map(t=>{const i=0===s.size||s.has(t),n=Qe(t,r),a=i?{background:n,borderColor:n,color:"#fff"}:{};return W`<button
                    type="button"
        ...
        ${d?W`
              <div class="stop-filter-row">
                ...
                <div class="per-line-dir-list">
                  ${l.map(t=>{const i=Qe(t,r),n=o[t]??null,s=(e=>{const t=new Set;for(const i of c)i.line===e&&("H"!==i.direction&&"R"!==i.direction||t.add(i.direction));return t})(t),a=s.has("H"),l=s.has("R"),d=1===s.size,h="H"===n||null===n&&d&&a,p="R"===n||null===n&&d&&l,u=null===n&&!d,_=this._et("per_line_direction_aria").replace("{line}",t),f=this._et("direction_unavailable");return W`
        ...
        ${(()=>{const i=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),r=tt(i.line,e);let n=t.get(r);n||(n={line:i.line,direction:e,type:i.type,termini:[]},t.set(r,n)),i.towards&&!n.termini.includes(i.towards)&&n.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(t),n=i.filter(e=>{if(s.size>0&&!s.has(e.line))return!1;const t=o[e.line]??a;return!t||e.direction===t});return n.length?W`
            <div class="stop-filter-row">
              ...
              <div class="walk-time-list">
                ${n.map(t=>{const i=Qe(t.line,r),n=tt(t.line,t.direction),s=e.walk_times?.[n],a=t.termini.join(" / "),o=a?`→ ${a}`:"",l=t.termini.length>1?this._et("walk_time_branching_hint"):"";return W`
  ...
  `}};function at(e,t){return e?W`<span lang="de">${e}</span>`:t??""}function ot(e){switch(e){case Ee:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}function lt(e){return e===Ee?"platform_short_rail":"platform_short_bus"}function dt(e,t){const i=Qe(e,t);return i===ze?{background:i,color:"#fef200"}:{background:i}}e([pe({attribute:!1})],st.prototype,"hass",void 0),e([ue()],st.prototype,"_config",void 0),st=e([de("wiener-linien-austria-card-editor")],st),console.info(`%c WIENER-LINIEN-AUSTRIA-CARD %c ${Se} `,"color: white; background: #E3000F; font-weight: 700;","color: #E3000F; background: white; font-weight: 700;"),window.customCards=window.customCards??[],window.customCards.push({type:"wiener-linien-austria-card",name:"Wiener Linien Austria",description:"Abfahrtsmonitor mit Störungen und Aufzugsinfo",preview:!0});let ct=class extends oe{constructor(){super(...arguments),this._activeTab=0,this._versionMismatch=null,this._expandedTraffic=new Set,this._expandedElevator=new Set,this._expandedRows=new Set,this._expandedTransfers=new Set,this._debugTraffic=[],this._debugElevator=[],this._versionCheckDone=!1,this._devTestTraffic=()=>{const e=this._resolveStops(),t=[];for(const i of e)for(const e of this._attrs(i.entity).departures??[])e.line&&e.towards&&t.push(e);const i=this._randomFrom(t),r=i?.line||"U?",n=i?.towards||"Unbekannt",s=new Date;this._debugTraffic=[...this._debugTraffic,{name:`DEBUG-T-${Date.now()}`,title:`${r}: Testmeldung`,description:`Debug-Eintrag für Linie ${r} Richtung ${n}.`,description_html:`Debug-Eintrag für Linie ${r} Richtung ${n}.<br><br>Grund: Dev-Mode-Test.`,location:"Debug-Stelle",related_lines:[r],time_start:new Date(s.getTime()-18e5).toISOString(),time_end:new Date(s.getTime()+108e5).toISOString(),time_created:new Date(s.getTime()-18e5).toISOString(),time_last_update:s.toISOString(),status:"active"}]},this._devTestElevator=()=>{const e=this._resolveStops(),t=this._randomFrom(e);if(!t)return;const i=this._attrs(t.entity),r=i.stop_name||t.entity,n=i.departures??[],s=this._randomFrom(n)?.line||"",a=this._randomFrom(n)?.towards||"Unbekannt",o=new Date;this._debugElevator=[...this._debugElevator,{__debug_entity:t.entity,name:`DEBUG-E-${Date.now()}`,station:r,description:`${s||"Station"} Bahnsteig Richtung ${a} — Ausgang ${r}`,reason:"AUFZUGSERNEUERUNG Voraussichtlich bis Ende Mai außer Betrieb! (Dev-Mode-Test)",status:"außer Betrieb",related_lines:s?[s]:[],time_start:new Date(o.getTime()-27e5).toISOString(),time_end:new Date(o.getTime()+144e5).toISOString()}]},this._devClear=()=>{this._debugTraffic=[],this._debugElevator=[]}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-card: config must be an object");const t=Array.isArray(e.entities),i="string"==typeof e.entity;if(!t&&!i)throw new Error("wiener-linien-austria-card: 'entities' (array) or legacy 'entity' (string) is required");this._config=Je(e)}getCardSize(){const e=this._config?.entities.length??1;return Math.min(12,3+3*e)}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-card-editor")}static getStubConfig(e){const t=Xe(e);return{entities:t.length?[t[0]]:[],max_departures:6}}connectedCallback(){super.connectedCallback(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion())}willUpdate(e){if(this._config&&(e.has("_config")||e.has("hass"))){const e=this._resolveStops();e.length&&this._activeTab>=e.length&&(this._activeTab=0)}}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_activeTab")||e.has("_versionMismatch")||e.has("_expandedTraffic")||e.has("_expandedElevator")||e.has("_expandedRows")||e.has("_expandedTransfers")||e.has("_debugTraffic")||e.has("_debugElevator"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStops().map(e=>e.entity);return i.some(e=>t.states[e]!==this.hass.states[e])}_lang(){return this.hass?.language?.startsWith("de")?"de":"en"}_t(e,t){return Ue(`modern.${e}`,{hassLanguage:this.hass?.language},t)}async _checkCardVersion(){try{const e=await this.hass.callWS({type:"wiener_linien_austria/card_version"});e?.version&&e.version!==Se&&(this._versionMismatch=e.version)}catch{}}_resolveStops(){const e=(this._config?.entities??[]).filter(e=>this.hass?.states?.[e.entity]);if(e.length)return e;const t=Xe(this.hass);return t.length?[{entity:t[0]}]:[]}_attrs(e){return this.hass?.states?.[e]?.attributes??{}}render(){if(!this._config)return K;if(!this.hass)return W`<ha-card><div class="wrap"></div></ha-card>`;const e=this._config,t=this._resolveStops(),i="tabs"===e.layout&&t.length>=2,r=e.hide_attribution?"":t.map(e=>this._attrs(e.entity).attribution).find(e=>"string"==typeof e&&e.length>0)||"Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0";return W`
    ...
    `:K}_renderBody(e,t){if(!e.length)return this._renderEmpty();if(t){const t=e[this._activeTab];return W`${this._renderStop(t,this._activeTab)}`}return W`${e.map(e=>this._renderStop(e))}`}_renderEmpty(){const e=Xe(this.hass).length?"no_entities_picked":"no_entities_available";return W`<div class="empty" role="status" aria-live="polite">${this._t(e)}</div>`}_renderTabs(e,t){return W`
      <div class="tabs" role="tablist">
        ${e.map((i,r)=>{const n=this._attrs(i.entity),s=n.stop_name||n.friendly_name||i.entity,a=r===t;return W`<button
            type="button"
            role="tab"
            id=${`wl-tab-${r}`}
    ...
    `}_setActiveTab(e){Number.isFinite(e)&&e!==this._activeTab&&(this._activeTab=e)}_onTabKeydown(e,t,i){let r=t;switch(e.key){case"ArrowRight":r=(t+1)%i;break;case"ArrowLeft":r=(t-1+i)%i;break;case"Home":r=0;break;case"End":r=i-1;break;default:return}e.preventDefault(),this._setActiveTab(r),this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelectorAll('.tabs [role="tab"]');e?.[r]?.focus()})}_renderStop(e,t){const i=this._attrs(e.entity),r=i.stop_name||i.friendly_name,n=r||e.entity,s=function(e,t){const{lines:i,direction:r,line_directions:n,walk_times:s,accessibility_only:a}=t,o=i&&i.length?new Set(i):null;return e.filter(e=>{if(o&&!o.has(e.line))return!1;const t=n?.[e.line]??r;if(t&&e.direction!==t)return!1;if(s){const t=s[tt(e.line,String(e.direction??""))];if("number"==typeof t&&e.countdown<t)return!1}return!(a&&!e.barrier_free)})}(Array.isArray(i.departures)?i.departures:[],{...e,accessibility_only:this._config.accessibility_only}),a=Array.isArray(i.elevator_info)?i.elevator_info:[],o=this._debugElevator.filter(t=>t.__debug_entity===e.entity),l=[...a,...o],d=this._config.show_elevator_info&&l.length>0,c=this._stopMapUrl(n,i.latitude,i.longitude),h=this._t("open_in_maps"),p=this._computeHeroGroup(s),u=p[0],_=this._config.show_hero_metric?new Set(p):new Set,f=s.filter(e=>!_.has(e)),g=f.slice(0,this._config.max_departures),m=u?Qe(u.line||"",this._config.line_colors):"var(--primary-color)",b=(v=u?.type,ot(v)??"mdi:bus-stop");var v;const w=u&&Number.isFinite(u.countdown)?u.countdown:null,y=null===w?"—":w<=0?this._t("now"):String(w),x=null!==w&&w>0?this._t("min"):"",$=void 0!==t;return W`
      ...
      >
        ...
        ${this._config.show_hero_metric&&u?W`<div class="hero-host">
              <div class="hero">
                <div class="hero-time" aria-live="polite" aria-atomic="true">
                  <span class="hero-min">${y}</span>
                  ${x?W`<span class="hero-unit">${x}</span>`:K}
                </div>
    ...
    `:K}_renderTrafficItem(e){const t=this._config.line_colors,i=Array.isArray(e.related_lines)?e.related_lines:[],r=e.description_html?rt(e.description_html):e.description?rt(e.description):"",n=nt(e.time_end,this._lang()),s=nt(e.time_last_update,this._lang()),a=nt(e.time_created,this._lang()),o=s&&s!==a?s:"",l=Boolean(e.location||n||o),d=Boolean(r||l),c=this._expandedTraffic.has(e.name),h={alert:!0,expanded:c,"no-detail":!d},p=e.title||this._t("traffic_label");return W`
      <div
        class=${we(h)}
        role=${d?"button":"group"}
        tabindex=${d?"0":"-1"}
    ...
    `}_renderRow(e,t){const i=this._config.line_colors,r=e.line||"?",n=dt(r,i),s=Number.isFinite(e.countdown)?e.countdown:null,a=null===s?"—":s<=0?this._t("now"):`${s} ${this._t("min")}`,o=function(e,t){if(!e||!t)return null;const i=Date.parse(e),r=Date.parse(t);return Number.isFinite(i)&&Number.isFinite(r)?Math.round((r-i)/6e4):null}(e.time_planned,e.time_real),l=this._config.show_delay&&null!==o&&o>=1?1===o?this._t("delay_singular"):this._t("delay_plural",{n:o}):"",d=null!==s&&s<=0?"now":null!==o&&o>=1?"late":null!==o&&o<=-1?"early":"",c=this._config.show_accessibility,h=Boolean(e.traffic_jam||c&&e.barrier_free),p=this._config.show_platform&&e.platform?String(e.platform):null,u=this._config.show_type_icon?ot(e.type):null,_=Array.isArray(e.stops_ahead)&&e.stops_ahead.length>0,f=e.time_planned??`cd${e.countdown}`,g=`${t}|${e.line}|${e.direction}|${e.towards??""}|${f}`,m=_&&this._expandedRows.has(g),b=`wl-stopsahead-${t.replace(/[^a-z0-9_]/gi,"_")}-${e.line}-${e.direction}-${e.countdown}`,v=m?"stops_ahead_aria_hide":"stops_ahead_aria_show",w=_?this._t(v,{line:r,towards:e.towards||""}):"",y=W`
      ...
      >
        <div class="line-badge" style=${$e(n)}>${r}</div>
        <div class="towards">
          ${u?W`<ha-icon class="type-icon" icon=${u} aria-hidden="true"></ha-icon>`:K}${at(e.towards)}${l?W` <span class="delay">${l}</span>`:K}
        </div>
        ${p||h?W`<span class="row-end">
              ${p?W`<span class="row-platform"
                    >${this._t(lt(e.type))} ${p}</span
                  >`:K}
              ${h?W`<span class="row-flags">
    ...
    `;return _?[y,this._renderStopsAheadPanel(e.stops_ahead,b,m,r,g)]:y}_renderStopsAheadPanel(e,t,i,r,n){const s=this._config.line_colors;return W`
      <li
    ...
    `}_renderStopAhead(e,t,i,r){const n=e.lines??[],s=this._isNightlineHour(),a=[],o=[];for(const e of n)/^U\d/.test(e)||s&&/^N\d/.test(e)?a.push(e):o.push(e);const l=`${i}|${t}`,d=this._expandedTransfers.has(l),c={"stops-ahead-stop":!0,terminus:!!e.is_terminus,"transfers-expanded":d},h=a.length?W`<span class="stops-ahead-metros">
          ${a.map(e=>W`<span
              class="stops-ahead-line-chip"
              style=${$e(dt(e,r))}
              >${e}</span
            >`)}
        </span>`:K,p=o.length?W`<button
          type="button"
          class="stops-ahead-other-toggle"
          aria-expanded=${d?"true":"false"}
          aria-label=${this._t(d?"stops_ahead_other_hide":"stops_ahead_other_show",{count:o.length,stop:e.name})}
          @click=${e=>{e.stopPropagation(),this._toggleTransfers(l)}}
          @keydown=${e=>{"Enter"!==e.key&&" "!==e.key||e.stopPropagation()}}
        >
          <span class="stops-ahead-other-count">+${o.length}</span>
          <ha-icon icon="mdi:chevron-down" aria-hidden="true"></ha-icon>
        </button>`:K,u=o.length&&d?W`<div class="stops-ahead-others">
            ${o.map(e=>W`<span
      ...
      <li class=${we(c)}>
        <div class="stops-ahead-row">
          ...
          <span class="stops-ahead-name">${at(e.name)}</span>
          ${h} ${p}
        </div>
        ${u}
      </li>
    `}_toggleTransfers(e){const t=new Set(this._expandedTransfers);t.has(e)?t.delete(e):t.add(e),this._expandedTransfers=t}_isNightlineHour(){const e=new Date,t=60*e.getHours()+e.getMinutes();return t>=1435||t<=315}_toggleRow(e){const t=new Set(this._expandedRows);t.has(e)?t.delete(e):t.add(e),this._expandedRows=t}_stopMapUrl(e,t,i){return"number"==typeof t&&"number"==typeof i?`https://www.google.com/maps/search/?api=1&query=${t},${i}`:e?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${e}, Wien`)}`:null}_renderBanner(){const e=this._t("version_update",{v:this._versionMismatch??""});return W`
    ...
    `:K}_randomFrom(e){return e.length?e[Math.floor(Math.random()*e.length)]:null}static{this.styles=ke}};e([pe({attribute:!1})],ct.prototype,"hass",void 0),e([ue()],ct.prototype,"_config",void 0),e([ue()],ct.prototype,"_activeTab",void 0),e([ue()],ct.prototype,"_versionMismatch",void 0),e([ue()],ct.prototype,"_expandedTraffic",void 0),e([ue()],ct.prototype,"_expandedElevator",void 0),e([ue()],ct.prototype,"_expandedRows",void 0),e([ue()],ct.prototype,"_expandedTransfers",void 0),e([ue()],ct.prototype,"_debugTraffic",void 0),e([ue()],ct.prototype,"_debugElevator",void 0),ct=e([de("wiener-linien-austria-card")],ct);export{ct as WienerLinienAustriaCard};
