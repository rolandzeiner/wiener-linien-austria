...
* SPDX-License-Identifier: BSD-3-Clause
*/const{I:Pn}=Te,Fn=e=>e.strings===void 0,In={},Ln=(e,t=In)=>e._$AH=t,Rn=Pe(class extends Fe{constructor(e){
/**
* @license
* Copyright 2020 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
if(super(e),e.type!==B.PROPERTY&&e.type!==B.ATTRIBUTE&&e.type!==B.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Fn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===F)return t;let n=e.element,r=e.name;if(e.type===B.PROPERTY){if(t===n[r])return P}else if(e.type===B.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return P}else if(e.type===B.ATTRIBUTE&&n.getAttribute(r)===t+``)return P;return Ln(e),t}});function zn(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function Bn(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function Vn(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Hn(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Un(e,t){return e?.states?.[t]?.attributes}function Wn(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function Gn(e,t){return!e.singleLine&&Gt(t.lines,t.picked).length>=2}function Kn(e,t,n,r){let i=Un(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=_t(e),l=e=>It(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=Kt(i),f=u.size?[...new Set([...d,...u])].sort():d,p=Vt(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return N`
    <section class="wl-section">
      <header class="wl-section-header">
  ...
  `}function Yn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=Gt(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=Wt(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>f.unknown||f.available.has(e)?Ut(Wn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,x=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return N`
    <div class="wl-group">
  ...
  </button>`}function Xn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=Gt(s,o),d=e.line_directions??{},f=e.direction??null,p=e=>d[e]??f,m=(t,r)=>{let i={};for(let e of u){let n=e===t?r:p(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return N`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=Wt(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):Ut(Wn(a,n,e),l(n)));return N`
          <div class="wl-override-row">
            <span class="wl-badge" style=${H(Hn(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${X({label:l(`H`).short,active:r===`H`||r===null&&n.oneWay===`H`,disabled:!d&&!o,compact:!0,title:Wn(a,`H`,e).join(` / `)||t.t(`dir_h`),ariaLabel:f(`H`),onClick:()=>m(e,`H`)})}
              ${X({label:l(`R`).short,active:r===`R`||r===null&&n.oneWay===`R`,disabled:!d&&!s,compact:!0,title:Wn(a,`R`,e).join(` / `)||t.t(`dir_r`),ariaLabel:f(`R`),onClick:()=>m(e,`R`)})}
  ...
  `}function Zn(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=Xt(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?N`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=Bt(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return N`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${H(Hn(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:F}function Qn(e,t){let n=(n,r)=>{let i=e();i&&t(i.map(e=>e.entity===n?r({...e}):e))};return{toggleLine:(e,t)=>n(e,e=>{let n=new Set(e.lines??[]);return n.has(t)?n.delete(t):n.add(t),n.size?e.lines=[...n]:delete e.lines,e}),setDirections:(e,t)=>n(e,e=>(t.direction===null?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>n(e,e=>{let n={...e.walk_times??{}};return r===null?delete n[t]:n[t]=r,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:n=>{let r=e();r&&t(r.filter(e=>e.entity!==n))}}}function $n(e,t){let n=Array.isArray(t)?t.filter(e=>typeof e==`string`&&e.length>0):[],r=new Map(e.map(e=>[e.entity,e]));return n.map(e=>r.get(e)??{entity:e})}function er(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function tr(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let nr=class extends R{constructor(...e){super(...e),this._tab=`stops`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Pt({...this._config,entities:$n(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>er(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n,n=this._config;return tr(this._i18n,e.name,{...n?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)},...n?.show_delay?{}:{show_delay_colors:t(`show_delay_colors_requires`)},...(n?.entities.length??0)>=2?{}:{layout:t(`layout_requires`)}})}}setConfig(e){this._config=Pt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`))return!0;let t=e.get(`hass`);return!t||!this.hass||this._config.entities.map(e=>e.entity).some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return kn(`modern`,this.hass?.language)}_commit(e){this._config=e,mt(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Pt({...this._config,...e}))}get _stopCallbacks(){return Qn(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return F;let{et:e}=this._i18n;return N`
    ...
    `}_renderColors(){let e=this._config,{et:t}=this._i18n,n=e.entities.map(e=>e.entity),r=qt(this.hass,n),i=zt(this.hass,n);return Mn({title:t(`section_colors`),hint:t(`section_colors_hint`)},r.length?N`<div class="wl-group">
            <span class="wl-note">${t(`colors_hint`)}</span>
            ${r.map(n=>{let r=It(n,e.line_colors,i,_t(this.hass),`#888888`),a=r.fill,o=a.startsWith(`#`)?a:`#888888`,s=!!e.line_colors[n.toUpperCase()],c=t(`pick_color_for_line`).replace(`{line}`,n);return N`
    ...
    `}_renderTabActions(e,t){if(!this._config.hide_header)return F;let n=e[t]??e[0];if(!n)return F;let r=this._attrs(n.entity),i=r.stop_name||r.friendly_name||n.entity,a=$t(i,r.latitude,r.longitude),o=this._stopGeoUri(i,r.latitude,r.longitude),s=this._config.show_qr_button!==!1,c=s&&o!==null;return!a&&!c?F:N`<div
    ...
    >
      ...
      <div class="title-block">
        <h3 class="title">${U(t,e.entity)}</h3>
        ${r?.line?N`<p class="subtitle">${U(r.towards)}</p>`:F}
      </div>
    ...
    </div>`}_renderStop(e,t){let n=this._attrs(e.entity),r=n.stop_name||n.friendly_name,i=r||e.entity,a=Jt(Array.isArray(n.departures)?n.departures:[],{...e,accessibility_only:this._config.accessibility_only}),o=Array.isArray(n.elevator_info)?n.elevator_info:[],s=this._debugElevator.filter(t=>t.__debug_entity===e.entity),c=[...o,...s],l=this._config.show_elevator_info&&c.length>0,u=$t(i,n.latitude,n.longitude),d=this._stopGeoUri(i,n.latitude,n.longitude),f=this._config.show_qr_button!==!1&&d!==null,p=!this._config.hide_header||t!==void 0,{heroGroup:m,heroLead:h,rows:g}=En(a,{showHeroMetric:this._config.show_hero_metric,maxDepartures:this._config.max_departures}),_=typeof n.stale_departures==`number`?n.stale_departures:0,v=Rt(this.hass,e.entity),y=h?Ft(h.line||``,this._config.line_colors,v):`var(--primary-color)`,b=gt(h?.type),x=h&&Number.isFinite(h.countdown)?h.countdown:null,S=x===null?`—`:x<=0?this._t(`now`):String(x),C=x!==null&&x>0?this._t(`min`):``,w=Tt(y,this._colorScheme()),T=t!==void 0;return N`
      <section
        class="station"
    ...
    `}_toggleElevator(e){this._expandedElevator=Qt(this._expandedElevator,e)}_onExpanderKeydown(e,t,n){t&&(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),n())}_renderTrafficBanner(e){let t=new Set,n=[];for(let r of e)for(let e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),n.push(e));for(let e of this._debugTraffic)t.has(e.name)||(t.add(e.name),n.push(e));if(!n.length)return F;let r=zt(this.hass,this._config.entities.map(e=>e.entity));return N`
      <div class="alert-list">
      ...
      >
        ...
        <div class="alert-body">
          <div class="alert-summary">
            ...
            <div class="alert-title">${e.title?U(e.title):this._t(`traffic_label`)}</div>
          </div>
                ...
                <div class="alert-detail-inner">
                  ...
                  ${f?N`<div class="alert-meta">
                        ${e.location?N`<span class="alert-location-chip">
                              <ha-icon icon="mdi:map-marker" aria-hidden="true"></ha-icon>${U(e.location)}
                            </span>`:F}
    ...
    `}_toggleTraffic(e){this._expandedTraffic=Qt(this._expandedTraffic,e)}_expandState(e,t,n){let r=Yt(this._config.show_stops_ahead,e),i=this._rowKey(e,t),a=r&&this._expandedRows.has(i),o=this._panelId(e,t,n),s=a?`stops_ahead_aria_hide`:`stops_ahead_aria_show`;return{hasStopsAhead:r,rowKey:i,expanded:a,panelId:o,ariaLabel:r?this._t(s,{line:e.line||`?`,towards:e.towards||``}):``}}_renderStopsAheadInner(e,t,n,r){let i=this._config.line_colors,a=Rt(this.hass,r);return N`
      <ol
        class="stops-ahead"
        style=${H({"--stops-ahead-line":Ft(t,i,a)})}
      >
        ${e.map((e,t)=>this._renderStopAhead(e,t,n,i,a))}
      </ol>
    `}_renderHeroEntry(e,t){let n=Y(e.line||``,this._config.line_colors,Rt(this.hass,t)),r=this._config.show_platform&&e.platform?String(e.platform):null,i=!!e.barrier_free&&this._config.show_accessibility,a=!!e.cooling&&this._config.show_cooling,o=this._config.show_type_icon?ht(e.type):null,{hasStopsAhead:s,rowKey:c,expanded:l,panelId:u,ariaLabel:d}=this._expandState(e,t,`hero`),f={"hero-entry":!0,expandable:s,expanded:l},p=e.line||`?`;return N`
      <div
        class=${V(f)}
      ...
      >
        ...
        ${o?N`<ha-icon
              ...
              aria-hidden="true"
            ></ha-icon>`:F}
        <span class="hero-direction">${U(e.towards)}</span>
        ${r?N`<span class="hero-platform"
              >${this._t(rr(e.type))} ${r}</span
            >`:F}
        ${i?N`<span
              class="hero-a11y"
              role="img"
      ...
      >
        ...
        <div class="towards">
          ...
          <div class="towards-rows">
            <span class="towards-name">${U(e.towards)}</span>${h?N`<span class="delay">${h}</span>`:F}
          </div>
        </div>
        ${d||u?N`<span class="row-end">
              ${d?N`<span class="row-platform"
                    >${this._t(rr(e.type))} ${d}</span
                  >`:F}
    ...
    `;return v?[C,this._renderStopsAheadPanel(`row`,e.stops_ahead,x,b,a,y,t)]:C}_renderStopAhead(e,t,n,r,i){let a=e.lines??[],o=this._isNightlineHour(),s=[],c=[];for(let e of a)/^U\d/.test(e)||o&&/^N\d/.test(e)?s.push(e):c.push(e);let l=this._transferKey(n,t),u=this._expandedTransfers.has(l),d={"stops-ahead-stop":!0,terminus:!!e.is_terminus,"transfers-expanded":u},f=s.length?N`<span class="stops-ahead-metros">
      ...
      <li class=${V(d)}>
        ...
        >
          ...
          <span class="stops-ahead-name">${U(e.name)}</span>
          ${f} ${p}
        </div>
        ${m}
      </li>
    `}_toggleTransfers(e){this._expandedTransfers=Qt(this._expandedTransfers,e)}_isNightlineHour(){if(this._nightlineHourMemo!==null)return this._nightlineHourMemo;let e=ar(`Europe/Vienna`).formatToParts(new Date),t=Number(e.find(e=>e.type===`hour`)?.value??`0`),n=Number(e.find(e=>e.type===`minute`)?.value??`0`),r=t*60+n,i=r>=1435||r<=315;return this._nightlineHourMemo=i,i}_rowKey(e,t){let n=e.time_planned??`cd${e.countdown}`;return`${t}|${e.line}|${e.direction}|${e.towards??``}|${n}`}_panelId(e,t,n){let r=Zt(t),i=n===`hero`?`wl-hero-stopsahead`:`wl-stopsahead`,a=(e.time_planned??`cd${e.countdown}`).replace(/[^a-z0-9_-]/gi,`_`);return`${i}-${r}-${e.line}-${e.direction}-${a}`}_toggleRow(e){this._expandedRows=Qt(this._expandedRows,e)}_transferKey(e,t){return`${e}|${t}`}_stopGeoUri(e,t,n){return typeof t!=`number`||typeof n!=`number`?null:`geo:${t},${n}?q=${t},${n}${e?`(${encodeURIComponent(e)})`:``}`}_toggleQrFor(e){this._qrOpenFor=this._qrOpenFor===e?null:e}_renderQrPanel(e,t,n,r,i){let a=`wl-qr-${Zt(e)}`,o=this._t(`qr_dialog_title`),s=this._t(`qr_dialog_hint`);return N`
      <div
    ...
    `}_renderDevPaletteRow(e){return N`
      <div class="dev-pal-row">
        ...
        ${[`dark`,`light`].map(t=>{let n=Tt(e.hex,t),r=Q.DEV_GROUNDS[t];return N`
            <div class="dev-pal-scheme" style="background: ${r};">
              <span class="dev-pal-scheme-label">${t}</span>
              ${Q.DEV_SURFACES.map(t=>{let i=wt(e.hex,r,t.ratio)??r,a=n?Ct(n,i):null,o=a!==null&&a>=4.5;return N`
