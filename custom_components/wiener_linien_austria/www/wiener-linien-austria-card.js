...
`;function Zt(e,t,i){return W`
  ...
  `}function Jt(e){return Yt(e,W`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
  ...
  `}(t,i,r,{lines:d,picked:h,colorOf:l,typeByLine:p})}
        ${!a&&d.length?function(e,t){return!e.singleLine&&ai(t.lines,t.picked).length>=2}(i,{lines:d,picked:h})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,d=ai(o,a),h=e.line_directions??{},c=e.direction??null,p=e=>h[e]??c,u=(t,r)=>{const n={};for(const e of d){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(h))d.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=ni(n,e),r=p(e),a=i.has("H"),o=i.has("R"),d=1===i.size,h=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):bt(ri(n,i,e),l(i)));return W`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${si({label:l("H").short,active:"H"===r||null===r&&d&&a,disabled:!a,compact:!0,title:ri(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:h("H"),onClick:()=>u(e,"H")})}
              ${si({label:l("R").short,active:"R"===r||null===r&&d&&o,disabled:!o,compact:!0,title:ri(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:h("R"),onClick:()=>u(e,"R")})}
              ${si({label:"",icon:"mdi:swap-horizontal",active:null===r&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:h(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:c,picked:h,lines:d,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=ai(o,a),d=1===l.length?l[0]:void 0,h=e.direction??null,c=ni(n,d),p=c.has("H"),u=c.has("R"),f=1===c.size,g="H"===h||null===h&&f&&p,_="R"===h||null===h&&f&&u,m=null===h&&!f,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===c.size||c.has(e)?bt(ri(n,e,d),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,v=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${si({label:b("H"),active:g,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${si({label:b("R"),active:_,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?I:si({label:t.t("dir_both"),active:m,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
  ...
  `}(t,i,r,{triplets:c,picked:h,lines:d,dirStrings:u}):I}
    ...
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${d.map(r=>{const n=wt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.join(" / "),l=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),d=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(ii,r))};return W`
...
(t,i,r,{attrs:n,picked:h,colorOf:l})}
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderMisc()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return W`
      ...
      ></ha-form>
      ${e.entities.map((r,n)=>oi(this.hass,r,{index:n+1,total:e.entities.length,lineColorOverrides:e.line_colors,t:t,et:i},this._stopCallbacks))}
    ...
    `}_renderStopHero(e,t,i,r){return W`<div class="hero-host">
      ...
      <section
        ...
        aria-label=${n}
      >
        ${this._config.hide_header?I:this._renderStopHeader(e,r,n,g,v,h,p)}
        ${p&&c&&u?this._renderQrPanel(e.entity,n,c,v,this._qrOpenFor===e.entity):I}
    ...
    `}_renderHeroPanelForEntry(e,t){const{hasStopsAhead:i,rowKey:r,expanded:n,panelId:a}=this._expandState(e,t,"hero");return i?this._renderStopsAheadPanel("hero",e.stops_ahead,a,n,e.line||"?",r,t):I}_renderStopsAheadPanel(e,t,i,r,n,a,o){const s="hero"===e?"hero-detail":"dep-row-detail",l=be({[s]:!0,expanded:r}),d=r?"false":"true",h=W`
      <div class="${s}-inner">
    ...
    `;return"hero"===e?W`<div
      ...
      >
        ...
        ${c||h?W`<span class="row-end">
              ${c?W`<span class="row-platform"
                    >${this._t(hi(e.type))} ${c}</span
                  >`:I}
    ...
    `;return w?[$,this._renderStopsAheadPanel("row",e.stops_ahead,y,v,a,b,t)]:$}_renderStopAhead(e,t,i,r,n){const a=e.lines??[],o=this._isNightlineHour(),s=[],l=[];for(const e of a)/^U\d/.test(e)||o&&/^N\d/.test(e)?s.push(e):l.push(e);const d=this._transferKey(i,t),h=this._expandedTransfers.has(d),c={"stops-ahead-stop":!0,terminus:!!e.is_terminus,"transfers-expanded":h},p=s.length?W`<span class="stops-ahead-metros">
          ${s.map(e=>W`<span
        ...
        </button>`:I,f=l.length&&h?W`<div class="stops-ahead-others">
            ${l.map(e=>W`<span
                class="stops-ahead-line-chip stops-ahead-line-chip--other"
                style=${xe(ut(e,r,n))}
                >${e}</span
              >`)}
          </div>`:I,g=l.length>0,_=g?this._t(h?"stops_ahead_other_hide":"stops_ahead_other_show",{count:l.length,stop:e.name}):"";return W`
      <li class=${be(c)}>
        <div
    ...
    `}_renderDevPaletteRow(e){return W`
      <div class="dev-pal-row">
        ...
        ${["dark","light"].map(t=>{const i=Gt(e.hex,t),r=di.DEV_GROUNDS[t];return W`
            <div class="dev-pal-scheme" style="background: ${r};">
              <span class="dev-pal-scheme-label">${t}</span>
              ${di.DEV_SURFACES.map(t=>{const n=function(e,t,i){const r=Ft(e),n=Ft(t);if(!r||!n)return null;const a=[0,1,2].map(e=>qt(Wt(r[e])*i+Wt(n[e])*(1-i)));return"#"+a.map(e=>Math.round(255*e).toString(16).padStart(2,"0")).join("")}(e.hex,r,t.ratio)??r,a=i?function(e,t){const i=Ft(e),r=Ft(t);if(!i||!r)return null;const n=Vt(i),a=Vt(r);return(Math.max(n,a)+.05)/(Math.min(n,a)+.05)}(i,n):null,o=null!==a&&a>=4.5;return W`
