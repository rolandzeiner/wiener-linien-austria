...
`;function Kt(e,t,i){return W`
  ...
  `}function Zt(e){return Qt(e,W`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
  ...
  `}(t,i,r,{lines:d,picked:c,colorOf:l,typeByLine:p})}
        ${!a&&d.length?function(e,t){return!e.singleLine&&ri(t.lines,t.picked).length>=2}(i,{lines:d,picked:c})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,d=ri(o,a),c=e.line_directions??{},h=e.direction??null,p=e=>c[e]??h,u=(t,r)=>{const n={};for(const e of d){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(c))d.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=ii(n,e),r=p(e),a=i.has("H"),o=i.has("R"),d=1===i.size,c=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):bt(ti(n,i,e),l(i)));return W`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${ai({label:l("H").short,active:"H"===r||null===r&&d&&a,disabled:!a,compact:!0,title:ti(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:c("H"),onClick:()=>u(e,"H")})}
              ${ai({label:l("R").short,active:"R"===r||null===r&&d&&o,disabled:!o,compact:!0,title:ti(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:c("R"),onClick:()=>u(e,"R")})}
              ${ai({label:"",icon:"mdi:swap-horizontal",active:null===r&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:c(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:h,picked:c,lines:d,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=ri(o,a),d=1===l.length?l[0]:void 0,c=e.direction??null,h=ii(n,d),p=h.has("H"),u=h.has("R"),f=1===h.size,g="H"===c||null===c&&f&&p,_="R"===c||null===c&&f&&u,m=null===c&&!f,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===h.size||h.has(e)?bt(ti(n,e,d),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,v=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return W`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${ai({label:b("H"),active:g,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${ai({label:b("R"),active:_,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?I:ai({label:t.t("dir_both"),active:m,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
  ...
  `}(t,i,r,{triplets:h,picked:c,lines:d,dirStrings:u}):I}
    ...
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${d.map(r=>{const n=wt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.join(" / "),l=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),d=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(ei,r))};return W`
...
(t,i,r,{attrs:n,picked:c,colorOf:l})}
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderMisc()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return W`
      ...
      ></ha-form>
      ${e.entities.map((r,n)=>ni(this.hass,r,{index:n+1,total:e.entities.length,lineColorOverrides:e.line_colors,t:t,et:i},this._stopCallbacks))}
    ...
    `}_renderDevPaletteRow(e){return W`
      <div class="dev-pal-row">
        ...
        ${["dark","light"].map(t=>{const i=It(e.hex,t),r=si.DEV_GROUNDS[t];return W`
            <div class="dev-pal-scheme" style="background: ${r};">
              <span class="dev-pal-scheme-label">${t}</span>
              ${si.DEV_SURFACES.map(t=>{const n=function(e,t,i){const r=jt(e),n=jt(t);if(!r||!n)return null;const a=[0,1,2].map(e=>Ut(qt(r[e])*i+qt(n[e])*(1-i)));return"#"+a.map(e=>Math.round(255*e).toString(16).padStart(2,"0")).join("")}(e.hex,r,t.ratio)??r,a=i?function(e,t){const i=jt(e),r=jt(t);if(!i||!r)return null;const n=Ft(i),a=Ft(r);return(Math.max(n,a)+.05)/(Math.min(n,a)+.05)}(i,n):null,o=null!==a&&a>=4.5;return W`
