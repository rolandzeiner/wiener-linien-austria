...
--wl-ripple: color-mix(in srgb, var(--primary-color) 14%, transparent);
}`;function Nn(e,t){let n={hassLanguage:t};return{t:t=>U(`${e}.${t}`,n),et:t=>{let r=`${e}.editor.${t}`,i=U(r,n);if(i!==r)return i;let a=`common.editor.${t}`,o=U(a,n);return o===a?t:o}}}function Pn(e,t,n){let r=(t,r)=>{let i=t.key===`ArrowRight`?1:t.key===`ArrowLeft`?-1:0;if(!i)return;t.preventDefault();let a=(r+i+e.length)%e.length,o=e[a];if(!o)return;n(o.key);let s=t.currentTarget.parentElement?.children[a];s instanceof HTMLElement&&s.focus()};return N`
  ...
  `}function Ln(e){return In(e,N`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
...
* SPDX-License-Identifier: BSD-3-Clause
*/const{I:Rn}=Te,zn=e=>e.strings===void 0,Bn={},Vn=(e,t=Bn)=>e._$AH=t,Hn=Pe(class extends Fe{constructor(e){
/**
* @license
* Copyright 2020 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
if(super(e),e.type!==B.PROPERTY&&e.type!==B.ATTRIBUTE&&e.type!==B.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!zn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===F)return t;let n=e.element,r=e.name;if(e.type===B.PROPERTY){if(t===n[r])return P}else if(e.type===B.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return P}else if(e.type===B.ATTRIBUTE&&n.getAttribute(r)===t+``)return P;return Vn(e),t}});function Un(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function Wn(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function Gn(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Kn(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function qn(e,t){return e?.states?.[t]?.attributes}function Jn(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function Yn(e,t){return!e.singleLine&&Kt(t.lines,t.picked).length>=2}function Xn(e,t,n,r){let i=qn(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=_t(e),l=e=>Lt(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=qt(i),f=u.size?[...new Set([...d,...u])].sort():d,p=Ht(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return N`
    <section class="wl-section">
      <header class="wl-section-header">
      ...
      <div class="wl-stop-body">
        ...
        ${!a&&f.length?Yn(n,{lines:f,picked:u})?er(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):$n(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):F}
        ${a?F:tr(t,n,r,{attrs:i,picked:u,colorOf:l,lines:f,dirStrings:h})}
      </div>
    </section>
  `}function Zn(e,t,n){return N`
  ...
  `}function Qn(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return N`
    <div class="wl-group">
  ...
  `}function $n(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=Kt(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=Gt(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>f.unknown||f.available.has(e)?Wt(Jn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,x=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return N`
    <div class="wl-group">
  ...
  </button>`}function er(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=Kt(s,o),d=e.line_directions??{},f=e.direction??null,p=e=>d[e]??f,m=(t,r)=>{let i={};for(let e of u){let n=e===t?r:p(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return N`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=Gt(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):Wt(Jn(a,n,e),l(n)));return N`
          <div class="wl-override-row">
            <span class="wl-badge" style=${H(Kn(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${X({label:l(`H`).short,active:r===`H`||r===null&&n.oneWay===`H`,disabled:!d&&!o,compact:!0,title:Jn(a,`H`,e).join(` / `)||t.t(`dir_h`),ariaLabel:f(`H`),onClick:()=>m(e,`H`)})}
              ${X({label:l(`R`).short,active:r===`R`||r===null&&n.oneWay===`R`,disabled:!d&&!s,compact:!0,title:Jn(a,`R`,e).join(` / `)||t.t(`dir_r`),ariaLabel:f(`R`),onClick:()=>m(e,`R`)})}
  ...
  `}function tr(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=Zt(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?N`
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=Vt(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return N`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${H(Kn(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:F}function nr(e,t){let n=(n,r)=>{let i=e();i&&t(i.map(e=>e.entity===n?r({...e}):e))};return{toggleLine:(e,t)=>n(e,e=>{let n=new Set(e.lines??[]);return n.has(t)?n.delete(t):n.add(t),n.size?e.lines=[...n]:delete e.lines,e}),setDirections:(e,t)=>n(e,e=>(t.direction===null?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>n(e,e=>{let n={...e.walk_times??{}};return r===null?delete n[t]:n[t]=r,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:n=>{let r=e();r&&t(r.filter(e=>e.entity!==n))}}}function rr(e,t){let n=Array.isArray(t)?t.filter(e=>typeof e==`string`&&e.length>0):[],r=new Map(e.map(e=>[e.entity,e]));return n.map(e=>r.get(e)??{entity:e})}function ir(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function ar(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let or=class extends R{constructor(...e){super(...e),this._tab=`stops`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Ft({...this._config,entities:rr(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>ir(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n,n=this._config;return ar(this._i18n,e.name,{...n?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)},...n?.show_delay?{}:{show_delay_colors:t(`show_delay_colors_requires`)},...(n?.entities.length??0)>=2?{}:{layout:t(`layout_requires`)}})}}setConfig(e){this._config=Ft(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`))return!0;let t=e.get(`hass`);return!t||!this.hass||this._config.entities.map(e=>e.entity).some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return Nn(`modern`,this.hass?.language)}_commit(e){this._config=e,mt(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Ft({...this._config,...e}))}get _stopCallbacks(){return nr(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return F;let{et:e}=this._i18n;return N`
      <div class="wl-editor">
        ${Pn([{key:`stops`,label:e(`tab_stops`)},{key:`display`,label:e(`tab_display`)},{key:`tweaks`,label:e(`tab_tweaks`)}],this._tab,e=>{this._tab=e})}
        ${Fn(this._tab,this._renderActiveTab())}
      </div>
    `}_renderActiveTab(){switch(this._tab){case`stops`:return this._renderStops();case`display`:return this._renderDisplay();case`tweaks`:return this._renderMisc()}}_renderStops(){let e=this._config,{t,et:n}=this._i18n;return N`
      ...
      ></ha-form>
      ${e.entities.map((r,i)=>Xn(this.hass,r,{index:i+1,total:e.entities.length,lineColorOverrides:e.line_colors,t,et:n},this._stopCallbacks))}
    ...
    `}_renderEmptyState(e,t){if(t>0){let t=e.stale_since?En(e.stale_since,this._lang()):``;return N`<div class="empty stale" role="status" aria-live="polite">
    ...
    `}_renderElevatorDetail(e){let t=e.description||e.station||``,n=fn(t),r=e.reason||``,i=dn(r),a=En(e.time_end,this._lang()),o=!!(r||a),s=this._expandedElevator.has(e.name);return N`
      <div
