        ...
        ${h.length?W`
              <div class="stop-filter-row">
                ...
                <div class="walk-time-list">
                  ${h.map(t=>{const i=qe(t.line,r),n=Ze(t.line,t.direction,t.towards),s=e.walk_times?.[n],o=t.towards?`→ ${t.towards}`:"";return W`
