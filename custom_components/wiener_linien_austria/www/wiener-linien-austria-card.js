...
--wl-ripple: color-mix(in srgb, var(--primary-color) 14%, transparent);
  ...
  `}(t,i,r,{lines:p,picked:c,colorOf:d,typeByLine:_})}
    ...
    <div class="wl-group">
      ...
      ${c.map(e=>{const i=Ct(n,e),r=u(e),o=i.available.has("H"),s=i.available.has("R"),c=null!==i.oneWay,h=i.unknown,p=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):Et(di(a,i,e),d(i)));return j`
          <div class="wl-override-row">
            <span class="wl-badge" style=${xe(si(l(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${hi({label:d("H").short,active:"H"===r||null===r&&"H"===i.oneWay,disabled:!h&&!o,compact:!0,title:di(a,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:p("H"),onClick:()=>_(e,"H")})}
              ${hi({label:d("R").short,active:"R"===r||null===r&&"R"===i.oneWay,disabled:!h&&!s,compact:!0,title:di(a,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:p("R"),onClick:()=>_(e,"R")})}
              ${hi({label:"",icon:"mdi:swap-horizontal",active:null===r&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:p(null),onClick:()=>_(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{attrs:n,triplets:u,picked:c,lines:p,colorOf:d,dirStrings:f}):function(e,t,i,r){const{attrs:n,triplets:a,picked:o,lines:s,dirStrings:l}=r,d=Tt(s,o),c=1===d.length?d[0]:void 0,h=e.direction??null,p=Ct(n,c),u=p.available.has("H"),_=p.available.has("R"),f=null!==p.oneWay,g="H"===h||null===h&&"H"===p.oneWay,m="R"===h||null===h&&"R"===p.oneWay,w=null===h&&!f,b=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))d.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},v=e=>p.unknown||p.available.has(e)?Et(di(a,e,c),l(e)):`${l(e).short}: ${t.et("direction_not_served")}`,y=null!==p.oneWay&&1===d.length?t.et("direction_note_one_way").replace("{line}",d[0]??""):"";return j`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${hi({label:v("H"),active:g,disabled:!p.unknown&&!u,title:u||p.unknown?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>b("H")})}
        ${hi({label:v("R"),active:m,disabled:!p.unknown&&!_,title:_||p.unknown?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>b("R")})}
        ${t.singleLine?V:hi({label:t.t("dir_both"),active:w,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>b(null)})}
      </div>
...
let ui=class extends se{constructor(){super(...arguments),this._tab="stops",this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(vt({...this._config,entities:pi(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>function(e,t,i){const r=t.et(i);return r!==i?r:e?.localize?.(`ui.panel.lovelace.editor.card.generic.${i}`)||i}(this.hass,this._i18n,e.name),this._computeHelper=e=>{const{et:t}=this._i18n,i=this._config;return function(e,t,i){const r=i?.[t];if(void 0!==r)return r;const n=`${t}_helper`,a=e.et(n);return a===n?void 0:a}(this._i18n,e.name,{...i?.show_accessibility?{}:{accessibility_only:t("accessibility_only_requires")},...i?.show_delay?{}:{show_delay_colors:t("show_delay_colors_requires")},...(i?.entities.length??0)>=2?{}:{layout:t("layout_requires")}})}}setConfig(e){this._config=vt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>We(`${e}.${t}`,i),et:t=>{const r=`${e}.editor.${t}`,n=We(r,i);if(n!==r)return n;const a=`common.editor.${t}`,o=We(a,i);return o===a?t:o}}}("modern",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(vt({...this._config,...e}))}get _stopCallbacks(){return function(e,t){const i=(i,r)=>{const n=e();n&&t(n.map(e=>e.entity===i?r({...e}):e))};return{toggleLine:(e,t)=>i(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>i(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>i(e,e=>{const i={...e.walk_times??{}};return null===r?delete i[t]:i[t]=r,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e}),remove:i=>{const r=e();r&&t(r.filter(e=>e.entity!==i))}}}(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return V;const{et:e}=this._i18n;return j`
  ...
  `}
    ...
    `}_renderColors(){const e=this._config,{et:t}=this._i18n,i=e.entities.map(e=>e.entity),r=function(e,t){const i=new Set;for(const r of t){const t=e?.states?.[r]?.attributes;for(const e of Rt(t))i.add(e)}return Array.from(i).sort()}(this.hass,i),n=At(this.hass,i);return ii({title:t("section_colors"),hint:t("section_colors_hint")},r.length?j`<div class="wl-group">
    ...
    `}_renderEmptyState(e,t){if(t>0){const t=e.stale_since?Zt(e.stale_since,this._lang()):"";return j`<div class="empty stale" role="status" aria-live="polite">
    ...
    `}_renderElevatorDetail(e){const t=e.description||e.station||"",i=function(e){return e.split(/\s+-\s+/).map(e=>e.trim().replace(/\.$/,"")).filter(Boolean)}(t),r=e.reason||"",n=function(e){for(const[t,i]of qt)if(t.test(e))return i;return Bt}(r),a=Zt(e.time_end,this._lang()),o=Boolean(r||a),s=this._expandedElevator.has(e.name);return j`
      <div
    ...
    `}_renderTrafficItem(e,t){const i=this._config.line_colors,r=Array.isArray(e.related_lines)?e.related_lines:[],n=Gt(e.description_html||e.description||""),a=n.blocks.length>0||n.facts.length>0,o=Zt(e.time_end,this._lang()),s=Zt(e.time_last_update,this._lang()),l=Zt(e.time_created,this._lang()),d=s&&s!==l?s:"",c=Boolean(e.location||o||d),h=Boolean(a||c),p=this._expandedTraffic.has(e.name),u={alert:!0,expanded:p,"no-detail":!h},_=e.title||this._t("traffic_label");return j`
      <div
        class=${be(u)}
        role=${h?"button":"group"}
        tabindex=${h?"0":"-1"}
