      ...
      >
        ${this._config.hide_header?I:B`<header class="head">
              ...
              <div class="title-block">
                ...
                ${g?.line?B`<p class="subtitle">${gt(g.towards)}</p>`:I}
              </div>
        ...
        <div class="alert-body">
          ...
          ${n?B`<div class="alert-detail">
                <div class="alert-detail-inner">
                  ${i?B`<div class="alert-desc">${gt(i)}</div>`:I}
      ...
      >
        ...
        <div class="towards">
          ...
          <div class="towards-rows">
            <span class="towards-name">${gt(e.towards)}</span>${d?B`<span class="delay">${d}</span>`:I}
          </div>
        </div>
