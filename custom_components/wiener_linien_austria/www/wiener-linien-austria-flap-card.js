...
`;function qe(e,t,i){return I`
  ...
  `}function Ze(e){return Ge(e,I`<ha-form
    ...
    >${i.shapes()}</svg>
  </span>`}function et(e){"Escape"!==e.key&&"Tab"!==e.key&&e.stopPropagation()}const tt={flap:!0},it={flap:!0},nt={flap:"small"},at={flap:!0},rt={flap:"line"},st={flap:!0},ot=new Set(["none","regular","accessible",...Qe]);function lt(e,t,i){if("string"!=typeof e)return;const n=i?e.trim().slice(0,t):e.slice(0,t);return n.length>0?n:void 0}function ct(e,t){if(!Array.isArray(e))return;const{maxCount:i,truncateTo:n,accept:a}=t,r=e.filter(e=>"string"==typeof e).map(e=>void 0===n?e.trim():e.trim().slice(0,n)).filter(e=>e.length>0&&(void 0===a||a(e))).slice(0,i);return r.length>0?r:void 0}const dt=/^[a-z0-9_-]+:[a-z0-9_-]+$/i;function ht(e){if(!e||"object"!=typeof e)return;const t=e,i={},n=ot.has(t.exit)?t.exit:"none";"none"!==n&&(i.exit=n);const a=lt(t.text,64,!0);void 0!==a&&(i.text=a),!0===t.show_wc&&(i.show_wc=!0),!0===t.show_escalator&&(i.show_escalator=!0),!0===t.show_elevator&&(i.show_elevator=!0),!0===t.show_clock&&(i.show_clock=!0),!0===t.show_date&&(i.show_date=!0);const r=ct(t.chips,{truncateTo:16,maxCount:6});void 0!==r&&(i.chips=r);const s=ct(t.extra_icons,{maxCount:3,accept:e=>dt.test(e)&&e.length<=64});if(void 0!==s&&(i.extra_icons=s),0===Object.keys(i).length)return;const o=lt(t.date_format,32,!1);return void 0!==o&&(i.date_format=o),i}function pt(e,t,i={},n="var(--primary-color)"){const a=e.toUpperCase();if(void 0!==t[a])return{background:t[a]};if(/^N\d/.test(a))return{background:"#1b1464",color:"#fef200"};const r=i[e]??i[a];return r?.bg?r.fg?{background:`#${r.bg}`,color:`#${r.fg}`}:{background:`#${r.bg}`}:{background:n}}const ut=[{key:"show_wc",icon:"mdi:human-male-female",labelKey:"show_wc_short"},{key:"show_escalator",icon:"mdi:escalator",labelKey:"show_escalator_short"},{key:"show_elevator",icon:"mdi:elevator",labelKey:"show_elevator_short"},{key:"show_clock",icon:"mdi:clock-outline",labelKey:"show_clock_short"},{key:"show_date",icon:"mdi:calendar",labelKey:"show_date_short"}],_t=[{value:"regular",icon:"mdi:exit-run",labelKey:"header_exit_regular"},{value:"accessible",icon:"mdi:wheelchair-accessibility",labelKey:"header_exit_accessible"},...Qe.map(e=>({value:e,icon:e,labelKey:Je[e].labelKey})),{value:"none",icon:"mdi:close-circle-outline",labelKey:"header_exit_none"}];function ft(e,t){const i=("header_left"===e.selected?e.left:e.right)??{},n=e.et("header_slot_empty"),a=(i,n)=>t.patch(e.selected,i,n);return I`
    <div class="wl-strip">
      <div class="wl-strip-bar" role="group" aria-label=${e.et("header_bar_aria")}>
        ${gt("header_left",e,t,n)}
        ${gt("header_right",e,t,n)}
      </div>
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${_t.map(t=>{const n=(i.exit??"none")===t.value,r=e.et(t.labelKey);return I`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${ut.map(t=>{const n=Boolean(i[t.key]),r=e.et(t.labelKey);return I`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${n?"true":"false"}
                aria-label=${r}
  ...
  `}function gt(e,t,i,n){const a="header_left"===e?t.left:t.right,r=t.selected===e,s=function(e,t,i){const n=[];if(!e)return[{label:t,kind:"text",name:t}];if(e.exit&&"none"!==e.exit){const t=_t.find(t=>t.value===e.exit);n.push({label:"",icon:t?.icon??e.exit,kind:"icon",name:t?i(t.labelKey):e.exit})}e.text&&n.push({label:e.text,kind:"text",name:e.text});for(const t of ut)e[t.key]&&n.push({label:"",icon:t.icon,kind:"icon",name:i(t.labelKey)});for(const t of e.extra_icons??[])n.push({label:"",icon:t,kind:"icon",name:t});for(const t of e.chips??[])n.push({label:t,kind:"chip",name:t});return n.length||n.push({label:t,kind:"text",name:t}),n}(a,n,t.et),o=t.et("header_left"===e?"header_left":"header_right");return I`<button
    type="button"
  ...
  </button>`}function mt(e,t){const i=e.filter((e,i)=>i!==t);return i.length?i:void 0}function bt(e,t){return`${e}|${t}`}function wt(e,t){if(!e.length)return t.full;const i=e.slice(0,3).join(" / "),n=e.length>3?" +"+(e.length-3):"";return`${t.short}: ${i}${n}`}function yt(e,t){const i=new Set;for(const n of e?.tracked_line_keys??[]){const[e,a]=n.split("|",2);t&&e!==t||("H"!==a&&"R"!==a||i.add(a))}if(0===i.size)for(const n of e?.departures??[])t&&n.line!==t||"H"!==n.direction&&"R"!==n.direction||i.add(n.direction);const n=[...i];return{available:i,unknown:0===i.size,oneWay:1===i.size?n[0]??null:null}}function vt(e,t){if(0===t.size)return[...e];const i=e.filter(e=>t.has(e));for(const e of t)i.includes(e)||i.push(e);return i}function xt(e,t){const{lines:i,direction:n,line_directions:a,walk_times:r,accessibility_only:s}=t,o=i&&i.length?new Set(i):null;return e.filter(e=>{if(o&&!o.has(e.line))return!1;const t=a?.[e.line]??n;if(t&&e.direction!==t)return!1;if(r){const t=r[bt(e.line,String(e.direction??""))];if("number"==typeof t&&e.countdown<t)return!1}return!(s&&!e.barrier_free)})}function kt(e,t){const{lines:i,picked:n,lineDirections:a,stopDirection:r}=t,s=e=>a[e]??r,o=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),n=bt(i.line,e);let a=t.get(n);a||(a={line:i.line,direction:e,type:i.type,termini:[]},t.set(n,a)),i.towards&&!a.termini.includes(i.towards)&&a.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(e).filter(e=>{if(n.size>0&&!n.has(e.line))return!1;const t=s(e.line);return!t||e.direction===t}),l=new Set(o.map(e=>e.line)),c=vt(i,n),d=[];for(const e of c){if(l.has(e))continue;const t=s(e);for(const i of t?[t]:["H","R"])d.push({line:e,direction:i,type:"",termini:[]})}return[...o,...d].sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line))}const $t="ptMetro";const St=120;function At(e,t,i){const n=new Set;for(const a of e)a.direction===t&&(i&&a.line!==i||a.towards&&n.add(a.towards));return[...n].sort()}function zt(e,t,i,n){const a=function(e,t){return e?.states?.[t]?.attributes}(e,t.entity),r=!a,s=a?.stop_name||t.entity,o=a?.line_colors??{},l=e=>function(e,t,i={},n="var(--primary-color)"){return pt(e,t,i,n).background}(e,i.lineColorOverrides,o,"#5b6470"),c=new Set(t.lines??[]),d=function(e){if(e?.tracked_lines?.length)return[...e.tracked_lines].sort();const t=new Set;if(e?.lines_at_stop?.length)for(const i of e.lines_at_stop)t.add(i);for(const i of e?.departures??[])i.line&&t.add(i.line);return Array.from(t).sort()}(a),h=c.size?[...new Set([...d,...c])].sort():d,p=function(e){const t=[],i=new Set;for(const n of e?.departures??[]){const e=String(n.direction??""),a=`${n.line}|${e}|${n.towards}`;i.has(a)||(i.add(a),t.push({line:n.line,direction:e,towards:n.towards,type:n.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(a),u=new Map;for(const e of a?.departures??[])e.line&&e.type&&!u.has(e.line)&&u.set(e.line,e.type);const _=e=>({full:i.t("H"===e?"dir_h":"dir_r"),short:i.t("H"===e?"dir_h_short":"dir_r_short")});return I`
    <section class="wl-section">
      <header class="wl-section-header">
  ...
  `}(t,i,n):G}
    ...
    <div class="wl-group">
      ...
      ${a.length?I`<div class="wl-chips">
            ${a.map(n=>{const a=t.singleLine?r.has(n):0===r.size||r.has(n),l=function(e){switch(e){case $t:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}(o.get(n));return I`<button
                type="button"
                class="wl-chip"
  ...
  `}(t,i,n,{lines:h,picked:c,colorOf:l,typeByLine:u})}
        ${!r&&h.length?function(e,t){return!e.singleLine&&vt(t.lines,t.picked).length>=2}(i,{lines:h,picked:c})?function(e,t,i,n){const{attrs:a,triplets:r,picked:s,lines:o,colorOf:l,dirStrings:c}=n,d=vt(o,s),h=e.line_directions??{},p=e.direction??null,u=e=>h[e]??p,_=(t,n)=>{const a={};for(const e of d){const i=e===t?n:u(e);i&&(a[e]=i)}for(const[e,t]of Object.entries(h))d.includes(e)||(a[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:a})};return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=yt(a,e),n=u(e),s=i.available.has("H"),o=i.available.has("R"),d=null!==i.oneWay,h=i.unknown,p=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):wt(At(r,i,e),c(i)));return I`
          <div class="wl-override-row">
            <span class="wl-badge" style=${ze({background:l(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${Et({label:c("H").short,active:"H"===n||null===n&&"H"===i.oneWay,disabled:!h&&!s,compact:!0,title:At(r,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:p("H"),onClick:()=>_(e,"H")})}
              ${Et({label:c("R").short,active:"R"===n||null===n&&"R"===i.oneWay,disabled:!h&&!o,compact:!0,title:At(r,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:p("R"),onClick:()=>_(e,"R")})}
              ${Et({label:"",icon:"mdi:swap-horizontal",active:null===n&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:p(null),onClick:()=>_(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,n,{attrs:a,triplets:p,picked:c,lines:h,colorOf:l,dirStrings:_}):function(e,t,i,n){const{attrs:a,triplets:r,picked:s,lines:o,dirStrings:l}=n,c=vt(o,s),d=1===c.length?c[0]:void 0,h=e.direction??null,p=yt(a,d),u=p.available.has("H"),_=p.available.has("R"),f=null!==p.oneWay,g="H"===h||null===h&&"H"===p.oneWay,m="R"===h||null===h&&"R"===p.oneWay,b=null===h&&!f,w=t=>{const n={};for(const[t,i]of Object.entries(e.line_directions??{}))c.includes(t)||(n[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:n})},y=e=>p.unknown||p.available.has(e)?wt(At(r,e,d),l(e)):`${l(e).short}: ${t.et("direction_not_served")}`,v=null!==p.oneWay&&1===c.length?t.et("direction_note_one_way").replace("{line}",c[0]??""):"";return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${Et({label:y("H"),active:g,disabled:!p.unknown&&!u,title:u||p.unknown?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${Et({label:y("R"),active:m,disabled:!p.unknown&&!_,title:_||p.unknown?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?G:Et({label:t.t("dir_both"),active:b,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
      ${v?I`<span class="wl-note">${v}</span>`:G}
    </div>
  `}(t,i,n,{attrs:a,triplets:p,picked:c,lines:h,dirStrings:_}):G}
        ${r?G:function(e,t,i,n){const{attrs:a,picked:r,colorOf:s,lines:o,dirStrings:l}=n,c=e.line_directions??{},d=e.direction??null,h=kt(a,{lines:o,picked:r,lineDirections:c,stopDirection:d});return h.length?I`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${h.map(n=>{const a=bt(n.line,n.direction),r=e.walk_times?.[a],o=n.termini.length?n.termini.join(" / "):"H"===n.direction||"R"===n.direction?l(n.direction).full:"",c=t.et("walk_time_aria").replace("{line}",n.line).replace("{towards}",o),d=t=>{const n=(r??0)+t;i.setWalkTime(e.entity,a,n<1?null:Math.min(St,n))};return I`
  ...
  `:G}(t,i,n,{attrs:a,picked:c,colorOf:l,lines:h,dirStrings:_})}
      </div>
    </section>
  `}function Et(e){return I`<button
    type="button"
...
let Ot=class extends ce{constructor(){super(...arguments),this._tab="stops",this._headerSide="header_left",this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Wt({...this._config,entities:Lt(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>function(e,t,i){const n=t.et(i);return n!==i?n:e?.localize?.(`ui.panel.lovelace.editor.card.generic.${i}`)||i}(this.hass,this._i18n,e.name),this._computeHelper=e=>{const{et:t}=this._i18n;return function(e,t,i){const n=i?.[t];if(void 0!==n)return n;const a=`${t}_helper`,r=e.et(a);return r===a?void 0:r}(this._i18n,e.name,{...this._config?.show_accessibility?{}:{accessibility_only:t("accessibility_only_requires")}})}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card-editor: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card-editor: 'entity' must be a string");this._config=Wt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab")||e.has("_headerSide"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return 0===i.length||i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>Ue(`${e}.${t}`,i),et:t=>{const n=`${e}.editor.${t}`,a=Ue(n,i);if(a!==n)return a;const r=`common.editor.${t}`,s=Ue(r,i);return s===r?t:s}}}("flap",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(Wt({...this._config,...e}))}get _stopCallbacks(){return function(e,t){const i=(i,n)=>{const a=e();a&&t(a.map(e=>e.entity===i?n({...e}):e))};return{toggleLine:(e,t)=>i(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>i(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,n)=>i(e,e=>{const i={...e.walk_times??{}};return null===n?delete i[t]:i[t]=n,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e}),remove:i=>{const n=e();n&&t(n.filter(e=>e.entity!==i))}}}(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return G;const{et:e}=this._i18n;return I`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return I`
      ...
      ></ha-form>
      ${e.entities.map((n,a)=>zt(this.hass,n,{index:a+1,total:e.entities.length,lineColorOverrides:{},t:t,et:i},this._stopCallbacks))}
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return I`
      ${Ge({title:t("section_header"),hint:t("section_header_hint")},I`
          ...
          ></ha-form>
          ${e.show_header?ft({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,i)=>this._patchHeaderSide(e,t,i)}):G}
        `)}
    ...
    `}_patchHeaderSide(e,t,i){this._config&&this._patch({[e]:Ct(this._config[e],t,i)})}_stationBgOptions(){const{et:e}=this._i18n,t=[{value:"line",label:e("station_bg_line")}],i=new Set;for(const e of this._config?.entities??[]){const t=this.hass?.states?.[e.entity]?.attributes,n=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(const e of n??[])"string"==typeof e&&e&&i.add(e)}if(0===i.size){const e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(const e of Object.keys(t??{}))i.add(e)}for(const e of[...i].sort())t.push({value:`line:${e}`,label:e});return t.push({value:"white",label:e("station_bg_white")}),t.push({value:"black",label:e("station_bg_black")}),t}static{this.styles=[Ke,Ie]}};function Pt(e){if(!e)return[];const t=[];for(const[i,n]of Object.entries(e.states??{})){if(!i.startsWith("sensor."))continue;const e=n?.attributes??{};"number"==typeof e.diva&&(Array.isArray(e.departures)&&e.next_by_line&&"object"==typeof e.next_by_line&&t.push(i))}return t.sort(),t}function Nt(e){return String(e).padStart(2,"0")}function Bt(e,t,i){if(!e||!t)return null;const n=Date.parse(e);return Number.isFinite(n)?function(e,t,i="de"){if(!t)return"";const n="en"===i?"en-GB":"de-AT",a=()=>e.toLocaleDateString(n,{weekday:"long"}),r=()=>e.toLocaleDateString(n,{weekday:"short"}),s=()=>e.toLocaleDateString(n,{month:"long"}),o=()=>e.toLocaleDateString(n,{month:"short"});let l="",c=0;for(;c<t.length;){const i=t[c];if("\\"===i&&c+1<t.length)l+=t[c+1],c+=2;else{switch(i){case"d":l+=Nt(e.getDate());break;case"j":l+=String(e.getDate());break;case"D":l+=r();break;case"l":l+=a();break;case"m":l+=Nt(e.getMonth()+1);break;case"n":l+=String(e.getMonth()+1);break;case"M":l+=o();break;case"F":l+=s();break;case"Y":l+=String(e.getFullYear());break;case"y":l+=Nt(e.getFullYear()%100);break;case"H":l+=Nt(e.getHours());break;case"G":l+=String(e.getHours());break;case"h":l+=Nt((e.getHours()+11)%12+1);break;case"g":l+=String((e.getHours()+11)%12+1);break;case"i":l+=Nt(e.getMinutes());break;case"s":l+=Nt(e.getSeconds());break;default:l+=i??""}c++}}return l}(new Date(n),t,i):null}function jt(e,t,i,n,a){let r=G;if("regular"===e.exit||"accessible"===e.exit){const i="regular"===e.exit?"exit":"exit-access";r=Xe(i,{ariaLabel:n(`header.${Ye[i].labelKey}`),flipX:Ye[i].glyphPointsTo!==t})}else if(e.exit&&function(e){return"string"==typeof e&&e in Je}(e.exit)){const i=Je[e.exit];r=function(e,t){const i=t.flipX?"retro-station-header__mdi retro-station-header__mdi--flip-x":"retro-station-header__mdi";return I`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${t.ariaLabel}>
    <ha-icon class=${i} icon=${e}></ha-icon>
  </span>`}(e.exit,{ariaLabel:n(`header.${i.labelKey}`),flipX:void 0!==i.glyphPointsTo&&i.glyphPointsTo!==t})}const s=e.text?I`<span class="retro-station-header__text">${e.text}</span>`:G,o=e=>Xe(e,{ariaLabel:n(`header.${Ye[e].labelKey}`)}),l=e.show_wc?o("wc"):G,c=e.show_escalator?o("escalator"):G,d=e.show_elevator?o("elevator"):G,h=(e.extra_icons??[]).map(e=>I`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${e}>
...
const Ut="ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß",Ft="0123456789";function It(e,t,i){const n=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return n===e.length?i:e[n]}function Kt(e,t){if(e===t)return t;const i=Ut.includes(e),n=Ft.includes(e),a=Ut.includes(t),r=Ft.includes(t);return!i&&!a||n||r?!n&&!r||i||a?t:It(Ft,e,t):It(Ut,e,t)}function qt(e,t){return`row${e}-${t}`}const Gt={small:22,medium:28,regular:32};function Zt(e){const t="number"==typeof e&&Number.isFinite(e)?e:null;return null===t?"--":String(t<=0?0:t).padStart(2," ")}{const e=window;e.customCards=e.customCards??[],e.customCards.some(e=>"wiener-linien-austria-flap-card"===e.type)||e.customCards.push({type:"wiener-linien-austria-flap-card",name:"Wiener Linien Austria — Flap Board",description:"Solari-style split-flap departure board",preview:!0,getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"wiener_linien_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:wiener-linien-austria-flap-card",entities:[t]}}:null})}let Vt=class extends ce{constructor(){super(...arguments),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card: 'entity' must be a string");const t=Wt(e);if((Array.isArray(e.entities)?e.entities.length:"string"==typeof e.entity&&e.entity?1:0)>0&&0===t.entities.length)throw new Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-flap-card-editor")}static getStubConfig(e){const t=Pt(e)[0];if(!t)return{};let i="H";const n=e?.states?.[t]?.attributes?.departures;if(Array.isArray(n)){const e=n.some(e=>"H"===e.direction),t=n.some(e=>"R"===e.direction);!e&&t&&(i="R")}return{entity:t,direction:i}}connectedCallback(){super.connectedCallback(),function(){if("undefined"==typeof document)return;if(document.getElementById(Ee))return;const e=document.createElement("style");e.id=Ee,e.textContent='\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans Condensed";\n  src: url("/wiener-linien-austria/fonts/wl-sans-condensed-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n',document.head.appendChild(e)}(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_versionMismatch")||e.has("_displayed")||e.has("_target")||e.has("_justFlipped"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStopEids();return 0!==i.length&&i.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config)return;if(!e.has("hass")&&!e.has("_config"))return;const t=this._gatherRows(),i=this._maxDestLen(t),n=this._maxLineLen(t);for(let e=0;e<t.length;e++){const a=t[e];a&&(this._diffFlipField(qt(e,"line"),(a.line??"?").toUpperCase().padStart(n," ")),this._diffFlipField(qt(e,"dest"),(a.towards??"").toUpperCase().padEnd(i," ")),this._diffFlipField(qt(e,"cd"),Zt(a.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(qt(e,"line"),null),this._diffFlipField(qt(e,"dest"),null),this._diffFlipField(qt(e,"cd"),null)}_clearFlipTimer(){null!==this._marchTimer&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(null!==t){if(void 0===this._displayed[e])return this._displayed={...this._displayed,[e]:t},void(this._target={...this._target,[e]:t});this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}else{if(e in this._displayed){const{[e]:t,...i}=this._displayed;this._displayed=i}if(e in this._target){const{[e]:t,...i}=this._target;this._target=i}if(e in this._justFlipped){const{[e]:t,...i}=this._justFlipped;this._justFlipped=i}}}_ensureMarchTimer(){null===this._marchTimer&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){const e={...this._displayed},t={};let i=!1;for(const[n,a]of Object.entries(this._target)){const r=e[n]??"";if(r===a)continue;const s=Math.max(r.length,a.length),o=[],l={};for(let e=0;e<s;e++){const t=r[e]??" ",i=a[e]??" ";t===i?o.push(t):(l[e]=t,o.push(Kt(t,i)))}const c=o.join("");e[n]=c,Object.keys(l).length>0&&(t[n]=l,i=!0)}this._displayed=e,this._justFlipped=t,i||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const n=await e.callWS({type:t});if(n?.version&&n.version!==i)return n.version}catch{}return null}(this.hass,"wiener_linien_austria/flap_card_version","2.0.0")}catch(e){console.warn("[wiener-linien-austria-flap-card] version probe failed",e)}}_resolveStopEids(){const e=this._config?.entities??[],t=this.hass?.states,i=e.map(e=>e.entity).filter(e=>t?.[e]);if(0===i.length&&0===e.length){const e=Pt(this.hass)[0];e&&i.push(e)}return 0===i.length&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(", ")})`)),i}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??"").length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??"?").length))}_gatherRows(){if(!this._config)return[];const e=this._config.entities??[],t=this._config.accessibility_only,i=[];for(const n of e){const e=this.hass?.states?.[n.entity]?.attributes??{},a=xt(Array.isArray(e.departures)?e.departures:[],{direction:n.direction,lines:n.lines,line_directions:n.line_directions,walk_times:n.walk_times,accessibility_only:t});i.push(...a)}const n=e=>Number.isFinite(e.countdown)?e.countdown:Number.POSITIVE_INFINITY;return i.sort((e,t)=>n(e)-n(t)),i.slice(0,this._config.max_rows)}_t(e,t){return Ue(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return G;const e=this._config,t=this._resolveStopEids(),i=this._gatherRows(),n=t[0]??"",a=n?this.hass?.states?.[n]?.attributes??{}:{},r=a.stop_name||a.friendly_name||"",s=a.line_colors??{},o=a.server_time,l=e.show_platform&&i.some(e=>e.platform),c=(i[0]?.type??"")===$t,d=this._t(c?"gleis":"steig"),h=!1===this.hass?.themes?.darkMode,p={flap:!0,[`flap--size-${e.size}`]:"regular"!==e.size,"flap--has-platform":l,"flap--light":h,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},u=this._resolveStationHeaderStyle(e.station_bg,e.entities,i,s),_=e.show_header?function(e){const{left:t,right:i,serverTime:n,t:a,lang:r}=e;return t||i?I`
  ...
  `:G}({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):G,f=e.hide_attribution?"":"string"==typeof a.attribution&&a.attribution||"Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0";return I`
    ...
    `}_renderRow(e,t,i,n,a,r,s){const o=this._config,l=Number.isFinite(e.countdown)?e.countdown:null,c=null!==l&&l<=0,d=(e.line??"?").toUpperCase(),h=d.padStart(s," "),p=(e.towards??"").toUpperCase(),u=[d,p,null===l?this._t("no_data"):c?this._t("at_platform"):this._t("countdown_minutes",{n:String(l)})].filter(Boolean).join(" — "),_=pt(d,{},i),f="var(--primary-color)"!==_.background?{tileBg:_.background,blankSpace:!0}:{blankSpace:!0},g=this._renderFlipString(Zt(e.countdown),qt(t,"cd"),{blankSpace:!0}),m=n?I`<div class="flap-cell flap-cell--platform" aria-hidden="true">
  ...
  `}};e([_e({attribute:!1})],Vt.prototype,"hass",void 0),e([fe()],Vt.prototype,"_config",void 0),e([fe()],Vt.prototype,"_versionMismatch",void 0),e([fe()],Vt.prototype,"_displayed",void 0),e([fe()],Vt.prototype,"_target",void 0),e([fe()],Vt.prototype,"_justFlipped",void 0),Vt=e([he("wiener-linien-austria-flap-card")],Vt);export{Vt as WienerLinienAustriaFlapCard};
