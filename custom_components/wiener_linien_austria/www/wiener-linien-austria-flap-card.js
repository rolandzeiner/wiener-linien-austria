...
*/const St=B(class extends Le{constructor(e){if(super(e),e.type!==z.PROPERTY&&e.type!==z.ATTRIBUTE&&e.type!==z.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ze(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===j||t===M)return t;let n=e.element,r=e.name;if(e.type===z.PROPERTY){if(t===n[r])return j}else if(e.type===z.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return j}else if(e.type===z.ATTRIBUTE&&n.getAttribute(r)===t+``)return j;return Ve(e),t}}),Ct={exit:{kind:`svg`,viewBox:`0 0 36.29 29.04`,glyphPointsTo:`left`,labelKey:`icon_exit`,shapes:()=>ve`
  ...
  `}function an(e,t){let n=e.filter((e,n)=>n!==t);return n.length?n:void 0}function on(e,t){return`${e}|${t}`}function sn(e){let t=[],n=new Set;for(let r of e?.departures??[]){let e=String(r.direction??``),i=`${r.line}|${e}|${r.towards}`;n.has(i)||(n.add(i),t.push({line:r.line,direction:e,towards:r.towards,type:r.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}function cn(e){let t=new Map;for(let n of e?.departures??[]){let e=String(n.direction??``),r=on(n.line,e),i=t.get(r);i||(i={line:n.line,direction:e,type:n.type,termini:[]},t.set(r,i)),n.towards&&!i.termini.includes(n.towards)&&i.termini.push(n.towards)}let n=Array.from(t.values());return n.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),n}function ln(e,t){if(!e.length)return t.full;let n=e.slice(0,3).join(` / `),r=e.length>3?` +${e.length-3}`:``;return`${t.short}: ${n}${r}`}function un(e,t){let n=new Set;for(let r of e?.tracked_line_keys??[]){let[e,i]=r.split(`|`,2);t&&e!==t||(i===`H`||i===`R`)&&n.add(i)}if(n.size===0)for(let r of e?.departures??[])t&&r.line!==t||(r.direction===`H`||r.direction===`R`)&&n.add(r.direction);let r=[...n];return{available:n,unknown:n.size===0,oneWay:n.size===1?r[0]??null:null}}function dn(e,t){if(t.size===0)return[...e];let n=e.filter(e=>t.has(e));for(let e of t)n.includes(e)||n.push(e);return n}function fn(e){if(e?.tracked_lines?.length)return[...e.tracked_lines].sort();let t=new Set;if(e?.lines_at_stop?.length)for(let n of e.lines_at_stop)t.add(n);for(let n of e?.departures??[])n.line&&t.add(n.line);return Array.from(t).sort()}function pn(e,t){let{lines:n,direction:r,line_directions:i,walk_times:a,accessibility_only:o}=t,s=n&&n.length?new Set(n.map(Bt)):null;return e.filter(e=>{if(s&&!s.has(e.line))return!1;let t=i?.[e.line]??r;if(t&&e.direction!==t)return!1;if(a){let t=a[on(e.line,String(e.direction??``))];if(typeof t==`number`&&e.countdown<t)return!1}return!(o&&!e.barrier_free)})}function mn(e,t){let{lines:n,picked:r,lineDirections:i,stopDirection:a}=t,o=e=>i[e]??a,s=cn(e).filter(e=>{if(r.size>0&&!r.has(e.line))return!1;let t=o(e.line);return!t||e.direction===t}),c=new Set(s.map(e=>e.line)),l=dn(n,r),u=[];for(let e of l){if(c.has(e))continue;let t=o(e);for(let n of t?[t]:[`H`,`R`])u.push({line:e,direction:n,type:``,termini:[]})}return[...s,...u].sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line))}const hn=`ptMetro`;function gn(e){switch(e){case hn:return`mdi:subway-variant`;case`ptTram`:return`mdi:tram`;case`ptBusCity`:case`ptBusNight`:return`mdi:bus`;case`ptTrainS`:return`mdi:train`;default:return null}}function _n(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function vn(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function yn(e,t){return e?.states?.[t]?.attributes}function bn(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function xn(e,t){return!e.singleLine&&dn(t.lines,t.picked).length>=2}function Sn(e,t,n,r){let i=yn(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=jt(e),l=e=>Zt(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=fn(i),f=u.size?[...new Set([...d,...u])].sort():d,p=sn(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return A`
    <section class="wl-section">
      <header class="wl-section-header">
      ...
      <div class="wl-stop-body">
        ...
        ${!a&&f.length?xn(n,{lines:f,picked:u})?En(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):Tn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):M}
        ${a?M:Dn(t,n,r,{attrs:i,picked:u,colorOf:l,lines:f,dirStrings:h})}
      </div>
    </section>
  `}function Cn(e,t,n){return A`
  ...
  `}function wn(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return A`
    <div class="wl-group">
      ...
      ${i.length?A`<div class="wl-chips">
            ${i.map(r=>{let i=t.singleLine?a.has(r):a.size===0||a.has(r),c=gn(s.get(r));return A`<button
                type="button"
                class="wl-chip"
                style=${H(_n(o(r)))}
  ...
  `}function Tn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=dn(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=un(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},ee=e=>f.unknown||f.available.has(e)?ln(bn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,b=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return A`
    <div class="wl-group">
  ...
  </button>`}function En(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=dn(s,o),d=e.line_directions??{},f=e.direction??null,p=e=>d[e]??f,m=(t,r)=>{let i={};for(let e of u){let n=e===t?r:p(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return A`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=un(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):ln(bn(a,n,e),l(n)));return A`
          <div class="wl-override-row">
            <span class="wl-badge" style=${H(vn(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${J({label:l(`H`).short,active:r===`H`||r===null&&n.oneWay===`H`,disabled:!d&&!o,compact:!0,title:bn(a,`H`,e).join(` / `)||t.t(`dir_h`),ariaLabel:f(`H`),onClick:()=>m(e,`H`)})}
              ${J({label:l(`R`).short,active:r===`R`||r===null&&n.oneWay===`R`,disabled:!d&&!s,compact:!0,title:bn(a,`R`,e).join(` / `)||t.t(`dir_r`),ariaLabel:f(`R`),onClick:()=>m(e,`R`)})}
  ...
  `}function Dn(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=mn(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?A`
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=on(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return A`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${H(vn(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:M}function On(e,t){let n=(n,r)=>{let i=e();i&&t(i.map(e=>e.entity===n?r({...e}):e))};return{toggleLine:(e,t)=>n(e,e=>{let n=new Set(e.lines??[]);return n.has(t)?n.delete(t):n.add(t),n.size?e.lines=[...n]:delete e.lines,e}),setDirections:(e,t)=>n(e,e=>(t.direction===null?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>n(e,e=>{let n={...e.walk_times??{}};return r===null?delete n[t]:n[t]=r,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:n=>{let r=e();r&&t(r.filter(e=>e.entity!==n))}}}function kn(e,t){let n=Array.isArray(t)?t.filter(e=>typeof e==`string`&&e.length>0):[],r=new Map(e.map(e=>[e.entity,e]));return n.map(e=>r.get(e)??{entity:e})}function An(e,t,n){let r={...e??{},[t]:n};return n===void 0&&delete r[t],r}function jn(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function Mn(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Nn(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0,composed:!0}))}const Pn=new Set([`small`,`medium`,`regular`]),Fn=new Set([`line`,`white`,`black`]);function In(e){return typeof e==`string`&&(Fn.has(e)||e.startsWith(`line:`)&&e.length>5)?e:q.station_bg.flap}function Ln(e,t){return typeof e==`boolean`?e:t}function Rn(e){if(typeof e==`string`)return e.startsWith(`sensor.`)?{entity:e}:null;if(!e||typeof e!=`object`)return null;let t=e,n=typeof t.entity==`string`?t.entity:null;return n?.startsWith(`sensor.`)?Yt(n,t):null}const zn=new Set([`type`,`entities`,`entity`,`line`,`lines`,`direction`,`walk_times`,`size`,`max_rows`,`show_platform`,`show_station_name`,`show_station_header`,`station_bg`,`show_min_unit`,`show_accessibility`,`accessibility_only`,`show_header`,`header_left`,`header_right`,`hide_attribution`,`show_line_column`,`line_pill`,`housing`]);function Bn(e){let t=Pn.has(e.size)?e.size:q.size.flap,n=Number(e.max_rows),r=Number.isFinite(n);e.max_rows!==void 0&&!r&&console.warn(`[wiener-linien-austria-flap-card] max_rows ${JSON.stringify(e.max_rows)} is not a number — falling back to 2`);let i=r?Math.max(1,Math.min(8,Math.round(n))):2,a=[];if(Array.isArray(e.entities))a=e.entities;else if(typeof e.entity==`string`){let t;Array.isArray(e.lines)?t=e.lines.filter(e=>typeof e==`string`&&e.length>0):typeof e.line==`string`&&e.line&&(t=[e.line]),a=[{entity:e.entity,...t&&t.length?{lines:t}:{},...e.direction===void 0?{}:{direction:e.direction},...e.walk_times===void 0?{}:{walk_times:e.walk_times}}]}let o=[],s=new Set;for(let e of a){let t=Rn(e);if(!t){console.warn(`[wiener-linien-austria-flap-card] dropping malformed stop entry`,e);continue}s.has(t.entity)||(s.add(t.entity),o.push(t))}let c=Kt(e,zn),l=In(e.station_bg),u=e.show_station_header,d=typeof e.show_station_name==`boolean`?e.show_station_name:typeof u==`boolean`?u:q.show_station_name.flap;return{...c,type:e.type||`custom:wiener-linien-austria-flap-card`,entities:o,size:t,max_rows:i,show_platform:Ln(e.show_platform,q.show_platform.flap),show_station_name:d,station_bg:l,show_min_unit:Ln(e.show_min_unit,q.unit_caption.flap),show_accessibility:Ln(e.show_accessibility,!0),accessibility_only:e.accessibility_only===!0,show_header:e.show_header===!0,header_left:Gt(e.header_left),header_right:Gt(e.header_right),hide_attribution:e.hide_attribution===!0,show_line_column:e.show_line_column===void 0?e.line_pill!==!0:e.show_line_column===!0,housing:Ln(e.housing,q.housing.flap)}}function Y(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let X=class extends L{constructor(...e){super(...e),this._tab=`stops`,this._headerSide=`header_left`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Bn({...this._config,entities:kn(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>jn(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n;return Mn(this._i18n,e.name,{...this._config?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)}})}}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card-editor: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card-editor: 'entity' must be a string`);this._config=Bn(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`)||e.has(`_headerSide`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._config.entities.map(e=>e.entity);return n.length===0||n.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return vt(`flap`,this.hass?.language)}_commit(e){this._config=e,Nn(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Bn({...this._config,...e}))}get _stopCallbacks(){return On(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return M;let{et:e}=this._i18n;return A`
    ...
    `}_patchHeaderSide(e,t,n){this._config&&this._patch({[e]:An(this._config[e],t,n)})}_stationBgOptions(){let{et:e}=this._i18n,t=[{value:`line`,label:e(`station_bg_line`)}],n=new Set;for(let e of this._config?.entities??[]){let t=this.hass?.states?.[e.entity]?.attributes,r=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(let e of r??[])typeof e==`string`&&e&&n.add(e)}if(n.size===0){let e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(let e of Object.keys(t??{}))n.add(e)}for(let e of[...n].sort())t.push({value:`line:${e}`,label:e});return t.push({value:`white`,label:e(`station_bg_white`)}),t.push({value:`black`,label:e(`station_bg_black`)}),t}static{this.styles=[gt,ht,_t]}};Y([Ie({attribute:!1})],X.prototype,`hass`,void 0),Y([R()],X.prototype,`_config`,void 0),Y([R()],X.prototype,`_tab`,void 0),Y([R()],X.prototype,`_headerSide`,void 0),X=Y([Ne(`wiener-linien-austria-flap-card-editor`)],X);function Vn(e){return Hn(e,e=>typeof e.diva==`number`&&Array.isArray(e.departures)&&!!e.next_by_line&&typeof e.next_by_line==`object`)}function Hn(e,t){if(!e)return[];let n=[];for(let[r,i]of Object.entries(e.states??{}))r.startsWith(`sensor.`)&&t(i?.attributes??{})&&n.push(r);return n.sort()}function Un(e,t){return!e||!t?{}:e.states?.[t]?.attributes?.line_colors??{}}function Wn(e,t){if(!e)return{};let n={};for(let r of t)for(let[t,i]of Object.entries(Un(e,r)))t in n||(n[t]=i);return n}function Gn(e){if(!e)return null;let t=Date.parse(e);if(!Number.isFinite(t))return null;let n=new Date(t);return`${String(n.getHours()).padStart(2,`0`)}:${String(n.getMinutes()).padStart(2,`0`)}`}function Z(e){return String(e).padStart(2,`0`)}function Kn(e,t,n=`de`){if(!t)return``;let r=n===`en`?`en-GB`:`de-AT`,i=()=>e.toLocaleDateString(r,{weekday:`long`}),a=()=>e.toLocaleDateString(r,{weekday:`short`}),o=()=>e.toLocaleDateString(r,{month:`long`}),s=()=>e.toLocaleDateString(r,{month:`short`}),c=``,l=0;for(;l<t.length;){let n=t[l];if(n===`\\`&&l+1<t.length){c+=t[l+1],l+=2;continue}switch(n){case`d`:c+=Z(e.getDate());break;case`j`:c+=String(e.getDate());break;case`D`:c+=a();break;case`l`:c+=i();break;case`m`:c+=Z(e.getMonth()+1);break;case`n`:c+=String(e.getMonth()+1);break;case`M`:c+=s();break;case`F`:c+=o();break;case`Y`:c+=String(e.getFullYear());break;case`y`:c+=Z(e.getFullYear()%100);break;case`H`:c+=Z(e.getHours());break;case`G`:c+=String(e.getHours());break;case`h`:c+=Z((e.getHours()+11)%12+1);break;case`g`:c+=String((e.getHours()+11)%12+1);break;case`i`:c+=Z(e.getMinutes());break;case`s`:c+=Z(e.getSeconds());break;default:c+=n??``}l++}return c}function qn(e,t,n){if(!e||!t)return null;let r=Date.parse(e);return Number.isFinite(r)?Kn(new Date(r),t,n):null}function Jn(e,t,n,r,i){let a=M;if(e.exit===`regular`||e.exit===`accessible`){let n=e.exit===`regular`?`exit`:`exit-access`;a=Dt(n,{ariaLabel:r(`header.${Ct[n].labelKey}`),flipX:Ct[n].glyphPointsTo!==t})}else if(e.exit&&Et(e.exit)){let n=Tt[e.exit];a=Ot(e.exit,{ariaLabel:r(`header.${n.labelKey}`),flipX:n.glyphPointsTo!==void 0&&n.glyphPointsTo!==t})}let o=e.text?A`<span class="retro-station-header__text">${e.text}</span>`:M,s=e=>Dt(e,{ariaLabel:r(`header.${Ct[e].labelKey}`)}),c=e.show_wc?s(`wc`):M,l=e.show_escalator?s(`escalator`):M,u=e.show_elevator?s(`elevator`):M,d=(e.extra_icons??[]).map(e=>kt(e,e)),f=[...d].reverse(),p=(e.chips??[]).map(e=>A`<span class="retro-station-header__chip">${e}</span>`),m=[...p].reverse(),h=e.show_clock?Gn(n):null,g=h?A`<span
      ...
      >
        ...
        ></ha-icon>
        <span>${h}</span>
      </span>`:M,_=e.show_date?qn(n,e.date_format??`d.m.Y`,i):null,v=_?A`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${_}</span
      >`:M;return t===`left`?A`${a}${o}${u}${l}${c}${d}${p}${v}${g}`:A`${g}${v}${m}${f}${c}${l}${u}${o}${a}`}function Yn(e){let{left:t,right:n,serverTime:r,t:i,lang:a}=e;return!t&&!n?M:A`
  ...
  `}const Xn=`ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß`,Zn=`0123456789`;function Qn(e,t,n){let r=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return r===e.length?n:e[r]}function $n(e,t){if(e===t)return t;let n=Xn.includes(e),r=Zn.includes(e),i=Xn.includes(t),a=Zn.includes(t);return(n||i)&&!r&&!a?Qn(Xn,e,t):(r||a)&&!n&&!i?Qn(Zn,e,t):t}function Q(e,t){return`row${e}-${t}`}const er={small:22,medium:28,regular:32};function tr(e){let t=typeof e==`number`&&Number.isFinite(e)?e:null;return t===null?`--`:String(t<=0?0:t).padStart(2,` `)}{let e=window;e.customCards=e.customCards??[],e.customCards.some(e=>e.type===`wiener-linien-austria-flap-card`)||e.customCards.push({type:`wiener-linien-austria-flap-card`,name:`Wiener Linien Austria — Flap Board`,description:ut(`picker_flap`),preview:!0,getEntitySuggestion:(e,t)=>!t.startsWith(`sensor.`)||e?.entities?.[t]?.platform!==`wiener_linien_austria`?null:{config:{type:`custom:wiener-linien-austria-flap-card`,entities:[t]}}})}let $=class extends L{constructor(...e){super(...e),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card: 'entity' must be a string`);let t=Bn(e);if((Array.isArray(e.entities)?e.entities.length:typeof e.entity==`string`&&e.entity?1:0)>0&&t.entities.length===0)throw Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:`auto`,min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement(`wiener-linien-austria-flap-card-editor`)}static getStubConfig(e){let t=Vn(e)[0];if(!t)return{};let n=`H`,r=e?.states?.[t]?.attributes?.departures;if(Array.isArray(r)){let e=r.some(e=>e.direction===`H`),t=r.some(e=>e.direction===`R`);!e&&t&&(n=`R`)}return{entity:t,direction:n}}connectedCallback(){super.connectedCallback(),We(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_versionMismatch`)||e.has(`_displayed`)||e.has(`_target`)||e.has(`_justFlipped`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._resolveStopEids();return n.length!==0&&n.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config||!e.has(`hass`)&&!e.has(`_config`))return;let t=this._gatherRows(),n=this._maxDestLen(t),r=this._maxLineLen(t);for(let e=0;e<t.length;e++){let i=t[e];i&&(this._diffFlipField(Q(e,`line`),(i.line??`?`).toUpperCase().padStart(r,` `)),this._diffFlipField(Q(e,`dest`),(i.towards??``).toUpperCase().padEnd(n,` `)),this._diffFlipField(Q(e,`cd`),tr(i.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Q(e,`line`),null),this._diffFlipField(Q(e,`dest`),null),this._diffFlipField(Q(e,`cd`),null)}_clearFlipTimer(){this._marchTimer!==null&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(t===null){if(e in this._displayed){let{[e]:t,...n}=this._displayed;this._displayed=n}if(e in this._target){let{[e]:t,...n}=this._target;this._target=n}if(e in this._justFlipped){let{[e]:t,...n}=this._justFlipped;this._justFlipped=n}return}if(this._displayed[e]===void 0){this._displayed={...this._displayed,[e]:t},this._target={...this._target,[e]:t};return}this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}_ensureMarchTimer(){this._marchTimer===null&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){let e={...this._displayed},t={},n=!1;for(let[r,i]of Object.entries(this._target)){let a=e[r]??``;if(a===i)continue;let o=Math.max(a.length,i.length),s=[],c={};for(let e=0;e<o;e++){let t=a[e]??` `,n=i[e]??` `;t===n?s.push(t):(c[e]=t,s.push($n(t,n)))}e[r]=s.join(``),Object.keys(c).length>0&&(t[r]=c,n=!0)}this._displayed=e,this._justFlipped=t,n||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await dt(this.hass,`wiener_linien_austria/flap_card_version`,`2.0.0`)}catch(e){console.warn(`[wiener-linien-austria-flap-card] version probe failed`,e)}}_resolveStopEids(){let e=this._config?.entities??[],t=this.hass?.states,n=e.map(e=>e.entity).filter(e=>t?.[e]);if(n.length===0&&e.length===0){let e=Vn(this.hass)[0];e&&n.push(e)}return n.length===0&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(`, `)})`)),n}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??``).length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??`?`).length))}_gatherRows(){if(!this._config)return[];let e=this._config.entities??[],t=this._config.accessibility_only,n=[];for(let r of e){let e=this.hass?.states?.[r.entity]?.attributes??{},i=pn(Array.isArray(e.departures)?e.departures:[],{direction:r.direction,lines:r.lines,line_directions:r.line_directions,walk_times:r.walk_times,accessibility_only:t});n.push(...i)}let r=e=>Number.isFinite(e.countdown)?e.countdown:1/0;return n.sort((e,t)=>r(e)-r(t)),n.slice(0,this._config.max_rows)}_t(e,t){return U(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return M;let e=this._config,t=this._resolveStopEids(),n=this._gatherRows(),r=t[0]??``,i=r?this.hass?.states?.[r]?.attributes??{}:{},a=i.stop_name||i.friendly_name||``,o=i.server_time,s=Wn(this.hass,t),c=e.show_platform&&n.some(e=>e.platform),l=(n[0]?.type??``)===hn,u=this._t(l?`gleis`:`steig`),d=this.hass?.themes?.darkMode===!1,f={flap:!0,[`flap--size-${e.size}`]:e.size!==`regular`,"flap--has-platform":c,"flap--light":d,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},p=this._resolveStationHeaderStyle(e.station_bg,e.entities,n,s),m=e.show_header?Yn({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):M,h=e.hide_attribution?``:typeof i.attribution==`string`&&i.attribution||`Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0`;return A`
    ...
    `}_renderRow(e,t,n,r,i,a,o){let s=this._config,c=Number.isFinite(e.countdown)?e.countdown:null,l=c!==null&&c<=0,u=(e.line??`?`).toUpperCase(),d=u.padStart(o,` `),f=(e.towards??``).toUpperCase(),p=[u,f,c===null?this._t(`no_data`):l?this._t(`at_platform`):this._t(`countdown_minutes`,{n:String(c)}),e.timetable?this._t(`timetable_title`):``].filter(Boolean).join(` — `),m=Xt(u,{},n),h=m.background===`var(--primary-color)`?{blankSpace:!0}:{tileBg:m.background,blankSpace:!0},g=this._renderFlipString(tr(e.countdown),Q(t,`cd`),{blankSpace:!0}),_=r?A`<div class="flap-cell flap-cell--platform" aria-hidden="true">
