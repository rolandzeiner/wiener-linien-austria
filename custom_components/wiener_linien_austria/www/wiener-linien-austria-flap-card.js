...
`;function Ge(e,t,i){return I`
  ...
  `}function qe(e,t){return I`
    <section class="wl-section">
      <header class="wl-section-header">
        <span class="wl-section-title">${e.title}</span>
        ${e.hint?I`<span class="wl-section-hint">${e.hint}</span>`:q}
      </header>
      <div class="wl-section-body">${t}</div>
    </section>
  `}function Ze(e){return qe(e,I`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
  ...
  `}(t,i,n):q}
    ...
    <div class="wl-group">
      <div class="wl-group-head">
        ...
        ${a.length?I`<span class="wl-note">${l}</span>`:q}
      </div>
  ...
  `}(t,i,n,{lines:c,picked:d,colorOf:l,typeByLine:p})}
        ${!r&&c.length?function(e,t,i,n){const{triplets:a,picked:r,lines:s,dirStrings:o}=n,l=e.direction??null,c=ft(a),d=c.has("H"),h=c.has("R"),p=1===c.size,_="H"===l||null===l&&p&&d,u="R"===l||null===l&&p&&h,f=null===l&&!p,g=e=>function(e,t){return 0===e.size||e.has(t)}(c,e)?dt(ut(a,e),o(e)):`${o(e).short}: ${t.et("direction_not_served")}`,m=[...r][0]??s[0],b=h?"":t.et("direction_note_one_way").replace("{line}",m??"");return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${mt({label:g("H"),active:_,disabled:!d,title:d?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>i.setDirection(e.entity,"H")})}
        ${mt({label:g("R"),active:u,disabled:!h,title:h?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>i.setDirection(e.entity,"R")})}
        ${t.singleLine?q:mt({label:t.t("dir_both"),active:f,disabled:p,title:p?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>i.setDirection(e.entity,null)})}
      </div>
      ${b?I`<span class="wl-note">${b}</span>`:q}
    </div>
  `}(t,i,n,{triplets:h,picked:d,lines:c,dirStrings:_}):q}
        ${r||i.singleLine?q:function(e,t,i,n){const{triplets:a,picked:r,lines:s,colorOf:o,dirStrings:l}=n,c=r.size>0?s.filter(e=>r.has(e)):s;if(c.length<2)return q;const d=e.line_directions??{},h=e.direction??null;return I`
    <div class="wl-group wl-divide">
      <span class="wl-label">${t.et("per_line_direction_label")}</span>
      ${c.map(n=>{const r=ft(a,n),s=d[n]??null,c=r.has("H"),h=r.has("R"),p=1===r.size,_=e=>t.et("per_line_direction_aria").replace("{line}",n).replace("{direction}",null===e?t.t("dir_both"):dt(ut(a,e,n),l(e)));return I`
          <div class="wl-override-row">
            <span class="wl-badge" style=${ze({background:o(n)})}
              >${n}</span
            >
            <div class="wl-dirs">
              ${mt({label:l("H").short,active:"H"===s||null===s&&p&&c,disabled:!c,compact:!0,title:ut(a,"H",n).join(" / ")||t.t("dir_h"),ariaLabel:_("H"),onClick:()=>i.setLineDirection(e.entity,n,"H")})}
              ${mt({label:l("R").short,active:"R"===s||null===s&&p&&h,disabled:!h,compact:!0,title:ut(a,"R",n).join(" / ")||t.t("dir_r"),ariaLabel:_("R"),onClick:()=>i.setLineDirection(e.entity,n,"R")})}
              ${mt({label:"",icon:"mdi:swap-horizontal",active:null===s&&!p,disabled:p,compact:!0,title:t.t("dir_both"),ariaLabel:_(null),onClick:()=>i.setLineDirection(e.entity,n,null)})}
            </div>
          </div>
        `})}
      ${null===h?q:I`<span class="wl-note">${t.et("per_line_direction_hint")}</span>`}
    </div>
  `}(t,i,n,{triplets:h,picked:d,lines:c,colorOf:l,dirStrings:_})}
        ${r?q:function(e,t,i,n){const{attrs:a,picked:r,colorOf:s}=n,o=e.line_directions??{},l=e.direction??null,c=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),n=ct(i.line,e);let a=t.get(n);a||(a={line:i.line,direction:e,type:i.type,termini:[]},t.set(n,a)),i.towards&&!a.termini.includes(i.towards)&&a.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(a).filter(e=>{if(r.size>0&&!r.has(e.line))return!1;const t=o[e.line]??l;return!t||e.direction===t});return c.length?I`
    <div class="wl-group wl-divide">
      <div class="wl-group-head">
  ...
  `:q}(t,i,n,{attrs:a,picked:d,colorOf:l})}
      </div>
    </section>
  `}function mt(e){return I`<button
    type="button"
...
let $t=class extends ce{constructor(){super(...arguments),this._tab="stops",this._headerSide="header_left",this._onEntitiesChanged=e=>{if(e.stopPropagation(),!this._config)return;const t=e.detail.value.entities,i=Array.isArray(t)?t.filter(e=>"string"==typeof e&&e.length>0):[],n=new Map(this._config.entities.map(e=>[e.entity,e]));this._commit({...this._config,entities:i.map(e=>n.get(e)??{entity:e})})},this._computeLabel=e=>{const t=this.hass?.localize?.(`ui.panel.lovelace.editor.card.generic.${e.name}`);return t||this._i18n.et(e.name)},this._computeHelper=e=>{const{et:t}=this._i18n;if("accessibility_only"===e.name&&!this._config?.show_accessibility)return t("accessibility_only_requires");const i=`${e.name}_helper`,n=t(i);return n===i?void 0:n}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card-editor: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card-editor: 'entity' must be a string");this._config=kt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab")||e.has("_headerSide"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return 0===i.length||i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>Ue(`${e}.${t}`,i),et:t=>{const n=`${e}.editor.${t}`,a=Ue(n,i);if(a!==n)return a;const r=`common.editor.${t}`,s=Ue(r,i);return s===r?t:s}}}("flap",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(kt({...this._config,...e}))}_updateStop(e,t){if(!this._config)return;const i=this._config.entities.map(i=>i.entity===e?t({...i}):i);this._commit({...this._config,entities:i})}get _stopCallbacks(){return{toggleLine:(e,t)=>this._updateStop(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirection:(e,t)=>this._updateStop(e,e=>(null===t?delete e.direction:e.direction=t,e)),setLineDirection:(e,t,i)=>this._updateStop(e,e=>{const n={...e.line_directions??{}};return null===i?delete n[t]:n[t]=i,Object.keys(n).length?e.line_directions=n:delete e.line_directions,e}),setWalkTime:(e,t,i)=>this._updateStop(e,e=>{const n={...e.walk_times??{}};return null===i?delete n[t]:n[t]=i,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:e=>{this._config&&this._commit({...this._config,entities:this._config.entities.filter(t=>t.entity!==e)})}}}render(){if(!this._config)return q;const{et:e}=this._i18n;return I`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return I`
      ...
      ></ha-form>
      ${e.entities.map((n,a)=>gt(this.hass,n,{index:a+1,total:e.entities.length,lineColorOverrides:{},t:t,et:i},this._stopCallbacks))}
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return I`
      ${qe({title:t("section_header"),hint:t("section_header_hint")},I`
          <ha-form
            .hass=${this.hass}
          ...
          ></ha-form>
          ${e.show_header?it({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,i)=>this._patchHeaderSide(e,t,i)}):q}
        `)}
      ...
      ${Ze({...i,title:t("section_display"),hint:t("section_display_hint"),data:{max_rows:e.max_rows,show_platform:e.show_platform,show_accessibility:e.show_accessibility,accessibility_only:e.accessibility_only,show_min_unit:e.show_min_unit,size:e.size,hide_attribution:e.hide_attribution},schema:[{name:"max_rows",selector:{number:{min:1,max:8,step:1,mode:"slider"}}},{name:"show_platform",selector:{boolean:{}}},{name:"show_accessibility",selector:{boolean:{}}},{name:"accessibility_only",disabled:!e.show_accessibility,selector:{boolean:{}}},{name:"show_min_unit",selector:{boolean:{}}},{name:"size",selector:{select:{mode:"dropdown",options:[{value:"small",label:t("size_small")},{value:"medium",label:t("size_medium")},{value:"regular",label:t("size_regular")}]}}},{name:"hide_attribution",selector:{boolean:{}}}]})}
    `}_renderTweaks(){const e=this._config,{et:t}=this._i18n;return Ze({hass:this.hass,title:t("section_tweaks"),hint:t("section_tweaks_hint"),data:{show_line_column:e.show_line_column,housing:e.housing},schema:[{name:"show_line_column",selector:{boolean:{}}},{name:"housing",selector:{boolean:{}}}],computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)})}_patchHeaderSide(e,t,i){if(!this._config)return;const n={...this._config[e]??{},[t]:i};void 0===i&&delete n[t],this._patch({[e]:n})}_stationBgOptions(){const{et:e}=this._i18n,t=[{value:"line",label:e("station_bg_line")}],i=new Set;for(const e of this._config?.entities??[]){const t=this.hass?.states?.[e.entity]?.attributes,n=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(const e of n??[])"string"==typeof e&&e&&i.add(e)}if(0===i.size){const e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(const e of Object.keys(t??{}))i.add(e)}for(const e of[...i].sort())t.push({value:`line:${e}`,label:e});return t.push({value:"white",label:e("station_bg_white")}),t.push({value:"black",label:e("station_bg_black")}),t}static{this.styles=[Ke,Ie]}};function St(e){if(!e)return[];const t=[];for(const[i,n]of Object.entries(e.states??{})){if(!i.startsWith("sensor."))continue;const e=n?.attributes??{};"number"==typeof e.diva&&(Array.isArray(e.departures)&&e.next_by_line&&"object"==typeof e.next_by_line&&t.push(i))}return t.sort(),t}function At(e){return String(e).padStart(2,"0")}function zt(e,t,i){if(!e||!t)return null;const n=Date.parse(e);return Number.isFinite(n)?function(e,t,i="de"){if(!t)return"";const n="en"===i?"en-GB":"de-AT",a=()=>e.toLocaleDateString(n,{weekday:"long"}),r=()=>e.toLocaleDateString(n,{weekday:"short"}),s=()=>e.toLocaleDateString(n,{month:"long"}),o=()=>e.toLocaleDateString(n,{month:"short"});let l="",c=0;for(;c<t.length;){const i=t[c];if("\\"===i&&c+1<t.length)l+=t[c+1],c+=2;else{switch(i){case"d":l+=At(e.getDate());break;case"j":l+=String(e.getDate());break;case"D":l+=r();break;case"l":l+=a();break;case"m":l+=At(e.getMonth()+1);break;case"n":l+=String(e.getMonth()+1);break;case"M":l+=o();break;case"F":l+=s();break;case"Y":l+=String(e.getFullYear());break;case"y":l+=At(e.getFullYear()%100);break;case"H":l+=At(e.getHours());break;case"G":l+=String(e.getHours());break;case"h":l+=At((e.getHours()+11)%12+1);break;case"g":l+=String((e.getHours()+11)%12+1);break;case"i":l+=At(e.getMinutes());break;case"s":l+=At(e.getSeconds());break;default:l+=i??""}c++}}return l}(new Date(n),t,i):null}function Lt(e,t,i,n,a){let r=q;if("regular"===e.exit||"accessible"===e.exit){const i="regular"===e.exit?"exit":"exit-access";r=Je(i,{ariaLabel:n(`header.${Ve[i].labelKey}`),flipX:Ve[i].glyphPointsTo!==t})}else if(e.exit&&function(e){return"string"==typeof e&&e in Qe}(e.exit)){const i=Qe[e.exit];r=function(e,t){const i=t.flipX?"retro-station-header__mdi retro-station-header__mdi--flip-x":"retro-station-header__mdi";return I`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${t.ariaLabel}>
    <ha-icon class=${i} icon=${e}></ha-icon>
  </span>`}(e.exit,{ariaLabel:n(`header.${i.labelKey}`),flipX:void 0!==i.glyphPointsTo&&i.glyphPointsTo!==t})}const s=e.text?I`<span class="retro-station-header__text">${e.text}</span>`:q,o=e=>Je(e,{ariaLabel:n(`header.${Ve[e].labelKey}`)}),l=e.show_wc?o("wc"):q,c=e.show_escalator?o("escalator"):q,d=e.show_elevator?o("elevator"):q,h=(e.extra_icons??[]).map(e=>I`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${e}>
...
const Et="ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß",Ct="0123456789";function Rt(e,t,i){const n=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return n===e.length?i:e[n]}function Tt(e,t){if(e===t)return t;const i=Et.includes(e),n=Ct.includes(e),a=Et.includes(t),r=Ct.includes(t);return!i&&!a||n||r?!n&&!r||i||a?t:Rt(Ct,e,t):Rt(Et,e,t)}function Ht(e,t){return`row${e}-${t}`}const Mt={small:22,medium:28,regular:32};function Dt(e){const t="number"==typeof e&&Number.isFinite(e)?e:null;return null===t?"--":String(t<=0?0:t).padStart(2," ")}{const e=window;e.customCards=e.customCards??[],e.customCards.some(e=>"wiener-linien-austria-flap-card"===e.type)||e.customCards.push({type:"wiener-linien-austria-flap-card",name:"Wiener Linien Austria — Flap Board",description:"Solari-style split-flap departure board",preview:!0,getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"wiener_linien_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:wiener-linien-austria-flap-card",entities:[t]}}:null})}let Wt=class extends ce{constructor(){super(...arguments),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card: 'entity' must be a string");this._config=kt(e),this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-flap-card-editor")}static getStubConfig(e){const t=St(e)[0];if(!t)return{};let i="H";const n=e?.states?.[t]?.attributes?.departures;if(Array.isArray(n)){const e=n.some(e=>"H"===e.direction),t=n.some(e=>"R"===e.direction);!e&&t&&(i="R")}return{entity:t,direction:i}}connectedCallback(){super.connectedCallback(),function(){if("undefined"==typeof document)return;if(document.getElementById(Le))return;const e=document.createElement("style");e.id=Le,e.textContent='\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans Condensed";\n  src: url("/wiener-linien-austria/fonts/wl-sans-condensed-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n',document.head.appendChild(e)}(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion())}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_versionMismatch")||e.has("_displayed")||e.has("_target")||e.has("_justFlipped"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStopEids();return 0!==i.length&&i.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config)return;if(!e.has("hass")&&!e.has("_config"))return;const t=this._gatherRows(),i=this._maxDestLen(t),n=this._maxLineLen(t);for(let e=0;e<t.length;e++){const a=t[e];a&&(this._diffFlipField(Ht(e,"line"),(a.line??"?").toUpperCase().padStart(n," ")),this._diffFlipField(Ht(e,"dest"),(a.towards??"").toUpperCase().padEnd(i," ")),this._diffFlipField(Ht(e,"cd"),Dt(a.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Ht(e,"line"),null),this._diffFlipField(Ht(e,"dest"),null),this._diffFlipField(Ht(e,"cd"),null)}_clearFlipTimer(){null!==this._marchTimer&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(null!==t){if(void 0===this._displayed[e])return this._displayed={...this._displayed,[e]:t},void(this._target={...this._target,[e]:t});this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}else{if(e in this._displayed){const{[e]:t,...i}=this._displayed;this._displayed=i}if(e in this._target){const{[e]:t,...i}=this._target;this._target=i}if(e in this._justFlipped){const{[e]:t,...i}=this._justFlipped;this._justFlipped=i}}}_ensureMarchTimer(){null===this._marchTimer&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){const e={...this._displayed},t={};let i=!1;for(const[n,a]of Object.entries(this._target)){const r=e[n]??"";if(r===a)continue;const s=Math.max(r.length,a.length),o=[],l={};for(let e=0;e<s;e++){const t=r[e]??" ",i=a[e]??" ";t===i?o.push(t):(l[e]=t,o.push(Tt(t,i)))}const c=o.join("");e[n]=c,Object.keys(l).length>0&&(t[n]=l,i=!0)}this._displayed=e,this._justFlipped=t,i||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const n=await e.callWS({type:t});if(n?.version&&n.version!==i)return n.version}catch{}return null}(this.hass,"wiener_linien_austria/flap_card_version","1.8.1")}catch(e){console.warn("[wiener-linien-austria-flap-card] version probe failed",e)}}_resolveStopEids(){const e=this._config?.entities??[],t=this.hass?.states,i=e.map(e=>e.entity).filter(e=>t?.[e]);if(0===i.length&&0===e.length){const e=St(this.hass)[0];e&&i.push(e)}return 0===i.length&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(", ")})`)),i}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??"").length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??"?").length))}_gatherRows(){if(!this._config)return[];const e=this._config.entities??[],t=this._config.accessibility_only,i=[];for(const n of e){const e=this.hass?.states?.[n.entity]?.attributes??{},a=ht(Array.isArray(e.departures)?e.departures:[],{direction:n.direction,lines:n.lines,line_directions:n.line_directions,walk_times:n.walk_times,accessibility_only:t});i.push(...a)}const n=e=>Number.isFinite(e.countdown)?e.countdown:Number.POSITIVE_INFINITY;return i.sort((e,t)=>n(e)-n(t)),i.slice(0,this._config.max_rows)}_t(e,t){return Ue(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return q;const e=this._config,t=this._resolveStopEids(),i=this._gatherRows(),n=t[0]??"",a=n?this.hass?.states?.[n]?.attributes??{}:{},r=a.stop_name||a.friendly_name||"",s=a.line_colors??{},o=a.server_time,l=e.show_platform&&i.some(e=>e.platform),c=(i[0]?.type??"")===pt,d=this._t(c?"gleis":"steig"),h=!1===this.hass?.themes?.darkMode,p={flap:!0,[`flap--size-${e.size}`]:"regular"!==e.size,"flap--has-platform":l,"flap--light":h,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},_=this._resolveStationHeaderStyle(e.station_bg,e.entities,i,s),u=e.show_header?function(e){const{left:t,right:i,serverTime:n,t:a,lang:r}=e;return t||i?I`
    <div class="retro-station-header" role="group">
      ...
      <div class="retro-station-header__side retro-station-header__side--right">
        ${i?Lt(i,"right",n,a,r):q}
      </div>
    </div>
  `:q}({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):q,f=e.hide_attribution?"":"string"==typeof a.attribution&&a.attribution||"Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0";return I`
    ...
    `}_resolveStationHeaderStyle(e,t,i,n){if("white"===e)return{background:"#ffffff",color:"#1a1410"};if("black"===e)return{background:"#000000",color:"var(--flap-cream-hi)"};let a;if("line"===e?a=t[0]?.lines?.[0]??i[0]?.line:e.startsWith("line:")&&(a=e.slice(5)),!a)return{background:"var(--wl-orange)"};const r=lt(a,{},n);return{background:"var(--primary-color)"===r.background?"var(--wl-orange)":r.background,color:"var(--flap-on-color-fg)"}}_renderBoard(e,t,i,n,a,r,s){const o=this._maxDestLen(t),l=this._maxLineLen(t);if(0===e.length)return I`<div class="flap-empty">${this._t("no_entity")}</div>`;if(0===t.length){const t=e.some(e=>{const t=this.hass?.states?.[e]?.attributes??{};return Array.isArray(t.departures)&&t.departures.length>0}),i=e.some(e=>{const t=this.hass?.states?.[e]?.attributes??{};return"number"==typeof t.stale_departures&&t.stale_departures>0}),n=t?"no_data":i?"stale_feed":"betriebsschluss";return I`<div class="flap-empty">${this._t(n)}</div>`}const c=Mt[this._config?.size??"regular"],d=o*c+2*Math.max(0,o-1),h=a?d+6+c:d;return I`
      ...
      >
        <div class="flap-colheader" aria-hidden="true">
          ${r?q:I`<span class="flap-colheader__line"
    ...
    `}_renderRow(e,t,i,n,a,r,s){const o=this._config,l=Number.isFinite(e.countdown)?e.countdown:null,c=null!==l&&l<=0,d=(e.line??"?").toUpperCase(),h=d.padStart(s," "),p=(e.towards??"").toUpperCase(),_=[d,p,null===l?this._t("no_data"):c?this._t("at_platform"):this._t("countdown_minutes",{n:String(l)})].filter(Boolean).join(" — "),u=lt(d,{},i),f="var(--primary-color)"!==u.background?{tileBg:u.background,blankSpace:!0}:{blankSpace:!0},g=this._renderFlipString(Dt(e.countdown),Ht(t,"cd"),{blankSpace:!0}),m=n?I`<div class="flap-cell flap-cell--platform" aria-hidden="true">
      ...
      <div class="flap-row" role="listitem" aria-label=${_}>
        ${a?q:I`<div class="flap-cell flap-cell--line" aria-hidden="true">
              ${this._renderFlipString(h,Ht(t,"line"),f)}
            </div>`}
        <div class="flap-cell flap-cell--dest" aria-hidden="true">
          ${this._renderFlipString(p.padEnd(r," "),Ht(t,"dest"),{blankSpace:!0})}
        ...
        <div class="flap-cell flap-cell--cd" aria-hidden="true">
          ...
          ${o.show_min_unit&&null!==l?I`<span class="flap-cd-unit">${this._t("unit_min")}</span>`:q}
        </div>
      </div>
  ...
  `}};e([ue({attribute:!1})],Wt.prototype,"hass",void 0),e([fe()],Wt.prototype,"_config",void 0),e([fe()],Wt.prototype,"_versionMismatch",void 0),e([fe()],Wt.prototype,"_displayed",void 0),e([fe()],Wt.prototype,"_target",void 0),e([fe()],Wt.prototype,"_justFlipped",void 0),Wt=e([he("wiener-linien-austria-flap-card")],Wt);export{Wt as WienerLinienAustriaFlapCard};
