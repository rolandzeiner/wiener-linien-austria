...
`;function qe(e,t,i){return I`
  ...
  `}(t,i,n):G}
    ...
    <div class="wl-group">
      ...
      ${a.length?I`<div class="wl-chips">
            ${a.map(n=>{const a=t.singleLine?r.has(n):0===r.size||r.has(n),l=function(e){switch(e){case vt:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}(o.get(n));return I`<button
                type="button"
                class="wl-chip"
  ...
  `}(t,i,n,{lines:c,picked:d,colorOf:l,typeByLine:p})}
        ${!r&&c.length?function(e,t){return!e.singleLine&&St(t.lines,t.picked).length>=2}(i,{lines:c,picked:d})?function(e,t,i,n){const{triplets:a,picked:r,lines:s,colorOf:o,dirStrings:l}=n,c=St(s,r),d=e.line_directions??{},h=e.direction??null,p=e=>d[e]??h,u=(t,n)=>{const a={};for(const e of c){const i=e===t?n:p(e);i&&(a[e]=i)}for(const[e,t]of Object.entries(d))c.includes(e)||(a[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:a})};return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${c.map(e=>{const i=$t(a,e),n=p(e),r=i.has("H"),s=i.has("R"),c=1===i.size,d=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):wt(kt(a,i,e),l(i)));return I`
          <div class="wl-override-row">
            <span class="wl-badge" style=${ze({background:o(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${zt({label:l("H").short,active:"H"===n||null===n&&c&&r,disabled:!r,compact:!0,title:kt(a,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:d("H"),onClick:()=>u(e,"H")})}
              ${zt({label:l("R").short,active:"R"===n||null===n&&c&&s,disabled:!s,compact:!0,title:kt(a,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:d("R"),onClick:()=>u(e,"R")})}
              ${zt({label:"",icon:"mdi:swap-horizontal",active:null===n&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:d(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,n,{triplets:h,picked:d,lines:c,colorOf:l,dirStrings:u}):function(e,t,i,n){const{triplets:a,picked:r,lines:s,dirStrings:o}=n,l=St(s,r),c=1===l.length?l[0]:void 0,d=e.direction??null,h=$t(a,c),p=h.has("H"),u=h.has("R"),_=1===h.size,f="H"===d||null===d&&_&&p,g="R"===d||null===d&&_&&u,m=null===d&&!_,b=t=>{const n={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(n[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:n})},w=e=>0===h.size||h.has(e)?wt(kt(a,e,c),o(e)):`${o(e).short}: ${t.et("direction_not_served")}`,y=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${zt({label:w("H"),active:f,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>b("H")})}
        ${zt({label:w("R"),active:g,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>b("R")})}
        ${t.singleLine?G:zt({label:t.t("dir_both"),active:m,disabled:_,title:_?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>b(null)})}
      </div>
      ${y?I`<span class="wl-note">${y}</span>`:G}
    </div>
  `}(t,i,n,{triplets:h,picked:d,lines:c,dirStrings:u}):G}
        ${r?G:function(e,t,i,n){const{attrs:a,picked:r,colorOf:s}=n,o=e.line_directions??{},l=e.direction??null,c=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),n=bt(i.line,e);let a=t.get(n);a||(a={line:i.line,direction:e,type:i.type,termini:[]},t.set(n,a)),i.towards&&!a.termini.includes(i.towards)&&a.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(a).filter(e=>{if(r.size>0&&!r.has(e.line))return!1;const t=o[e.line]??l;return!t||e.direction===t});return c.length?I`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${c.map(n=>{const a=bt(n.line,n.direction),r=e.walk_times?.[a],o=n.termini.join(" / "),l=t.et("walk_time_aria").replace("{line}",n.line).replace("{towards}",o),c=t=>{const n=(r??0)+t;i.setWalkTime(e.entity,a,n<1?null:Math.min(xt,n))};return I`
...
let Mt=class extends ce{constructor(){super(...arguments),this._tab="stops",this._headerSide="header_left",this._onEntitiesChanged=e=>{if(e.stopPropagation(),!this._config)return;const t=e.detail.value.entities,i=Array.isArray(t)?t.filter(e=>"string"==typeof e&&e.length>0):[],n=new Map(this._config.entities.map(e=>[e.entity,e]));this._commit({...this._config,entities:i.map(e=>n.get(e)??{entity:e})})},this._computeLabel=e=>{const t=this.hass?.localize?.(`ui.panel.lovelace.editor.card.generic.${e.name}`);return t||this._i18n.et(e.name)},this._computeHelper=e=>{const{et:t}=this._i18n;if("accessibility_only"===e.name&&!this._config?.show_accessibility)return t("accessibility_only_requires");const i=`${e.name}_helper`,n=t(i);return n===i?void 0:n}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card-editor: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card-editor: 'entity' must be a string");this._config=Ht(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab")||e.has("_headerSide"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return 0===i.length||i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>Ue(`${e}.${t}`,i),et:t=>{const n=`${e}.editor.${t}`,a=Ue(n,i);if(a!==n)return a;const r=`common.editor.${t}`,s=Ue(r,i);return s===r?t:s}}}("flap",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(Ht({...this._config,...e}))}_updateStop(e,t){if(!this._config)return;const i=this._config.entities.map(i=>i.entity===e?t({...i}):i);this._commit({...this._config,entities:i})}get _stopCallbacks(){return{toggleLine:(e,t)=>this._updateStop(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>this._updateStop(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,i)=>this._updateStop(e,e=>{const n={...e.walk_times??{}};return null===i?delete n[t]:n[t]=i,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:e=>{this._config&&this._commit({...this._config,entities:this._config.entities.filter(t=>t.entity!==e)})}}}render(){if(!this._config)return G;const{et:e}=this._i18n;return I`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return I`
      ...
      ></ha-form>
      ${e.entities.map((n,a)=>At(this.hass,n,{index:a+1,total:e.entities.length,lineColorOverrides:{},t:t,et:i},this._stopCallbacks))}
    ...
    `}_patchHeaderSide(e,t,i){if(!this._config)return;const n={...this._config[e]??{},[t]:i};void 0===i&&delete n[t],this._patch({[e]:n})}_stationBgOptions(){const{et:e}=this._i18n,t=[{value:"line",label:e("station_bg_line")}],i=new Set;for(const e of this._config?.entities??[]){const t=this.hass?.states?.[e.entity]?.attributes,n=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(const e of n??[])"string"==typeof e&&e&&i.add(e)}if(0===i.size){const e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(const e of Object.keys(t??{}))i.add(e)}for(const e of[...i].sort())t.push({value:`line:${e}`,label:e});return t.push({value:"white",label:e("station_bg_white")}),t.push({value:"black",label:e("station_bg_black")}),t}static{this.styles=[Ke,Ie]}};function Dt(e){if(!e)return[];const t=[];for(const[i,n]of Object.entries(e.states??{})){if(!i.startsWith("sensor."))continue;const e=n?.attributes??{};"number"==typeof e.diva&&(Array.isArray(e.departures)&&e.next_by_line&&"object"==typeof e.next_by_line&&t.push(i))}return t.sort(),t}function Ot(e){return String(e).padStart(2,"0")}function Pt(e,t,i){if(!e||!t)return null;const n=Date.parse(e);return Number.isFinite(n)?function(e,t,i="de"){if(!t)return"";const n="en"===i?"en-GB":"de-AT",a=()=>e.toLocaleDateString(n,{weekday:"long"}),r=()=>e.toLocaleDateString(n,{weekday:"short"}),s=()=>e.toLocaleDateString(n,{month:"long"}),o=()=>e.toLocaleDateString(n,{month:"short"});let l="",c=0;for(;c<t.length;){const i=t[c];if("\\"===i&&c+1<t.length)l+=t[c+1],c+=2;else{switch(i){case"d":l+=Ot(e.getDate());break;case"j":l+=String(e.getDate());break;case"D":l+=r();break;case"l":l+=a();break;case"m":l+=Ot(e.getMonth()+1);break;case"n":l+=String(e.getMonth()+1);break;case"M":l+=o();break;case"F":l+=s();break;case"Y":l+=String(e.getFullYear());break;case"y":l+=Ot(e.getFullYear()%100);break;case"H":l+=Ot(e.getHours());break;case"G":l+=String(e.getHours());break;case"h":l+=Ot((e.getHours()+11)%12+1);break;case"g":l+=String((e.getHours()+11)%12+1);break;case"i":l+=Ot(e.getMinutes());break;case"s":l+=Ot(e.getSeconds());break;default:l+=i??""}c++}}return l}(new Date(n),t,i):null}function Wt(e,t,i,n,a){let r=G;if("regular"===e.exit||"accessible"===e.exit){const i="regular"===e.exit?"exit":"exit-access";r=Xe(i,{ariaLabel:n(`header.${Ye[i].labelKey}`),flipX:Ye[i].glyphPointsTo!==t})}else if(e.exit&&function(e){return"string"==typeof e&&e in Je}(e.exit)){const i=Je[e.exit];r=function(e,t){const i=t.flipX?"retro-station-header__mdi retro-station-header__mdi--flip-x":"retro-station-header__mdi";return I`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${t.ariaLabel}>
...
const Nt="ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß",Bt="0123456789";function jt(e,t,i){const n=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return n===e.length?i:e[n]}function Ut(e,t){if(e===t)return t;const i=Nt.includes(e),n=Bt.includes(e),a=Nt.includes(t),r=Bt.includes(t);return!i&&!a||n||r?!n&&!r||i||a?t:jt(Bt,e,t):jt(Nt,e,t)}function Ft(e,t){return`row${e}-${t}`}const It={small:22,medium:28,regular:32};function Kt(e){const t="number"==typeof e&&Number.isFinite(e)?e:null;return null===t?"--":String(t<=0?0:t).padStart(2," ")}{const e=window;e.customCards=e.customCards??[],e.customCards.some(e=>"wiener-linien-austria-flap-card"===e.type)||e.customCards.push({type:"wiener-linien-austria-flap-card",name:"Wiener Linien Austria — Flap Board",description:"Solari-style split-flap departure board",preview:!0,getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"wiener_linien_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:wiener-linien-austria-flap-card",entities:[t]}}:null})}let qt=class extends ce{constructor(){super(...arguments),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card: 'entity' must be a string");const t=Ht(e);if((Array.isArray(e.entities)?e.entities.length:"string"==typeof e.entity&&e.entity?1:0)>0&&0===t.entities.length)throw new Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-flap-card-editor")}static getStubConfig(e){const t=Dt(e)[0];if(!t)return{};let i="H";const n=e?.states?.[t]?.attributes?.departures;if(Array.isArray(n)){const e=n.some(e=>"H"===e.direction),t=n.some(e=>"R"===e.direction);!e&&t&&(i="R")}return{entity:t,direction:i}}connectedCallback(){super.connectedCallback(),function(){if("undefined"==typeof document)return;if(document.getElementById(Ee))return;const e=document.createElement("style");e.id=Ee,e.textContent='\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans Condensed";\n  src: url("/wiener-linien-austria/fonts/wl-sans-condensed-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n',document.head.appendChild(e)}(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_versionMismatch")||e.has("_displayed")||e.has("_target")||e.has("_justFlipped"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStopEids();return 0!==i.length&&i.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config)return;if(!e.has("hass")&&!e.has("_config"))return;const t=this._gatherRows(),i=this._maxDestLen(t),n=this._maxLineLen(t);for(let e=0;e<t.length;e++){const a=t[e];a&&(this._diffFlipField(Ft(e,"line"),(a.line??"?").toUpperCase().padStart(n," ")),this._diffFlipField(Ft(e,"dest"),(a.towards??"").toUpperCase().padEnd(i," ")),this._diffFlipField(Ft(e,"cd"),Kt(a.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Ft(e,"line"),null),this._diffFlipField(Ft(e,"dest"),null),this._diffFlipField(Ft(e,"cd"),null)}_clearFlipTimer(){null!==this._marchTimer&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(null!==t){if(void 0===this._displayed[e])return this._displayed={...this._displayed,[e]:t},void(this._target={...this._target,[e]:t});this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}else{if(e in this._displayed){const{[e]:t,...i}=this._displayed;this._displayed=i}if(e in this._target){const{[e]:t,...i}=this._target;this._target=i}if(e in this._justFlipped){const{[e]:t,...i}=this._justFlipped;this._justFlipped=i}}}_ensureMarchTimer(){null===this._marchTimer&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){const e={...this._displayed},t={};let i=!1;for(const[n,a]of Object.entries(this._target)){const r=e[n]??"";if(r===a)continue;const s=Math.max(r.length,a.length),o=[],l={};for(let e=0;e<s;e++){const t=r[e]??" ",i=a[e]??" ";t===i?o.push(t):(l[e]=t,o.push(Ut(t,i)))}const c=o.join("");e[n]=c,Object.keys(l).length>0&&(t[n]=l,i=!0)}this._displayed=e,this._justFlipped=t,i||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const n=await e.callWS({type:t});if(n?.version&&n.version!==i)return n.version}catch{}return null}(this.hass,"wiener_linien_austria/flap_card_version","2.0.0")}catch(e){console.warn("[wiener-linien-austria-flap-card] version probe failed",e)}}_resolveStopEids(){const e=this._config?.entities??[],t=this.hass?.states,i=e.map(e=>e.entity).filter(e=>t?.[e]);if(0===i.length&&0===e.length){const e=Dt(this.hass)[0];e&&i.push(e)}return 0===i.length&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(", ")})`)),i}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??"").length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??"?").length))}_gatherRows(){if(!this._config)return[];const e=this._config.entities??[],t=this._config.accessibility_only,i=[];for(const n of e){const e=this.hass?.states?.[n.entity]?.attributes??{},a=yt(Array.isArray(e.departures)?e.departures:[],{direction:n.direction,lines:n.lines,line_directions:n.line_directions,walk_times:n.walk_times,accessibility_only:t});i.push(...a)}const n=e=>Number.isFinite(e.countdown)?e.countdown:Number.POSITIVE_INFINITY;return i.sort((e,t)=>n(e)-n(t)),i.slice(0,this._config.max_rows)}_t(e,t){return Ue(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return G;const e=this._config,t=this._resolveStopEids(),i=this._gatherRows(),n=t[0]??"",a=n?this.hass?.states?.[n]?.attributes??{}:{},r=a.stop_name||a.friendly_name||"",s=a.line_colors??{},o=a.server_time,l=e.show_platform&&i.some(e=>e.platform),c=(i[0]?.type??"")===vt,d=this._t(c?"gleis":"steig"),h=!1===this.hass?.themes?.darkMode,p={flap:!0,[`flap--size-${e.size}`]:"regular"!==e.size,"flap--has-platform":l,"flap--light":h,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},u=this._resolveStationHeaderStyle(e.station_bg,e.entities,i,s),_=e.show_header?function(e){const{left:t,right:i,serverTime:n,t:a,lang:r}=e;return t||i?I`
    ...
    `}_renderRow(e,t,i,n,a,r,s){const o=this._config,l=Number.isFinite(e.countdown)?e.countdown:null,c=null!==l&&l<=0,d=(e.line??"?").toUpperCase(),h=d.padStart(s," "),p=(e.towards??"").toUpperCase(),u=[d,p,null===l?this._t("no_data"):c?this._t("at_platform"):this._t("countdown_minutes",{n:String(l)})].filter(Boolean).join(" — "),_=mt(d,{},i),f="var(--primary-color)"!==_.background?{tileBg:_.background,blankSpace:!0}:{blankSpace:!0},g=this._renderFlipString(Kt(e.countdown),Ft(t,"cd"),{blankSpace:!0}),m=n?I`<div class="flap-cell flap-cell--platform" aria-hidden="true">
      ...
      <div class="flap-row" role="listitem" aria-label=${u}>
        ${a?G:I`<div class="flap-cell flap-cell--line" aria-hidden="true">
              ${this._renderFlipString(h,Ft(t,"line"),f)}
            </div>`}
        <div class="flap-cell flap-cell--dest" aria-hidden="true">
          ${this._renderFlipString(p.padEnd(r," "),Ft(t,"dest"),{blankSpace:!0})}
  ...
  `}};e([_e({attribute:!1})],qt.prototype,"hass",void 0),e([fe()],qt.prototype,"_config",void 0),e([fe()],qt.prototype,"_versionMismatch",void 0),e([fe()],qt.prototype,"_displayed",void 0),e([fe()],qt.prototype,"_target",void 0),e([fe()],qt.prototype,"_justFlipped",void 0),qt=e([he("wiener-linien-austria-flap-card")],qt);export{qt as WienerLinienAustriaFlapCard};
