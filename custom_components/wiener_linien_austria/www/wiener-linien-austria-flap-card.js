...
*/const Tt=Re(class extends ze{constructor(e){if(super(e),e.type!==R.PROPERTY&&e.type!==R.ATTRIBUTE&&e.type!==R.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ve(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===A||t===j)return t;let n=e.element,r=e.name;if(e.type===R.PROPERTY){if(t===n[r])return A}else if(e.type===R.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return A}else if(e.type===R.ATTRIBUTE&&n.getAttribute(r)===t+``)return A;return Ue(e),t}}),Et={exit:{kind:`svg`,viewBox:`0 0 36.29 29.04`,glyphPointsTo:`left`,labelKey:`icon_exit`,shapes:()=>k`
  ...
  `}const Jn=`ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß`,Yn=`0123456789`;function Xn(e,t,n){let r=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return r===e.length?n:e[r]}function Zn(e,t){if(e===t)return t;let n=Jn.includes(e),r=Yn.includes(e),i=Jn.includes(t),a=Yn.includes(t);return(n||i)&&!r&&!a?Xn(Jn,e,t):(r||a)&&!n&&!i?Xn(Yn,e,t):t}function Q(e,t){return`row${e}-${t}`}const Qn={small:22,medium:28,regular:32};function $n(e){let t=typeof e==`number`&&Number.isFinite(e)?e:null;return t===null?`--`:String(t<=0?0:t).padStart(2,` `)}{let e=window;e.customCards=e.customCards??[],e.customCards.some(e=>e.type===`wiener-linien-austria-flap-card`)||e.customCards.push({type:`wiener-linien-austria-flap-card`,name:`Wiener Linien Austria — Flap Board`,description:ft(`picker_flap`),preview:!0,getEntitySuggestion:(e,t)=>!t.startsWith(`sensor.`)||e?.entities?.[t]?.platform!==`wiener_linien_austria`?null:{config:{type:`custom:wiener-linien-austria-flap-card`,entities:[t]}}})}let $=class extends I{constructor(...e){super(...e),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card: 'entity' must be a string`);let t=zn(e);if((Array.isArray(e.entities)?e.entities.length:typeof e.entity==`string`&&e.entity?1:0)>0&&t.entities.length===0)throw Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:`auto`,min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement(`wiener-linien-austria-flap-card-editor`)}static getStubConfig(e){let t=Bn(e)[0];if(!t)return{};let n=`H`,r=e?.states?.[t]?.attributes?.departures;if(Array.isArray(r)){let e=r.some(e=>e.direction===`H`),t=r.some(e=>e.direction===`R`);!e&&t&&(n=`R`)}return{entity:t,direction:n}}connectedCallback(){super.connectedCallback(),Ke(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_versionMismatch`)||e.has(`_displayed`)||e.has(`_target`)||e.has(`_justFlipped`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._resolveStopEids();return n.length!==0&&n.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config||!e.has(`hass`)&&!e.has(`_config`))return;let t=this._gatherRows(),n=this._maxDestLen(t),r=this._maxLineLen(t);for(let e=0;e<t.length;e++){let i=t[e];i&&(this._diffFlipField(Q(e,`line`),(i.line??`?`).toUpperCase().padStart(r,` `)),this._diffFlipField(Q(e,`dest`),(i.towards??``).toUpperCase().padEnd(n,` `)),this._diffFlipField(Q(e,`cd`),$n(i.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Q(e,`line`),null),this._diffFlipField(Q(e,`dest`),null),this._diffFlipField(Q(e,`cd`),null)}_clearFlipTimer(){this._marchTimer!==null&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(t===null){if(e in this._displayed){let{[e]:t,...n}=this._displayed;this._displayed=n}if(e in this._target){let{[e]:t,...n}=this._target;this._target=n}if(e in this._justFlipped){let{[e]:t,...n}=this._justFlipped;this._justFlipped=n}return}if(this._displayed[e]===void 0){this._displayed={...this._displayed,[e]:t},this._target={...this._target,[e]:t};return}this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}_ensureMarchTimer(){this._marchTimer===null&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){let e={...this._displayed},t={},n=!1;for(let[r,i]of Object.entries(this._target)){let a=e[r]??``;if(a===i)continue;let o=Math.max(a.length,i.length),s=[],c={};for(let e=0;e<o;e++){let t=a[e]??` `,n=i[e]??` `;t===n?s.push(t):(c[e]=t,s.push(Zn(t,n)))}e[r]=s.join(``),Object.keys(c).length>0&&(t[r]=c,n=!0)}this._displayed=e,this._justFlipped=t,n||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await pt(this.hass,`wiener_linien_austria/flap_card_version`,`2.0.0`)}catch(e){console.warn(`[wiener-linien-austria-flap-card] version probe failed`,e)}}_resolveStopEids(){let e=this._config?.entities??[],t=this.hass?.states,n=e.map(e=>e.entity).filter(e=>t?.[e]);if(n.length===0&&e.length===0){let e=Bn(this.hass)[0];e&&n.push(e)}return n.length===0&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(`, `)})`)),n}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??``).length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??`?`).length))}_gatherRows(){if(!this._config)return[];let e=this._config.entities??[],t=this._config.accessibility_only,n=[];for(let r of e){let e=this.hass?.states?.[r.entity]?.attributes??{},i=mn(Array.isArray(e.departures)?e.departures:[],{direction:r.direction,lines:r.lines,line_directions:r.line_directions,walk_times:r.walk_times,accessibility_only:t});n.push(...i)}let r=e=>Number.isFinite(e.countdown)?e.countdown:1/0;return n.sort((e,t)=>r(e)-r(t)),n.slice(0,this._config.max_rows)}_t(e,t){return V(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return j;let e=this._config,t=this._resolveStopEids(),n=this._gatherRows(),r=t[0]??``,i=r?this.hass?.states?.[r]?.attributes??{}:{},a=i.stop_name||i.friendly_name||``,o=i.server_time,s=Hn(this.hass,t),c=e.show_platform&&n.some(e=>e.platform),l=(n[0]?.type??``)===gn,u=this._t(l?`gleis`:`steig`),d=this.hass?.themes?.darkMode===!1,f={flap:!0,[`flap--size-${e.size}`]:e.size!==`regular`,"flap--has-platform":c,"flap--light":d,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},p=this._resolveStationHeaderStyle(e.station_bg,e.entities,n,s),m=e.show_header?qn({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):j,h=e.hide_attribution?``:typeof i.attribution==`string`&&i.attribution||`Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0`;return O`
    ...
    `}_renderRow(e,t,n,r,i,a,o){let s=this._config,c=Number.isFinite(e.countdown)?e.countdown:null,l=c!==null&&c<=0,u=(e.line??`?`).toUpperCase(),d=u.padStart(o,` `),f=(e.towards??``).toUpperCase(),p=[u,f,c===null?this._t(`no_data`):l?this._t(`at_platform`):this._t(`countdown_minutes`,{n:String(c)})].filter(Boolean).join(` — `),m=Qt(u,{},n),h=m.background===`var(--primary-color)`?{blankSpace:!0}:{tileBg:m.background,blankSpace:!0},g=this._renderFlipString($n(e.countdown),Q(t,`cd`),{blankSpace:!0}),_=r?O`<div class="flap-cell flap-cell--platform" aria-hidden="true">
