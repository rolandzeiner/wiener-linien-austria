...
outline-offset: -2px;
    ...
    <div class="wl-tabs" role="tablist">
      ${e.map((n,r)=>K`<button
          ...
          aria-controls=${t===n.key?`wl-panel-${n.key}`:G}
  ...
  `}function Ve(e,t){return K`
    <section class="wl-section">
      <header class="wl-section-header">
        <span class="wl-section-title">${e.title}</span>
        ${e.hint?K`<span class="wl-section-hint">${e.hint}</span>`:G}
      </header>
      <div class="wl-section-body">${t}</div>
    </section>
  `}function Ze(e){return Ve(e,K`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
    ...
    ></ha-form>`)}const Ye=we(class extends ye{constructor(e){if(super(e),e.type!==me&&e.type!==ge&&e.type!==be)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===q||t===G)return t;const i=e.element,n=e.name;if(e.type===me){if(t===i[n])return q}else if(e.type===be){if(!!t===i.hasAttribute(n))return q}else if(e.type===ge&&i.getAttribute(n)===t+"")return q;return ke(e),t}}),Qe={exit:{kind:"svg",viewBox:"0 0 36.29 29.04",glyphPointsTo:"left",labelKey:"icon_exit",shapes:()=>I`
    ...
    `}},Xe=["mdi:exit-run","mdi:exit-to-app","mdi:door-open","mdi:stairs"],Je={"mdi:exit-run":{labelKey:"icon_mdi_exit_run",glyphPointsTo:"right"},"mdi:exit-to-app":{labelKey:"icon_mdi_exit_to_app",glyphPointsTo:"right"},"mdi:door-open":{labelKey:"icon_mdi_door_open"},"mdi:stairs":{labelKey:"icon_mdi_stairs"}};function et(e,t){const i=Qe[e];if("text"===i.kind)return K`<span class="retro-station-header__tile" role="img" aria-label=${t.ariaLabel}>
      <span class="retro-station-header__monogram" aria-hidden="true">${i.text}</span>
    </span>`;const n=t.flipX?"retro-station-header__icon retro-station-header__icon--flip-x":"retro-station-header__icon";return K`<span class="retro-station-header__tile" role="img" aria-label=${t.ariaLabel}>
    <svg
      class=${n}
      viewBox=${i.viewBox}
      aria-hidden="true"
    ...
    >${i.shapes()}</svg>
  </span>`}function tt(e){"Escape"!==e.key&&"Tab"!==e.key&&e.stopPropagation()}const it=e=>Math.min(1,Math.max(0,e)),nt=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4;const rt=([e,t,i])=>"#"+[e,t,i].map(e=>Math.round(255*it((e=>e<=.0031308?12.92*e:1.055*e**(1/2.4)-.055)(e))).toString(16).padStart(2,"0")).join("");function at(e,t){if(void 0===t)return null;const i=function(e){const t=e.trim();if(!t||t.includes("var("))return null;let i=/^#[0-9a-f]{3,8}$/i.test(t)?t.slice(1):"";if(!i){let e="";try{const i=document.createElement("span").style;i.color=t,e=i.color.trim()}catch{return null}const i=/^rgba?\(([^)]+)\)$/.exec(e);if(!i?.[1])return null;const n=i[1].split(/[,\s/]+/).filter(Boolean).map(Number),[r,a,s]=n;return void 0===r||void 0===a||void 0===s?null:[r,a,s].every(Number.isFinite)?[nt(r/255),nt(a/255),nt(s/255)]:null}if(3!==i.length&&4!==i.length||(i=[...i.slice(0,3)].map(e=>e+e).join("")),6!==i.length&&8!==i.length)return null;const n=Number.parseInt(i.slice(0,6),16);return Number.isFinite(n)?[nt((n>>16&255)/255),nt((n>>8&255)/255),nt((255&n)/255)]:null}(e);if(!i)return null;const[n,r,a]=function([e,t,i]){const n=Math.cbrt(.4122214708*e+.5363325363*t+.0514459929*i),r=Math.cbrt(.2119034982*e+.6806995451*t+.1073969566*i),a=Math.cbrt(.0883024619*e+.2817188376*t+.6299787005*i);return[.2104542553*n+.793617785*r-.0040720468*a,1.9779984951*n-2.428592205*r+.4505937099*a,.0259040371*n+.7827717662*r-.808675766*a]}(i),s="dark"===t?Math.max(.72,n):Math.min(.45,n);if(s===n)return rt(i);const o=Math.hypot(r,a),l=Math.atan2(a,r),c=function([e,t,i]){const n=(e+.3963377774*t+.2158037573*i)**3,r=(e-.1055613458*t-.0638541728*i)**3,a=(e-.0894841775*t-1.291485548*i)**3;return[4.0767416621*n-3.3077115913*r+.2309699292*a,-1.2684380046*n+2.6097574011*r-.3413193965*a,-.0041960863*n-.7034186147*r+1.707614701*a]}([s,o*Math.cos(l),o*Math.sin(l)]);return rt([it(c[0]),it(c[1]),it(c[2])])}const st={flap:!0},ot={flap:!0},lt={flap:"small"},ct={flap:!0},dt={flap:"line"},pt={flap:!0},ht=new Set(["none","regular","accessible",...Xe]);function _t(e,t,i){if("string"!=typeof e)return;const n=i?e.trim().slice(0,t):e.slice(0,t);return n.length>0?n:void 0}function ut(e,t){if(!Array.isArray(e))return;const{maxCount:i,truncateTo:n,accept:r}=t,a=e.filter(e=>"string"==typeof e).map(e=>void 0===n?e.trim():e.trim().slice(0,n)).filter(e=>e.length>0&&(void 0===r||r(e))).slice(0,i);return a.length>0?a:void 0}const ft=/^[a-z0-9_-]+:[a-z0-9_-]+$/i;function gt(e){if(!e||"object"!=typeof e)return;const t=e,i={},n=ht.has(t.exit)?t.exit:"none";"none"!==n&&(i.exit=n);const r=_t(t.text,64,!0);void 0!==r&&(i.text=r),!0===t.show_wc&&(i.show_wc=!0),!0===t.show_escalator&&(i.show_escalator=!0),!0===t.show_elevator&&(i.show_elevator=!0),!0===t.show_clock&&(i.show_clock=!0),!0===t.show_date&&(i.show_date=!0);const a=ut(t.chips,{truncateTo:16,maxCount:6});void 0!==a&&(i.chips=a);const s=ut(t.extra_icons,{maxCount:3,accept:e=>ft.test(e)&&e.length<=64});if(void 0!==s&&(i.extra_icons=s),0===Object.keys(i).length)return;const o=_t(t.date_format,32,!1);return void 0!==o&&(i.date_format=o),i}function mt(e,t,i={},n="var(--primary-color)"){const r=e.toUpperCase();if(void 0!==t[r])return{background:t[r]};if(/^N\d/.test(r))return{background:"#1b1464",color:"#fef200"};const a=i[e]??i[r];return a?.bg?a.fg?{background:`#${a.bg}`,color:`#${a.fg}`}:{background:`#${a.bg}`}:{background:n}}const bt=[{key:"show_wc",icon:"mdi:human-male-female",labelKey:"show_wc_short"},{key:"show_escalator",icon:"mdi:escalator",labelKey:"show_escalator_short"},{key:"show_elevator",icon:"mdi:elevator",labelKey:"show_elevator_short"},{key:"show_clock",icon:"mdi:clock-outline",labelKey:"show_clock_short"},{key:"show_date",icon:"mdi:calendar",labelKey:"show_date_short"}],wt=[{value:"regular",icon:"mdi:exit-run",labelKey:"header_exit_regular"},{value:"accessible",icon:"mdi:wheelchair-accessibility",labelKey:"header_exit_accessible"},...Xe.map(e=>({value:e,icon:e,labelKey:Je[e].labelKey})),{value:"none",icon:"mdi:close-circle-outline",labelKey:"header_exit_none"}];function yt(e,t){const i=("header_left"===e.selected?e.left:e.right)??{},n=e.et("header_slot_empty"),r=(i,n)=>t.patch(e.selected,i,n);return K`
    <div class="wl-strip">
      <div class="wl-strip-bar" role="group" aria-label=${e.et("header_bar_aria")}>
        ${vt("header_left",e,t,n)}
        ${vt("header_right",e,t,n)}
      </div>
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${wt.map(t=>{const n=(i.exit??"none")===t.value,a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${bt.map(t=>{const n=Boolean(i[t.key]),a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${n?"true":"false"}
                aria-label=${a}
        ...
        ${function(e,t,i){const n=e.chips??[],r=e.extra_icons??[];return K`
    <div class="wl-group">
      <span class="wl-label"
      ...
      ${n.length<6?K`<input
            ...
            @keydown=${e=>{if(tt(e),"Enter"!==e.key)return;const t=e.target,r=t.value.trim();r&&(i("chips",[...n,r].slice(0,6)),t.value="")}}
            @keyup=${tt}
            @keypress=${tt}
          />`:G}
    </div>
  ...
  `}function vt(e,t,i,n){const r="header_left"===e?t.left:t.right,a=t.selected===e,s=function(e,t,i){const n=[];if(!e)return[{label:t,kind:"text",name:t}];if(e.exit&&"none"!==e.exit){const t=wt.find(t=>t.value===e.exit);n.push({label:"",icon:t?.icon??e.exit,kind:"icon",name:t?i(t.labelKey):e.exit})}e.text&&n.push({label:e.text,kind:"text",name:e.text});for(const t of bt)e[t.key]&&n.push({label:"",icon:t.icon,kind:"icon",name:i(t.labelKey)});for(const t of e.extra_icons??[])n.push({label:"",icon:t,kind:"icon",name:t});for(const t of e.chips??[])n.push({label:t,kind:"chip",name:t});return n.length||n.push({label:t,kind:"text",name:t}),n}(r,n,t.et),o=t.et("header_left"===e?"header_left":"header_right");return K`<button
    type="button"
  ...
  </button>`}function xt(e,t){const i=e.filter((e,i)=>i!==t);return i.length?i:void 0}function kt(e,t){return`${e}|${t}`}function $t(e,t){if(!e.length)return t.full;const i=e.slice(0,3).join(" / "),n=e.length>3?" +"+(e.length-3):"";return`${t.short}: ${i}${n}`}function St(e,t){const i=new Set;for(const n of e?.tracked_line_keys??[]){const[e,r]=n.split("|",2);t&&e!==t||("H"!==r&&"R"!==r||i.add(r))}if(0===i.size)for(const n of e?.departures??[])t&&n.line!==t||"H"!==n.direction&&"R"!==n.direction||i.add(n.direction);const n=[...i];return{available:i,unknown:0===i.size,oneWay:1===i.size?n[0]??null:null}}function At(e,t){if(0===t.size)return[...e];const i=e.filter(e=>t.has(e));for(const e of t)i.includes(e)||i.push(e);return i}function zt(e,t){const{lines:i,direction:n,line_directions:r,walk_times:a,accessibility_only:s}=t,o=i&&i.length?new Set(i):null;return e.filter(e=>{if(o&&!o.has(e.line))return!1;const t=r?.[e.line]??n;if(t&&e.direction!==t)return!1;if(a){const t=a[kt(e.line,String(e.direction??""))];if("number"==typeof t&&e.countdown<t)return!1}return!(s&&!e.barrier_free)})}function Et(e,t){const{lines:i,picked:n,lineDirections:r,stopDirection:a}=t,s=e=>r[e]??a,o=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),n=kt(i.line,e);let r=t.get(n);r||(r={line:i.line,direction:e,type:i.type,termini:[]},t.set(n,r)),i.towards&&!r.termini.includes(i.towards)&&r.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(e).filter(e=>{if(n.size>0&&!n.has(e.line))return!1;const t=s(e.line);return!t||e.direction===t}),l=new Set(o.map(e=>e.line)),c=At(i,n),d=[];for(const e of c){if(l.has(e))continue;const t=s(e);for(const i of t?[t]:["H","R"])d.push({line:e,direction:i,type:"",termini:[]})}return[...o,...d].sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line))}const Lt="ptMetro";function Ct(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}const Rt=120;function Ht(e,t,i){const n=new Set;for(const r of e)r.direction===t&&(i&&r.line!==i||r.towards&&n.add(r.towards));return[...n].sort()}function Tt(e,t,i,n){const r=function(e,t){return e?.states?.[t]?.attributes}(e,t.entity),a=!r,s=r?.stop_name||t.entity,o=r?.line_colors??{},l=function(e){return!0===e?.themes?.darkMode?"dark":!1===e?.themes?.darkMode?"light":void 0}(e),c=e=>function(e,t,i={},n,r="var(--primary-color)"){const a=mt(e,t,i,r);return{fill:a.background,ink:a.color,text:at(a.background,n)??void 0}}(e,i.lineColorOverrides,o,l,"#5b6470"),d=new Set(t.lines??[]),p=function(e){if(e?.tracked_lines?.length)return[...e.tracked_lines].sort();const t=new Set;if(e?.lines_at_stop?.length)for(const i of e.lines_at_stop)t.add(i);for(const i of e?.departures??[])i.line&&t.add(i.line);return Array.from(t).sort()}(r),h=d.size?[...new Set([...p,...d])].sort():p,_=function(e){const t=[],i=new Set;for(const n of e?.departures??[]){const e=String(n.direction??""),r=`${n.line}|${e}|${n.towards}`;i.has(r)||(i.add(r),t.push({line:n.line,direction:e,towards:n.towards,type:n.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(r),u=new Map;for(const e of r?.departures??[])e.line&&e.type&&!u.has(e.line)&&u.set(e.line,e.type);const f=e=>({full:i.t("H"===e?"dir_h":"dir_r"),short:i.t("H"===e?"dir_h_short":"dir_r_short")});return K`
    <section class="wl-section">
      <header class="wl-section-header">
        ${i.total>1?K`<span class="wl-index" aria-hidden="true">${i.index}</span>`:G}
  ...
  `}(t,i,n):G}
        ${function(e,t,i,n){const{lines:r,picked:a,colorOf:s,typeByLine:o}=n,l=a.size?t.et("lines_selected").replace("{n}",String(a.size)).replace("{total}",String(r.length)):t.et("lines_empty_means_all");return K`
    <div class="wl-group">
      <div class="wl-group-head">
        <span class="wl-label wl-label--grow">${t.et("lines_label")}</span>
        ${r.length?K`<span class="wl-note">${l}</span>`:G}
      </div>
      ${r.length?K`<div class="wl-chips">
            ${r.map(n=>{const r=t.singleLine?a.has(n):0===a.size||a.has(n),l=function(e){switch(e){case Lt:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}(o.get(n));return K`<button
                type="button"
                class="wl-chip"
                style=${ze(function(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}(s(n)))}
  ...
  `}(t,i,n,{lines:h,picked:d,colorOf:c,typeByLine:u})}
        ${!a&&h.length?function(e,t){return!e.singleLine&&At(t.lines,t.picked).length>=2}(i,{lines:h,picked:d})?function(e,t,i,n){const{attrs:r,triplets:a,picked:s,lines:o,colorOf:l,dirStrings:c}=n,d=At(o,s),p=e.line_directions??{},h=e.direction??null,_=e=>p[e]??h,u=(t,n)=>{const r={};for(const e of d){const i=e===t?n:_(e);i&&(r[e]=i)}for(const[e,t]of Object.entries(p))d.includes(e)||(r[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:r})};return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=St(r,e),n=_(e),s=i.available.has("H"),o=i.available.has("R"),d=null!==i.oneWay,p=i.unknown,h=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):$t(Ht(a,i,e),c(i)));return K`
          <div class="wl-override-row">
            <span class="wl-badge" style=${ze(Ct(l(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${Mt({label:c("H").short,active:"H"===n||null===n&&"H"===i.oneWay,disabled:!p&&!s,compact:!0,title:Ht(a,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:h("H"),onClick:()=>u(e,"H")})}
              ${Mt({label:c("R").short,active:"R"===n||null===n&&"R"===i.oneWay,disabled:!p&&!o,compact:!0,title:Ht(a,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:h("R"),onClick:()=>u(e,"R")})}
              ${Mt({label:"",icon:"mdi:swap-horizontal",active:null===n&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:h(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,n,{attrs:r,triplets:_,picked:d,lines:h,colorOf:c,dirStrings:f}):function(e,t,i,n){const{attrs:r,triplets:a,picked:s,lines:o,dirStrings:l}=n,c=At(o,s),d=1===c.length?c[0]:void 0,p=e.direction??null,h=St(r,d),_=h.available.has("H"),u=h.available.has("R"),f=null!==h.oneWay,g="H"===p||null===p&&"H"===h.oneWay,m="R"===p||null===p&&"R"===h.oneWay,b=null===p&&!f,w=t=>{const n={};for(const[t,i]of Object.entries(e.line_directions??{}))c.includes(t)||(n[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:n})},y=e=>h.unknown||h.available.has(e)?$t(Ht(a,e,d),l(e)):`${l(e).short}: ${t.et("direction_not_served")}`,v=null!==h.oneWay&&1===c.length?t.et("direction_note_one_way").replace("{line}",c[0]??""):"";return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${Mt({label:y("H"),active:g,disabled:!h.unknown&&!_,title:_||h.unknown?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${Mt({label:y("R"),active:m,disabled:!h.unknown&&!u,title:u||h.unknown?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?G:Mt({label:t.t("dir_both"),active:b,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
      ${v?K`<span class="wl-note">${v}</span>`:G}
    </div>
  `}(t,i,n,{attrs:r,triplets:_,picked:d,lines:h,dirStrings:f}):G}
        ${a?G:function(e,t,i,n){const{attrs:r,picked:a,colorOf:s,lines:o,dirStrings:l}=n,c=e.line_directions??{},d=e.direction??null,p=Et(r,{lines:o,picked:a,lineDirections:c,stopDirection:d});return p.length?K`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${p.map(n=>{const r=kt(n.line,n.direction),a=e.walk_times?.[r],o=n.termini.length?n.termini.join(" / "):"H"===n.direction||"R"===n.direction?l(n.direction).full:"",c=t.et("walk_time_aria").replace("{line}",n.line).replace("{towards}",o),d=t=>{const n=(a??0)+t;i.setWalkTime(e.entity,r,n<1?null:Math.min(Rt,n))};return K`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${ze(Ct(s(n.line)))}
                >${n.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:G}(t,i,n,{attrs:r,picked:d,colorOf:c,lines:h,dirStrings:f})}
      </div>
    </section>
  `}function Mt(e){return K`<button
    type="button"
...
let Ut=class extends ce{constructor(){super(...arguments),this._tab="stops",this._headerSide="header_left",this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Ft({...this._config,entities:Ot(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>function(e,t,i){const n=t.et(i);return n!==i?n:e?.localize?.(`ui.panel.lovelace.editor.card.generic.${i}`)||i}(this.hass,this._i18n,e.name),this._computeHelper=e=>{const{et:t}=this._i18n;return function(e,t,i){const n=i?.[t];if(void 0!==n)return n;const r=`${t}_helper`,a=e.et(r);return a===r?void 0:a}(this._i18n,e.name,{...this._config?.show_accessibility?{}:{accessibility_only:t("accessibility_only_requires")}})}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card-editor: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card-editor: 'entity' must be a string");this._config=Ft(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab")||e.has("_headerSide"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return 0===i.length||i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>Fe(`${e}.${t}`,i),et:t=>{const n=`${e}.editor.${t}`,r=Fe(n,i);if(r!==n)return r;const a=`common.editor.${t}`,s=Fe(a,i);return s===a?t:s}}}("flap",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(Ft({...this._config,...e}))}get _stopCallbacks(){return function(e,t){const i=(i,n)=>{const r=e();r&&t(r.map(e=>e.entity===i?n({...e}):e))};return{toggleLine:(e,t)=>i(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>i(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,n)=>i(e,e=>{const i={...e.walk_times??{}};return null===n?delete i[t]:i[t]=n,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e}),remove:i=>{const n=e();n&&t(n.filter(e=>e.entity!==i))}}}(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return G;const{et:e}=this._i18n;return K`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return K`
      <ha-form
        .hass=${this.hass}
      ...
      ></ha-form>
      ${e.entities.map((n,r)=>Tt(this.hass,n,{index:r+1,total:e.entities.length,lineColorOverrides:{},t:t,et:i},this._stopCallbacks))}
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return K`
      ${Ve({title:t("section_header"),hint:t("section_header_hint")},K`
          <ha-form
            .hass=${this.hass}
          ...
          ></ha-form>
          ${e.show_header?yt({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,i)=>this._patchHeaderSide(e,t,i)}):G}
        `)}
    ...
    `}_patchHeaderSide(e,t,i){this._config&&this._patch({[e]:Dt(this._config[e],t,i)})}_stationBgOptions(){const{et:e}=this._i18n,t=[{value:"line",label:e("station_bg_line")}],i=new Set;for(const e of this._config?.entities??[]){const t=this.hass?.states?.[e.entity]?.attributes,n=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(const e of n??[])"string"==typeof e&&e&&i.add(e)}if(0===i.size){const e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(const e of Object.keys(t??{}))i.add(e)}for(const e of[...i].sort())t.push({value:`line:${e}`,label:e});return t.push({value:"white",label:e("station_bg_white")}),t.push({value:"black",label:e("station_bg_black")}),t}static{this.styles=[Ie,Ke,qe]}};function Kt(e){if(!e)return[];const t=[];for(const[i,n]of Object.entries(e.states??{})){if(!i.startsWith("sensor."))continue;const e=n?.attributes??{};"number"==typeof e.diva&&(Array.isArray(e.departures)&&e.next_by_line&&"object"==typeof e.next_by_line&&t.push(i))}return t.sort(),t}function It(e){return String(e).padStart(2,"0")}function qt(e,t,i){if(!e||!t)return null;const n=Date.parse(e);return Number.isFinite(n)?function(e,t,i="de"){if(!t)return"";const n="en"===i?"en-GB":"de-AT",r=()=>e.toLocaleDateString(n,{weekday:"long"}),a=()=>e.toLocaleDateString(n,{weekday:"short"}),s=()=>e.toLocaleDateString(n,{month:"long"}),o=()=>e.toLocaleDateString(n,{month:"short"});let l="",c=0;for(;c<t.length;){const i=t[c];if("\\"===i&&c+1<t.length)l+=t[c+1],c+=2;else{switch(i){case"d":l+=It(e.getDate());break;case"j":l+=String(e.getDate());break;case"D":l+=a();break;case"l":l+=r();break;case"m":l+=It(e.getMonth()+1);break;case"n":l+=String(e.getMonth()+1);break;case"M":l+=o();break;case"F":l+=s();break;case"Y":l+=String(e.getFullYear());break;case"y":l+=It(e.getFullYear()%100);break;case"H":l+=It(e.getHours());break;case"G":l+=String(e.getHours());break;case"h":l+=It((e.getHours()+11)%12+1);break;case"g":l+=String((e.getHours()+11)%12+1);break;case"i":l+=It(e.getMinutes());break;case"s":l+=It(e.getSeconds());break;default:l+=i??""}c++}}return l}(new Date(n),t,i):null}function Gt(e,t,i,n,r){let a=G;if("regular"===e.exit||"accessible"===e.exit){const i="regular"===e.exit?"exit":"exit-access";a=et(i,{ariaLabel:n(`header.${Qe[i].labelKey}`),flipX:Qe[i].glyphPointsTo!==t})}else if(e.exit&&function(e){return"string"==typeof e&&e in Je}(e.exit)){const i=Je[e.exit];a=function(e,t){const i=t.flipX?"retro-station-header__mdi retro-station-header__mdi--flip-x":"retro-station-header__mdi";return K`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${t.ariaLabel}>
    <ha-icon class=${i} icon=${e}></ha-icon>
  </span>`}(e.exit,{ariaLabel:n(`header.${i.labelKey}`),flipX:void 0!==i.glyphPointsTo&&i.glyphPointsTo!==t})}const s=e.text?K`<span class="retro-station-header__text">${e.text}</span>`:G,o=e=>et(e,{ariaLabel:n(`header.${Qe[e].labelKey}`)}),l=e.show_wc?o("wc"):G,c=e.show_escalator?o("escalator"):G,d=e.show_elevator?o("elevator"):G,p=(e.extra_icons??[]).map(e=>K`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${e}>
    <ha-icon class="retro-station-header__mdi" icon=${e}></ha-icon>
  </span>`),h=[...p].reverse(),_=(e.chips??[]).map(e=>K`<span class="retro-station-header__chip">${e}</span>`),u=[..._].reverse(),f=e.show_clock?function(e){if(!e)return null;const t=Date.parse(e);if(!Number.isFinite(t))return null;const i=new Date(t);return`${String(i.getHours()).padStart(2,"0")}:${String(i.getMinutes()).padStart(2,"0")}`}(i):null,g=f?K`<span
...
const Vt="ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß",Zt="0123456789";function Yt(e,t,i){const n=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return n===e.length?i:e[n]}function Qt(e,t){if(e===t)return t;const i=Vt.includes(e),n=Zt.includes(e),r=Vt.includes(t),a=Zt.includes(t);return!i&&!r||n||a?!n&&!a||i||r?t:Yt(Zt,e,t):Yt(Vt,e,t)}function Xt(e,t){return`row${e}-${t}`}const Jt={small:22,medium:28,regular:32};function ei(e){const t="number"==typeof e&&Number.isFinite(e)?e:null;return null===t?"--":String(t<=0?0:t).padStart(2," ")}{const e=window;e.customCards=e.customCards??[],e.customCards.some(e=>"wiener-linien-austria-flap-card"===e.type)||e.customCards.push({type:"wiener-linien-austria-flap-card",name:"Wiener Linien Austria — Flap Board",description:"Solari-style split-flap departure board",preview:!0,getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"wiener_linien_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:wiener-linien-austria-flap-card",entities:[t]}}:null})}let ti=class extends ce{constructor(){super(...arguments),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card: 'entity' must be a string");const t=Ft(e);if((Array.isArray(e.entities)?e.entities.length:"string"==typeof e.entity&&e.entity?1:0)>0&&0===t.entities.length)throw new Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-flap-card-editor")}static getStubConfig(e){const t=Kt(e)[0];if(!t)return{};let i="H";const n=e?.states?.[t]?.attributes?.departures;if(Array.isArray(n)){const e=n.some(e=>"H"===e.direction),t=n.some(e=>"R"===e.direction);!e&&t&&(i="R")}return{entity:t,direction:i}}connectedCallback(){super.connectedCallback(),function(){if("undefined"==typeof document)return;if(document.getElementById(Ee))return;const e=document.createElement("style");e.id=Ee,e.textContent='\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans Condensed";\n  src: url("/wiener-linien-austria/fonts/wl-sans-condensed-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n',document.head.appendChild(e)}(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_versionMismatch")||e.has("_displayed")||e.has("_target")||e.has("_justFlipped"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStopEids();return 0!==i.length&&i.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config)return;if(!e.has("hass")&&!e.has("_config"))return;const t=this._gatherRows(),i=this._maxDestLen(t),n=this._maxLineLen(t);for(let e=0;e<t.length;e++){const r=t[e];r&&(this._diffFlipField(Xt(e,"line"),(r.line??"?").toUpperCase().padStart(n," ")),this._diffFlipField(Xt(e,"dest"),(r.towards??"").toUpperCase().padEnd(i," ")),this._diffFlipField(Xt(e,"cd"),ei(r.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Xt(e,"line"),null),this._diffFlipField(Xt(e,"dest"),null),this._diffFlipField(Xt(e,"cd"),null)}_clearFlipTimer(){null!==this._marchTimer&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(null!==t){if(void 0===this._displayed[e])return this._displayed={...this._displayed,[e]:t},void(this._target={...this._target,[e]:t});this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}else{if(e in this._displayed){const{[e]:t,...i}=this._displayed;this._displayed=i}if(e in this._target){const{[e]:t,...i}=this._target;this._target=i}if(e in this._justFlipped){const{[e]:t,...i}=this._justFlipped;this._justFlipped=i}}}_ensureMarchTimer(){null===this._marchTimer&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){const e={...this._displayed},t={};let i=!1;for(const[n,r]of Object.entries(this._target)){const a=e[n]??"";if(a===r)continue;const s=Math.max(a.length,r.length),o=[],l={};for(let e=0;e<s;e++){const t=a[e]??" ",i=r[e]??" ";t===i?o.push(t):(l[e]=t,o.push(Qt(t,i)))}const c=o.join("");e[n]=c,Object.keys(l).length>0&&(t[n]=l,i=!0)}this._displayed=e,this._justFlipped=t,i||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const n=await e.callWS({type:t});if(n?.version&&n.version!==i)return n.version}catch{}return null}(this.hass,"wiener_linien_austria/flap_card_version","2.0.0")}catch(e){console.warn("[wiener-linien-austria-flap-card] version probe failed",e)}}_resolveStopEids(){const e=this._config?.entities??[],t=this.hass?.states,i=e.map(e=>e.entity).filter(e=>t?.[e]);if(0===i.length&&0===e.length){const e=Kt(this.hass)[0];e&&i.push(e)}return 0===i.length&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(", ")})`)),i}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??"").length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??"?").length))}_gatherRows(){if(!this._config)return[];const e=this._config.entities??[],t=this._config.accessibility_only,i=[];for(const n of e){const e=this.hass?.states?.[n.entity]?.attributes??{},r=zt(Array.isArray(e.departures)?e.departures:[],{direction:n.direction,lines:n.lines,line_directions:n.line_directions,walk_times:n.walk_times,accessibility_only:t});i.push(...r)}const n=e=>Number.isFinite(e.countdown)?e.countdown:Number.POSITIVE_INFINITY;return i.sort((e,t)=>n(e)-n(t)),i.slice(0,this._config.max_rows)}_t(e,t){return Fe(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return G;const e=this._config,t=this._resolveStopEids(),i=this._gatherRows(),n=t[0]??"",r=n?this.hass?.states?.[n]?.attributes??{}:{},a=r.stop_name||r.friendly_name||"",s=r.line_colors??{},o=r.server_time,l=e.show_platform&&i.some(e=>e.platform),c=(i[0]?.type??"")===Lt,d=this._t(c?"gleis":"steig"),p=!1===this.hass?.themes?.darkMode,h={flap:!0,[`flap--size-${e.size}`]:"regular"!==e.size,"flap--has-platform":l,"flap--light":p,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},_=this._resolveStationHeaderStyle(e.station_bg,e.entities,i,s),u=e.show_header?function(e){const{left:t,right:i,serverTime:n,t:r,lang:a}=e;return t||i?K`
    <div class="retro-station-header" role="group">
      ...
      <div class="retro-station-header__side retro-station-header__side--right">
        ${i?Gt(i,"right",n,r,a):G}
      </div>
    </div>
  `:G}({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):G,f=e.hide_attribution?"":"string"==typeof r.attribution&&r.attribution||"Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0";return K`
      <ha-card style="padding:0;overflow:hidden;">
        <div class=${ve(h)}>
          ${Ue(this._versionMismatch,e=>this._t(e),"flap-banner")}
          ${u}
          ...
          <div class="flap-panel">
            ...
            ${f?K`<div class="flap-foot">${f}</div>`:G}
          </div>
        </div>
      </ha-card>
    `}_resolveStationHeaderStyle(e,t,i,n){if("white"===e)return{background:"#ffffff",color:"#1a1410"};if("black"===e)return{background:"#000000",color:"var(--flap-cream-hi)"};let r;if("line"===e?r=t[0]?.lines?.[0]??i[0]?.line:e.startsWith("line:")&&(r=e.slice(5)),!r)return{background:"var(--wl-orange)"};const a=mt(r,{},n);return{background:"var(--primary-color)"===a.background?"var(--wl-orange)":a.background,color:"var(--flap-on-color-fg)"}}_renderBoard(e,t,i,n,r,a,s){const o=this._maxDestLen(t),l=this._maxLineLen(t);if(0===e.length)return K`<div class="flap-empty">${this._t("no_entity")}</div>`;if(0===t.length){const t=e.some(e=>{const t=this.hass?.states?.[e]?.attributes??{};return Array.isArray(t.departures)&&t.departures.length>0}),i=e.some(e=>{const t=this.hass?.states?.[e]?.attributes??{};return"number"==typeof t.stale_departures&&t.stale_departures>0}),n=t?"no_data":i?"stale_feed":"betriebsschluss";return K`<div class="flap-empty">${this._t(n)}</div>`}const c=Jt[this._config?.size??"regular"],d=o*c+2*Math.max(0,o-1),p=r?d+6+c:d;return K`
      <div
        class=${ve({"flap-board":!0,"flap-board--has-platform":i,"flap-board--no-line":a})}
        role="list"
        aria-label=${this._t("departures_list")}
      >
        <div class="flap-colheader" aria-hidden="true">
          ${a?G:K`<span class="flap-colheader__line"
                >${this._t("col_line")}</span
              >`}
          <span
            class="flap-colheader__dest"
            style=${ze({maxWidth:`${p}px`})}
          >
            <span>${this._t("col_dest")}</span>
            ${r?K`<span class="flap-colheader__step-free"
                  >${this._t("col_step_free")}</span
                >`:G}
          </span>
          ${i?K`<span class="flap-colheader__platform"
                >${n}</span
              >`:G}
    ...
    `}_renderRow(e,t,i,n,r,a,s){const o=this._config,l=Number.isFinite(e.countdown)?e.countdown:null,c=null!==l&&l<=0,d=(e.line??"?").toUpperCase(),p=d.padStart(s," "),h=(e.towards??"").toUpperCase(),_=[d,h,null===l?this._t("no_data"):c?this._t("at_platform"):this._t("countdown_minutes",{n:String(l)})].filter(Boolean).join(" — "),u=mt(d,{},i),f="var(--primary-color)"!==u.background?{tileBg:u.background,blankSpace:!0}:{blankSpace:!0},g=this._renderFlipString(ei(e.countdown),Xt(t,"cd"),{blankSpace:!0}),m=n?K`<div class="flap-cell flap-cell--platform" aria-hidden="true">
      ...
      <div class="flap-row" role="listitem" aria-label=${_}>
        ${r?G:K`<div class="flap-cell flap-cell--line" aria-hidden="true">
              ${this._renderFlipString(p,Xt(t,"line"),f)}
            </div>`}
        <div class="flap-cell flap-cell--dest" aria-hidden="true">
          ${this._renderFlipString(h.padEnd(a," "),Xt(t,"dest"),{blankSpace:!0})}
        ...
        <div class="flap-cell flap-cell--cd" aria-hidden="true">
          ...
          ${o.show_min_unit&&null!==l?K`<span class="flap-cd-unit">${this._t("unit_min")}</span>`:G}
        </div>
      </div>
    `}_renderFlipString(e,t,i={}){const n=(this._displayed[t]??e).split(""),r=this._justFlipped[t]??{};return K`<span class="flap-tiles" aria-label=${e}
      >${n.map((e,t)=>$e(`${t}:${e}`,this._renderTile(e,r[t],t,i)))}</span
    >`}_renderTile(e,t,i,n={}){if(" "===e&&!n.blankSpace)return K`<span class="flap-space" aria-hidden="true">&nbsp;</span>`;const r=" "===e,a=r?void 0:n.tileBg,s=r?void 0:n.tileFg,o=void 0!==t,l=ze({"--tile-i":String(i),...a?{"--tile-bg":a}:{},...s?{"--tile-fg":s}:{}}),c=ve({"flap-tile":!0,"flap-tile--wide":!0===n.wide,"flap-tile--color":void 0!==a,"flap-tile--flipping":o,"flap-tile--blank":r}),d=" "===e?"":e;return K`<span class=${c} style=${l}>
      ...
      ${o?K`<span class="flap-tile__leaf"
    ...
    >
      ...
      <span class="flap-tile__pin flap-tile__pin--l" aria-hidden="true"></span>
      <span class="flap-tile__pin flap-tile__pin--r" aria-hidden="true"></span>
    </span>`}static{this.styles=s`@property --tile-bg {
syntax: "<color>";
inherits: true;
...
}`}};e([ue({attribute:!1})],ti.prototype,"hass",void 0),e([fe()],ti.prototype,"_config",void 0),e([fe()],ti.prototype,"_versionMismatch",void 0),e([fe()],ti.prototype,"_displayed",void 0),e([fe()],ti.prototype,"_target",void 0),e([fe()],ti.prototype,"_justFlipped",void 0),ti=e([pe("wiener-linien-austria-flap-card")],ti);export{ti as WienerLinienAustriaFlapCard};
