...
`;function qe(e,t,i){return I`
    <div class="wl-tabs" role="tablist">
      ${e.map((n,a)=>I`<button
          ...
          @click=${()=>i(n.key)}
          @keydown=${t=>((t,n)=>{const a="ArrowRight"===t.key?1:"ArrowLeft"===t.key?-1:0;if(!a)return;t.preventDefault();const r=(n+a+e.length)%e.length,s=e[r];if(!s)return;i(s.key);const o=t.currentTarget.parentElement,l=o?.children[r];l instanceof HTMLElement&&l.focus()})(t,a)}
        >
          ${n.label}
  ...
  `}function Ve(e){return Ge(e,I`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
    ...
    ></ha-form>`)}const Ze=we(class extends ye{constructor(e){if(super(e),e.type!==me&&e.type!==ge&&e.type!==be)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===q||t===G)return t;const i=e.element,n=e.name;if(e.type===me){if(t===i[n])return q}else if(e.type===be){if(!!t===i.hasAttribute(n))return q}else if(e.type===ge&&i.getAttribute(n)===t+"")return q;return ke(e),t}}),Ye={exit:{kind:"svg",viewBox:"0 0 36.29 29.04",glyphPointsTo:"left",labelKey:"icon_exit",shapes:()=>K`
    ...
    >${i.shapes()}</svg>
  </span>`}function et(e){"Escape"!==e.key&&"Tab"!==e.key&&e.stopPropagation()}const tt=e=>Math.min(1,Math.max(0,e)),it=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4;const nt=([e,t,i])=>"#"+[e,t,i].map(e=>Math.round(255*tt((e=>e<=.0031308?12.92*e:1.055*e**(1/2.4)-.055)(e))).toString(16).padStart(2,"0")).join("");function at(e,t){if(void 0===t)return null;const i=function(e){const t=e.trim();if(!t||t.includes("var("))return null;let i=/^#[0-9a-f]{3,8}$/i.test(t)?t.slice(1):"";if(!i){let e="";try{const i=document.createElement("span").style;i.color=t,e=i.color.trim()}catch{return null}const i=/^rgba?\(([^)]+)\)$/.exec(e);if(!i?.[1])return null;const n=i[1].split(/[,\s/]+/).filter(Boolean).map(Number),[a,r,s]=n;return void 0===a||void 0===r||void 0===s?null:[a,r,s].every(Number.isFinite)?[it(a/255),it(r/255),it(s/255)]:null}if(3!==i.length&&4!==i.length||(i=[...i.slice(0,3)].map(e=>e+e).join("")),6!==i.length&&8!==i.length)return null;const n=Number.parseInt(i.slice(0,6),16);return Number.isFinite(n)?[it((n>>16&255)/255),it((n>>8&255)/255),it((255&n)/255)]:null}(e);if(!i)return null;const[n,a,r]=function([e,t,i]){const n=Math.cbrt(.4122214708*e+.5363325363*t+.0514459929*i),a=Math.cbrt(.2119034982*e+.6806995451*t+.1073969566*i),r=Math.cbrt(.0883024619*e+.2817188376*t+.6299787005*i);return[.2104542553*n+.793617785*a-.0040720468*r,1.9779984951*n-2.428592205*a+.4505937099*r,.0259040371*n+.7827717662*a-.808675766*r]}(i),s="dark"===t?Math.max(.72,n):Math.min(.45,n);if(s===n)return nt(i);const o=Math.hypot(a,r),l=Math.atan2(r,a),c=function([e,t,i]){const n=(e+.3963377774*t+.2158037573*i)**3,a=(e-.1055613458*t-.0638541728*i)**3,r=(e-.0894841775*t-1.291485548*i)**3;return[4.0767416621*n-3.3077115913*a+.2309699292*r,-1.2684380046*n+2.6097574011*a-.3413193965*r,-.0041960863*n-.7034186147*a+1.707614701*r]}([s,o*Math.cos(l),o*Math.sin(l)]);return nt([tt(c[0]),tt(c[1]),tt(c[2])])}const rt={flap:!0},st={flap:!0},ot={flap:"small"},lt={flap:!0},ct={flap:"line"},dt={flap:!0},ht=new Set(["none","regular","accessible",...Qe]);function pt(e,t,i){if("string"!=typeof e)return;const n=i?e.trim().slice(0,t):e.slice(0,t);return n.length>0?n:void 0}function ut(e,t){if(!Array.isArray(e))return;const{maxCount:i,truncateTo:n,accept:a}=t,r=e.filter(e=>"string"==typeof e).map(e=>void 0===n?e.trim():e.trim().slice(0,n)).filter(e=>e.length>0&&(void 0===a||a(e))).slice(0,i);return r.length>0?r:void 0}const _t=/^[a-z0-9_-]+:[a-z0-9_-]+$/i;function ft(e){if(!e||"object"!=typeof e)return;const t=e,i={},n=ht.has(t.exit)?t.exit:"none";"none"!==n&&(i.exit=n);const a=pt(t.text,64,!0);void 0!==a&&(i.text=a),!0===t.show_wc&&(i.show_wc=!0),!0===t.show_escalator&&(i.show_escalator=!0),!0===t.show_elevator&&(i.show_elevator=!0),!0===t.show_clock&&(i.show_clock=!0),!0===t.show_date&&(i.show_date=!0);const r=ut(t.chips,{truncateTo:16,maxCount:6});void 0!==r&&(i.chips=r);const s=ut(t.extra_icons,{maxCount:3,accept:e=>_t.test(e)&&e.length<=64});if(void 0!==s&&(i.extra_icons=s),0===Object.keys(i).length)return;const o=pt(t.date_format,32,!1);return void 0!==o&&(i.date_format=o),i}function gt(e,t,i={},n="var(--primary-color)"){const a=e.toUpperCase();if(void 0!==t[a])return{background:t[a]};if(/^N\d/.test(a))return{background:"#1b1464",color:"#fef200"};const r=i[e]??i[a];return r?.bg?r.fg?{background:`#${r.bg}`,color:`#${r.fg}`}:{background:`#${r.bg}`}:{background:n}}const mt=[{key:"show_wc",icon:"mdi:human-male-female",labelKey:"show_wc_short"},{key:"show_escalator",icon:"mdi:escalator",labelKey:"show_escalator_short"},{key:"show_elevator",icon:"mdi:elevator",labelKey:"show_elevator_short"},{key:"show_clock",icon:"mdi:clock-outline",labelKey:"show_clock_short"},{key:"show_date",icon:"mdi:calendar",labelKey:"show_date_short"}],bt=[{value:"regular",icon:"mdi:exit-run",labelKey:"header_exit_regular"},{value:"accessible",icon:"mdi:wheelchair-accessibility",labelKey:"header_exit_accessible"},...Qe.map(e=>({value:e,icon:e,labelKey:Xe[e].labelKey})),{value:"none",icon:"mdi:close-circle-outline",labelKey:"header_exit_none"}];function wt(e,t){const i=("header_left"===e.selected?e.left:e.right)??{},n=e.et("header_slot_empty"),a=(i,n)=>t.patch(e.selected,i,n);return I`
    <div class="wl-strip">
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${bt.map(t=>{const n=(i.exit??"none")===t.value,r=e.et(t.labelKey);return I`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${mt.map(t=>{const n=Boolean(i[t.key]),r=e.et(t.labelKey);return I`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${n?"true":"false"}
                aria-label=${r}
    ...
    <div class="wl-group">
      ...
      ${n.length<6?I`<input
            ...
            @keydown=${e=>{if(et(e),"Enter"!==e.key)return;const t=e.target,a=t.value.trim();a&&(i("chips",[...n,a].slice(0,6)),t.value="")}}
            @keyup=${et}
            @keypress=${et}
          />`:G}
    </div>
  ...
  `}function yt(e,t,i,n){const a="header_left"===e?t.left:t.right,r=t.selected===e,s=function(e,t,i){const n=[];if(!e)return[{label:t,kind:"text",name:t}];if(e.exit&&"none"!==e.exit){const t=bt.find(t=>t.value===e.exit);n.push({label:"",icon:t?.icon??e.exit,kind:"icon",name:t?i(t.labelKey):e.exit})}e.text&&n.push({label:e.text,kind:"text",name:e.text});for(const t of mt)e[t.key]&&n.push({label:"",icon:t.icon,kind:"icon",name:i(t.labelKey)});for(const t of e.extra_icons??[])n.push({label:"",icon:t,kind:"icon",name:t});for(const t of e.chips??[])n.push({label:t,kind:"chip",name:t});return n.length||n.push({label:t,kind:"text",name:t}),n}(a,n,t.et),o=t.et("header_left"===e?"header_left":"header_right");return I`<button
    type="button"
  ...
  </button>`}function vt(e,t){const i=e.filter((e,i)=>i!==t);return i.length?i:void 0}function xt(e,t){return`${e}|${t}`}function kt(e,t){if(!e.length)return t.full;const i=e.slice(0,3).join(" / "),n=e.length>3?" +"+(e.length-3):"";return`${t.short}: ${i}${n}`}function $t(e,t){const i=new Set;for(const n of e?.tracked_line_keys??[]){const[e,a]=n.split("|",2);t&&e!==t||("H"!==a&&"R"!==a||i.add(a))}if(0===i.size)for(const n of e?.departures??[])t&&n.line!==t||"H"!==n.direction&&"R"!==n.direction||i.add(n.direction);const n=[...i];return{available:i,unknown:0===i.size,oneWay:1===i.size?n[0]??null:null}}function St(e,t){if(0===t.size)return[...e];const i=e.filter(e=>t.has(e));for(const e of t)i.includes(e)||i.push(e);return i}function At(e,t){const{lines:i,direction:n,line_directions:a,walk_times:r,accessibility_only:s}=t,o=i&&i.length?new Set(i):null;return e.filter(e=>{if(o&&!o.has(e.line))return!1;const t=a?.[e.line]??n;if(t&&e.direction!==t)return!1;if(r){const t=r[xt(e.line,String(e.direction??""))];if("number"==typeof t&&e.countdown<t)return!1}return!(s&&!e.barrier_free)})}function zt(e,t){const{lines:i,picked:n,lineDirections:a,stopDirection:r}=t,s=e=>a[e]??r,o=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),n=xt(i.line,e);let a=t.get(n);a||(a={line:i.line,direction:e,type:i.type,termini:[]},t.set(n,a)),i.towards&&!a.termini.includes(i.towards)&&a.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(e).filter(e=>{if(n.size>0&&!n.has(e.line))return!1;const t=s(e.line);return!t||e.direction===t}),l=new Set(o.map(e=>e.line)),c=St(i,n),d=[];for(const e of c){if(l.has(e))continue;const t=s(e);for(const i of t?[t]:["H","R"])d.push({line:e,direction:i,type:"",termini:[]})}return[...o,...d].sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line))}const Et="ptMetro";function Lt(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}const Ct=120;function Tt(e,t,i){const n=new Set;for(const a of e)a.direction===t&&(i&&a.line!==i||a.towards&&n.add(a.towards));return[...n].sort()}function Rt(e,t,i,n){const a=function(e,t){return e?.states?.[t]?.attributes}(e,t.entity),r=!a,s=a?.stop_name||t.entity,o=a?.line_colors??{},l=function(e){return!0===e?.themes?.darkMode?"dark":!1===e?.themes?.darkMode?"light":void 0}(e),c=e=>function(e,t,i={},n,a="var(--primary-color)"){const r=gt(e,t,i,a);return{fill:r.background,ink:r.color,text:at(r.background,n)??void 0}}(e,i.lineColorOverrides,o,l,"#5b6470"),d=new Set(t.lines??[]),h=function(e){if(e?.tracked_lines?.length)return[...e.tracked_lines].sort();const t=new Set;if(e?.lines_at_stop?.length)for(const i of e.lines_at_stop)t.add(i);for(const i of e?.departures??[])i.line&&t.add(i.line);return Array.from(t).sort()}(a),p=d.size?[...new Set([...h,...d])].sort():h,u=function(e){const t=[],i=new Set;for(const n of e?.departures??[]){const e=String(n.direction??""),a=`${n.line}|${e}|${n.towards}`;i.has(a)||(i.add(a),t.push({line:n.line,direction:e,towards:n.towards,type:n.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(a),_=new Map;for(const e of a?.departures??[])e.line&&e.type&&!_.has(e.line)&&_.set(e.line,e.type);const f=e=>({full:i.t("H"===e?"dir_h":"dir_r"),short:i.t("H"===e?"dir_h_short":"dir_r_short")});return I`
    <section class="wl-section">
      <header class="wl-section-header">
  ...
  `}(t,i,n):G}
    ...
    <div class="wl-group">
      ...
      ${a.length?I`<div class="wl-chips">
            ${a.map(n=>{const a=t.singleLine?r.has(n):0===r.size||r.has(n),l=function(e){switch(e){case Et:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}(o.get(n));return I`<button
                type="button"
                class="wl-chip"
  ...
  `}(t,i,n,{lines:p,picked:d,colorOf:c,typeByLine:_})}
        ${!r&&p.length?function(e,t){return!e.singleLine&&St(t.lines,t.picked).length>=2}(i,{lines:p,picked:d})?function(e,t,i,n){const{attrs:a,triplets:r,picked:s,lines:o,colorOf:l,dirStrings:c}=n,d=St(o,s),h=e.line_directions??{},p=e.direction??null,u=e=>h[e]??p,_=(t,n)=>{const a={};for(const e of d){const i=e===t?n:u(e);i&&(a[e]=i)}for(const[e,t]of Object.entries(h))d.includes(e)||(a[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:a})};return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${d.map(e=>{const i=$t(a,e),n=u(e),s=i.available.has("H"),o=i.available.has("R"),d=null!==i.oneWay,h=i.unknown,p=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):kt(Tt(r,i,e),c(i)));return I`
          <div class="wl-override-row">
            <span class="wl-badge" style=${ze(Lt(l(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${Ht({label:c("H").short,active:"H"===n||null===n&&"H"===i.oneWay,disabled:!h&&!s,compact:!0,title:Tt(r,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:p("H"),onClick:()=>_(e,"H")})}
              ${Ht({label:c("R").short,active:"R"===n||null===n&&"R"===i.oneWay,disabled:!h&&!o,compact:!0,title:Tt(r,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:p("R"),onClick:()=>_(e,"R")})}
              ${Ht({label:"",icon:"mdi:swap-horizontal",active:null===n&&!d,disabled:d,compact:!0,title:t.t("dir_both"),ariaLabel:p(null),onClick:()=>_(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,n,{attrs:a,triplets:u,picked:d,lines:p,colorOf:c,dirStrings:f}):function(e,t,i,n){const{attrs:a,triplets:r,picked:s,lines:o,dirStrings:l}=n,c=St(o,s),d=1===c.length?c[0]:void 0,h=e.direction??null,p=$t(a,d),u=p.available.has("H"),_=p.available.has("R"),f=null!==p.oneWay,g="H"===h||null===h&&"H"===p.oneWay,m="R"===h||null===h&&"R"===p.oneWay,b=null===h&&!f,w=t=>{const n={};for(const[t,i]of Object.entries(e.line_directions??{}))c.includes(t)||(n[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:n})},y=e=>p.unknown||p.available.has(e)?kt(Tt(r,e,d),l(e)):`${l(e).short}: ${t.et("direction_not_served")}`,v=null!==p.oneWay&&1===c.length?t.et("direction_note_one_way").replace("{line}",c[0]??""):"";return I`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${Ht({label:y("H"),active:g,disabled:!p.unknown&&!u,title:u||p.unknown?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${Ht({label:y("R"),active:m,disabled:!p.unknown&&!_,title:_||p.unknown?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?G:Ht({label:t.t("dir_both"),active:b,disabled:f,title:f?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
      ${v?I`<span class="wl-note">${v}</span>`:G}
    </div>
  `}(t,i,n,{attrs:a,triplets:u,picked:d,lines:p,dirStrings:f}):G}
        ${r?G:function(e,t,i,n){const{attrs:a,picked:r,colorOf:s,lines:o,dirStrings:l}=n,c=e.line_directions??{},d=e.direction??null,h=zt(a,{lines:o,picked:r,lineDirections:c,stopDirection:d});return h.length?I`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${h.map(n=>{const a=xt(n.line,n.direction),r=e.walk_times?.[a],o=n.termini.length?n.termini.join(" / "):"H"===n.direction||"R"===n.direction?l(n.direction).full:"",c=t.et("walk_time_aria").replace("{line}",n.line).replace("{towards}",o),d=t=>{const n=(r??0)+t;i.setWalkTime(e.entity,a,n<1?null:Math.min(Ct,n))};return I`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${ze(Lt(s(n.line)))}
                >${n.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:G}(t,i,n,{attrs:a,picked:d,colorOf:c,lines:p,dirStrings:f})}
      </div>
    </section>
  `}function Ht(e){return I`<button
    type="button"
...
let Ft=class extends ce{constructor(){super(...arguments),this._tab="stops",this._headerSide="header_left",this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Bt({...this._config,entities:Mt(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>function(e,t,i){const n=t.et(i);return n!==i?n:e?.localize?.(`ui.panel.lovelace.editor.card.generic.${i}`)||i}(this.hass,this._i18n,e.name),this._computeHelper=e=>{const{et:t}=this._i18n;return function(e,t,i){const n=i?.[t];if(void 0!==n)return n;const a=`${t}_helper`,r=e.et(a);return r===a?void 0:r}(this._i18n,e.name,{...this._config?.show_accessibility?{}:{accessibility_only:t("accessibility_only_requires")}})}}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card-editor: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card-editor: 'entity' must be a string");this._config=Bt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_tab")||e.has("_headerSide"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entities.map(e=>e.entity);return 0===i.length||i.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return function(e,t){const i={hassLanguage:t};return{t:t=>Fe(`${e}.${t}`,i),et:t=>{const n=`${e}.editor.${t}`,a=Fe(n,i);if(a!==n)return a;const r=`common.editor.${t}`,s=Fe(r,i);return s===r?t:s}}}("flap",this.hass?.language)}_commit(e){var t,i;this._config=e,t="config-changed",i={config:e},this.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}_patch(e){this._config&&this._commit(Bt({...this._config,...e}))}get _stopCallbacks(){return function(e,t){const i=(i,n)=>{const a=e();a&&t(a.map(e=>e.entity===i?n({...e}):e))};return{toggleLine:(e,t)=>i(e,e=>{const i=new Set(e.lines??[]);return i.has(t)?i.delete(t):i.add(t),i.size?e.lines=[...i]:delete e.lines,e}),setDirections:(e,t)=>i(e,e=>(null===t.direction?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,n)=>i(e,e=>{const i={...e.walk_times??{}};return null===n?delete i[t]:i[t]=n,Object.keys(i).length?e.walk_times=i:delete e.walk_times,e}),remove:i=>{const n=e();n&&t(n.filter(e=>e.entity!==i))}}}(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return G;const{et:e}=this._i18n;return I`
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStops();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStops(){const e=this._config,{t:t,et:i}=this._i18n;return I`
      ...
      ></ha-form>
      ${e.entities.map((n,a)=>Rt(this.hass,n,{index:a+1,total:e.entities.length,lineColorOverrides:{},t:t,et:i},this._stopCallbacks))}
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return I`
      ${Ge({title:t("section_header"),hint:t("section_header_hint")},I`
          ...
          ></ha-form>
          ${e.show_header?wt({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,i)=>this._patchHeaderSide(e,t,i)}):G}
        `)}
...
const Gt="ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß",Vt="0123456789";function Zt(e,t,i){const n=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return n===e.length?i:e[n]}function Yt(e,t){if(e===t)return t;const i=Gt.includes(e),n=Vt.includes(e),a=Gt.includes(t),r=Vt.includes(t);return!i&&!a||n||r?!n&&!r||i||a?t:Zt(Vt,e,t):Zt(Gt,e,t)}function Qt(e,t){return`row${e}-${t}`}const Xt={small:22,medium:28,regular:32};function Jt(e){const t="number"==typeof e&&Number.isFinite(e)?e:null;return null===t?"--":String(t<=0?0:t).padStart(2," ")}{const e=window;e.customCards=e.customCards??[],e.customCards.some(e=>"wiener-linien-austria-flap-card"===e.type)||e.customCards.push({type:"wiener-linien-austria-flap-card",name:"Wiener Linien Austria — Flap Board",description:"Solari-style split-flap departure board",preview:!0,getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"wiener_linien_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:wiener-linien-austria-flap-card",entities:[t]}}:null})}let ei=class extends ce{constructor(){super(...arguments),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||"object"!=typeof e)throw new Error("wiener-linien-austria-flap-card: config must be an object");if(void 0!==e.entity&&"string"!=typeof e.entity)throw new Error("wiener-linien-austria-flap-card: 'entity' must be a string");const t=Bt(e);if((Array.isArray(e.entities)?e.entities.length:"string"==typeof e.entity&&e.entity?1:0)>0&&0===t.entities.length)throw new Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement("wiener-linien-austria-flap-card-editor")}static getStubConfig(e){const t=Ut(e)[0];if(!t)return{};let i="H";const n=e?.states?.[t]?.attributes?.departures;if(Array.isArray(n)){const e=n.some(e=>"H"===e.direction),t=n.some(e=>"R"===e.direction);!e&&t&&(i="R")}return{entity:t,direction:i}}connectedCallback(){super.connectedCallback(),function(){if("undefined"==typeof document)return;if(document.getElementById(Ee))return;const e=document.createElement("style");e.id=Ee,e.textContent='\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans";\n  src: url("/wiener-linien-austria/fonts/wl-sans-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Sans Condensed";\n  src: url("/wiener-linien-austria/fonts/wl-sans-condensed-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-regular.woff2") format("woff2");\n  font-weight: 400;\n  font-style: normal;\n  font-display: swap;\n}\n@font-face {\n  font-family: "WL Mono";\n  src: url("/wiener-linien-austria/fonts/wl-mono-bold.woff2") format("woff2");\n  font-weight: 700;\n  font-style: normal;\n  font-display: swap;\n}\n',document.head.appendChild(e)}(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_versionMismatch")||e.has("_displayed")||e.has("_target")||e.has("_justFlipped"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._resolveStopEids();return 0!==i.length&&i.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config)return;if(!e.has("hass")&&!e.has("_config"))return;const t=this._gatherRows(),i=this._maxDestLen(t),n=this._maxLineLen(t);for(let e=0;e<t.length;e++){const a=t[e];a&&(this._diffFlipField(Qt(e,"line"),(a.line??"?").toUpperCase().padStart(n," ")),this._diffFlipField(Qt(e,"dest"),(a.towards??"").toUpperCase().padEnd(i," ")),this._diffFlipField(Qt(e,"cd"),Jt(a.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Qt(e,"line"),null),this._diffFlipField(Qt(e,"dest"),null),this._diffFlipField(Qt(e,"cd"),null)}_clearFlipTimer(){null!==this._marchTimer&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(null!==t){if(void 0===this._displayed[e])return this._displayed={...this._displayed,[e]:t},void(this._target={...this._target,[e]:t});this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}else{if(e in this._displayed){const{[e]:t,...i}=this._displayed;this._displayed=i}if(e in this._target){const{[e]:t,...i}=this._target;this._target=i}if(e in this._justFlipped){const{[e]:t,...i}=this._justFlipped;this._justFlipped=i}}}_ensureMarchTimer(){null===this._marchTimer&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){const e={...this._displayed},t={};let i=!1;for(const[n,a]of Object.entries(this._target)){const r=e[n]??"";if(r===a)continue;const s=Math.max(r.length,a.length),o=[],l={};for(let e=0;e<s;e++){const t=r[e]??" ",i=a[e]??" ";t===i?o.push(t):(l[e]=t,o.push(Yt(t,i)))}const c=o.join("");e[n]=c,Object.keys(l).length>0&&(t[n]=l,i=!0)}this._displayed=e,this._justFlipped=t,i||this._clearFlipTimer()}async _checkCardVersion(){try{this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const n=await e.callWS({type:t});if(n?.version&&n.version!==i)return n.version}catch{}return null}(this.hass,"wiener_linien_austria/flap_card_version","2.0.0")}catch(e){console.warn("[wiener-linien-austria-flap-card] version probe failed",e)}}_resolveStopEids(){const e=this._config?.entities??[],t=this.hass?.states,i=e.map(e=>e.entity).filter(e=>t?.[e]);if(0===i.length&&0===e.length){const e=Ut(this.hass)[0];e&&i.push(e)}return 0===i.length&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(", ")})`)),i}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??"").length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??"?").length))}_gatherRows(){if(!this._config)return[];const e=this._config.entities??[],t=this._config.accessibility_only,i=[];for(const n of e){const e=this.hass?.states?.[n.entity]?.attributes??{},a=At(Array.isArray(e.departures)?e.departures:[],{direction:n.direction,lines:n.lines,line_directions:n.line_directions,walk_times:n.walk_times,accessibility_only:t});i.push(...a)}const n=e=>Number.isFinite(e.countdown)?e.countdown:Number.POSITIVE_INFINITY;return i.sort((e,t)=>n(e)-n(t)),i.slice(0,this._config.max_rows)}_t(e,t){return Fe(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return G;const e=this._config,t=this._resolveStopEids(),i=this._gatherRows(),n=t[0]??"",a=n?this.hass?.states?.[n]?.attributes??{}:{},r=a.stop_name||a.friendly_name||"",s=a.line_colors??{},o=a.server_time,l=e.show_platform&&i.some(e=>e.platform),c=(i[0]?.type??"")===Et,d=this._t(c?"gleis":"steig"),h=!1===this.hass?.themes?.darkMode,p={flap:!0,[`flap--size-${e.size}`]:"regular"!==e.size,"flap--has-platform":l,"flap--light":h,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},u=this._resolveStationHeaderStyle(e.station_bg,e.entities,i,s),_=e.show_header?function(e){const{left:t,right:i,serverTime:n,t:a,lang:r}=e;return t||i?I`
  ...
  `:G}({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):G,f=e.hide_attribution?"":"string"==typeof a.attribution&&a.attribution||"Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0";return I`
    ...
    `}_renderRow(e,t,i,n,a,r,s){const o=this._config,l=Number.isFinite(e.countdown)?e.countdown:null,c=null!==l&&l<=0,d=(e.line??"?").toUpperCase(),h=d.padStart(s," "),p=(e.towards??"").toUpperCase(),u=[d,p,null===l?this._t("no_data"):c?this._t("at_platform"):this._t("countdown_minutes",{n:String(l)})].filter(Boolean).join(" — "),_=gt(d,{},i),f="var(--primary-color)"!==_.background?{tileBg:_.background,blankSpace:!0}:{blankSpace:!0},g=this._renderFlipString(Jt(e.countdown),Qt(t,"cd"),{blankSpace:!0}),m=n?I`<div class="flap-cell flap-cell--platform" aria-hidden="true">
      ...
      <div class="flap-row" role="listitem" aria-label=${u}>
        ${a?G:I`<div class="flap-cell flap-cell--line" aria-hidden="true">
              ${this._renderFlipString(h,Qt(t,"line"),f)}
            </div>`}
        <div class="flap-cell flap-cell--dest" aria-hidden="true">
          ${this._renderFlipString(p.padEnd(r," "),Qt(t,"dest"),{blankSpace:!0})}
  ...
  `}};e([_e({attribute:!1})],ei.prototype,"hass",void 0),e([fe()],ei.prototype,"_config",void 0),e([fe()],ei.prototype,"_versionMismatch",void 0),e([fe()],ei.prototype,"_displayed",void 0),e([fe()],ei.prototype,"_target",void 0),e([fe()],ei.prototype,"_justFlipped",void 0),ei=e([he("wiener-linien-austria-flap-card")],ei);export{ei as WienerLinienAustriaFlapCard};
