  ...
  `}(t,i,n,{lines:c,picked:d,colorOf:l,typeByLine:p})}
    ...
    <div class="wl-group">
      ...
      <div class="wl-dirs">
        ...
        ${t.singleLine?G:mt({label:t.t("dir_both"),active:f,disabled:p,title:p?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>i.setDirection(e.entity,null)})}
      </div>
      ${b?I`<span class="wl-note">${b}</span>`:G}
    </div>
  `}(t,i,n,{triplets:h,picked:d,lines:c,dirStrings:_}):G}
        ${r||i.singleLine?G:function(e,t,i,n){const{triplets:a,picked:r,lines:s,colorOf:o,dirStrings:l}=n,c=r.size>0?s.filter(e=>r.has(e)):s;if(c.length<2)return G;const d=e.line_directions??{},h=e.direction??null;return I`
    <div class="wl-group wl-divide">
      ...
      ${c.map(n=>{const r=ft(a,n),s=d[n]??null,c=r.has("H"),h=r.has("R"),p=1===r.size,_=e=>t.et("per_line_direction_aria").replace("{line}",n).replace("{direction}",null===e?t.t("dir_both"):dt(ut(a,e,n),l(e)));return I`
        ...
        `})}
      ${null===h?G:I`<span class="wl-note">${t.et("per_line_direction_hint")}</span>`}
    </div>
  ...
  `}
    ...
    <ha-icon class="retro-station-header__mdi" icon=${e}></ha-icon>
      ...
      >
        ...
        ></ha-icon>
        <span>${f}</span>
      </span>`:G,m=e.show_date?zt(i,e.date_format??"d.m.Y",a):null,b=m?I`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${m}</span
      >`:G;return"left"===t?I`${r}${s}${d}${c}${l}${h}${_}${b}${g}`:I`${g}${b}${u}${p}${l}${c}${d}${s}${r}`}e([ue({attribute:!1})],$t.prototype,"hass",void 0),e([fe()],$t.prototype,"_config",void 0),e([fe()],$t.prototype,"_tab",void 0),e([fe()],$t.prototype,"_headerSide",void 0),$t=e([he("wiener-linien-austria-flap-card-editor")],$t);
