...
* SPDX-License-Identifier: BSD-3-Clause
*/
const re=globalThis,ie=e=>e,ae=re.trustedTypes,oe=ae?ae.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,se=`$lit$`,C=`lit$${Math.random().toFixed(9).slice(2)}$`,ce=`?`+C,le=`<${ce}>`,w=document,T=()=>w.createComment(``),E=e=>e===null||typeof e!=`object`&&typeof e!=`function`,ue=Array.isArray,de=e=>ue(e)||typeof e?.[Symbol.iterator]==`function`,fe=`[ 	
\f\r]`,D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,pe=/-->/g,me=/>/g,O=RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),he=/'/g,ge=/"/g,_e=/^(?:script|style|textarea|title)$/i,ve=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),k=ve(1),A=ve(2),j=Symbol.for(`lit-noChange`),M=Symbol.for(`lit-nothing`),ye=new WeakMap,N=w.createTreeWalker(w,129);function be(e,t){if(!ue(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return oe===void 0?t:oe.createHTML(t)}const xe=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=D;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===D?c[1]===`!--`?o=pe:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=O):(_e.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=O):o=me:o===O?c[0]===`>`?(o=i??D,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?O:c[3]===`"`?ge:he):o===ge||o===he?o=O:o===pe||o===me?o=D:(o=O,i=void 0);let d=o===O&&e[t+1].startsWith(`/>`)?` `:``;a+=o===D?n+le:l>=0?(r.push(s),n.slice(0,l)+se+n.slice(l)+C+d):n+C+(l===-2?t:d)}return[be(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]};var Se=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=xe(t,n);if(this.el=e.createElement(l,r),N.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=N.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(se)){let t=u[o++],n=i.getAttribute(e).split(C),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?we:r[1]===`?`?Te:r[1]===`@`?Ee:I}),i.removeAttribute(e)}else e.startsWith(C)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(_e.test(i.tagName)){let e=i.textContent.split(C),t=e.length-1;if(t>0){i.textContent=ae?ae.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],T()),N.nextNode(),c.push({type:2,index:++a});i.append(e[t],T())}}}else if(i.nodeType===8){if(i.data===ce)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(C,e+1))!==-1;)c.push({type:7,index:a}),e+=C.length-1}}a++}}static createElement(e,t){let n=w.createElement(`template`);return n.innerHTML=e,n}};function P(e,t,n=e,r){if(t===j)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=E(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=P(e,i._$AS(e,t.values),i,r)),t}var Ce=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??w).importNode(t,!0);N.currentNode=r;let i=N.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new F(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new De(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=N.nextNode(),a++)}return N.currentNode=w,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},F=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=M,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=P(this,e,t),E(e)?e===M||e==null||e===``?(this._$AH!==M&&this._$AR(),this._$AH=M):e!==this._$AH&&e!==j&&this._(e):e._$litType$===void 0?e.nodeType===void 0?de(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==M&&E(this._$AH)?this._$AA.nextSibling.data=e:this.T(w.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Se.createElement(be(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Ce(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=ye.get(e.strings);return t===void 0&&ye.set(e.strings,t=new Se(e)),t}k(t){ue(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(T()),this.O(T()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ie(e).nextSibling;ie(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},I=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=M,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=M}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=P(this,e,t,0),a=!E(e)||e!==this._$AH&&e!==j,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=P(this,r[n+o],t,o),s===j&&(s=this._$AH[o]),a||=!E(s)||s!==this._$AH[o],s===M?e=M:e!==M&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===M?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},we=class extends I{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===M?void 0:e}},Te=class extends I{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==M)}},Ee=class extends I{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=P(this,e,t,0)??M)===j)return;let n=this._$AH,r=e===M&&n!==M||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==M&&(n===M||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},De=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){P(this,e)}};const Oe={M:se,P:C,A:ce,C:1,L:xe,R:Ce,D:de,V:P,I:F,H:I,N:Te,U:Ee,B:we,F:De},ke=re.litHtmlPolyfillSupport;ke?.(Se,F),(re.litHtmlVersions??=[]).push(`3.3.3`);const Ae=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new F(t.insertBefore(T(),e),e,void 0,n??{})}return i._$AI(e),i},je=globalThis
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
  ...
  `}function xt(e,t){return k`
    <section class="wl-section">
      <header class="wl-section-header">
        ...
        ${e.hint?k`<span class="wl-section-hint">${e.hint}</span>`:M}
      </header>
      <div class="wl-section-body">${t}</div>
    </section>
  `}function W(e){return xt(e,k`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
...
*/const St=B(class extends Le{constructor(e){if(super(e),e.type!==z.PROPERTY&&e.type!==z.ATTRIBUTE&&e.type!==z.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ze(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===j||t===M)return t;let n=e.element,r=e.name;if(e.type===z.PROPERTY){if(t===n[r])return j}else if(e.type===z.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return j}else if(e.type===z.ATTRIBUTE&&n.getAttribute(r)===t+``)return j;return Ve(e),t}}),Ct={exit:{kind:`svg`,viewBox:`0 0 36.29 29.04`,glyphPointsTo:`left`,labelKey:`icon_exit`,shapes:()=>A`
    ...
    `},"exit-access":{kind:`svg`,viewBox:`0 0 36.29 29.04`,glyphPointsTo:`right`,labelKey:`icon_exit_access`,shapes:()=>A`
    ...
    `},wc:{kind:`text`,text:`WC`,labelKey:`icon_wc`},escalator:{kind:`svg`,viewBox:`0 0 36.74 28.3`,labelKey:`icon_escalator`,shapes:()=>A`
    ...
    `},elevator:{kind:`svg`,viewBox:`0 0 24.01 36.69`,labelKey:`icon_elevator`,shapes:()=>A`
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${an.map(t=>{let r=(n.exit??`none`)===t.value,a=e.et(t.labelKey);return k`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${rn.map(t=>{let r=!!n[t.key],a=e.et(t.labelKey);return k`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?`true`:`false`}
                aria-label=${a}
  ...
  `}function cn(e,t,n,r){let i=e===`header_left`?t.left:t.right,a=t.selected===e,o=on(i,r,t.et),s=t.et(e===`header_left`?`header_left`:`header_right`);return k`<button
    type="button"
  ...
  </button>`}function ln(e,t,n){let r=e.chips??[],i=e.extra_icons??[];return k`
    <div class="wl-group">
      <span class="wl-label"
  ...
  `}function un(e,t){let n=e.filter((e,n)=>n!==t);return n.length?n:void 0}function dn(e){return xt({title:e.et(`section_header`),hint:e.et(`section_header_hint`)},k`
      <ha-form
        .hass=${e.hass}
    ...
    <section class="wl-section">
      <header class="wl-section-header">
        ${n.total>1?k`<span class="wl-index" aria-hidden="true">${n.index}</span>`:M}
  ...
  `}function jn(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return k`
    <div class="wl-group">
      <div class="wl-group-head">
        <span class="wl-label wl-label--grow">${t.et(`lines_label`)}</span>
        ${i.length?k`<span class="wl-note">${c}</span>`:M}
      </div>
      ${i.length?k`<div class="wl-chips">
            ${i.map(r=>{let i=t.singleLine?a.has(r):a.size===0||a.has(r),c=Cn(s.get(r));return k`<button
                type="button"
                class="wl-chip"
                style=${H(wn(o(r)))}
  ...
  `}function Mn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=vn(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=_n(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},ee=e=>f.unknown||f.available.has(e)?gn(Dn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,b=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return k`
    <div class="wl-group">
      ...
      ${b?k`<span class="wl-note">${b}</span>`:M}
    </div>
  `}function J(e){return k`<button
    type="button"
  ...
  >
    ...
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=_n(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):gn(Dn(a,n,e),l(n)));return k`
  ...
  `}function Pn(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=xn(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?k`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=fn(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return k`
  ...
  `:M}function Fn(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0,composed:!0}))}const In=new Set([`small`,`medium`,`regular`]),Ln=new Set([`line`,`white`,`black`]);function Rn(e){return typeof e==`string`&&(Ln.has(e)||e.startsWith(`line:`)&&e.length>5)?e:q.station_bg.flap}function zn(e,t){return typeof e==`boolean`?e:t}function Bn(e){if(typeof e==`string`)return e.startsWith(`sensor.`)?{entity:e}:null;if(!e||typeof e!=`object`)return null;let t=e,n=typeof t.entity==`string`?t.entity:null;return n?.startsWith(`sensor.`)?en(n,t):null}const Vn=new Set([`type`,`entities`,`entity`,`line`,`lines`,`direction`,`walk_times`,`size`,`max_rows`,`show_platform`,`show_station_name`,`show_station_header`,`station_bg`,`show_min_unit`,`show_accessibility`,`accessibility_only`,`show_header`,`header_left`,`header_right`,`hide_attribution`,`show_line_column`,`line_pill`,`housing`]);function Hn(e){let t=In.has(e.size)?e.size:q.size.flap,n=Number(e.max_rows),r=Number.isFinite(n);e.max_rows!==void 0&&!r&&console.warn(`[wiener-linien-austria-flap-card] max_rows ${JSON.stringify(e.max_rows)} is not a number — falling back to 2`);let i=r?Math.max(1,Math.min(8,Math.round(n))):2,a=[];if(Array.isArray(e.entities))a=e.entities;else if(typeof e.entity==`string`){let t;Array.isArray(e.lines)?t=e.lines.filter(e=>typeof e==`string`&&e.length>0):typeof e.line==`string`&&e.line&&(t=[e.line]),a=[{entity:e.entity,...t&&t.length?{lines:t}:{},...e.direction===void 0?{}:{direction:e.direction},...e.walk_times===void 0?{}:{walk_times:e.walk_times}}]}let o=[],s=new Set;for(let e of a){let t=Bn(e);if(!t){console.warn(`[wiener-linien-austria-flap-card] dropping malformed stop entry`,e);continue}s.has(t.entity)||(s.add(t.entity),o.push(t))}let c=Zt(e,Vn),l=Rn(e.station_bg),u=e.show_station_header,d=typeof e.show_station_name==`boolean`?e.show_station_name:typeof u==`boolean`?u:q.show_station_name.flap;return{...c,type:e.type||`custom:wiener-linien-austria-flap-card`,entities:o,size:t,max_rows:i,show_platform:zn(e.show_platform,q.show_platform.flap),show_station_name:d,station_bg:l,show_min_unit:zn(e.show_min_unit,q.unit_caption.flap),show_accessibility:zn(e.show_accessibility,!0),accessibility_only:e.accessibility_only===!0,show_header:e.show_header===!0,header_left:Xt(e.header_left),header_right:Xt(e.header_right),hide_attribution:e.hide_attribution===!0,show_line_column:e.show_line_column===void 0?e.line_pill!==!0:e.show_line_column===!0,housing:zn(e.housing,q.housing.flap)}}function Y(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let X=class extends L{constructor(...e){super(...e),this._tab=`stops`,this._headerSide=`header_left`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Hn({...this._config,entities:Mt(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>Pt(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n;return Ft(this._i18n,e.name,{...this._config?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)}})}}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card-editor: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card-editor: 'entity' must be a string`);this._config=Hn(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`)||e.has(`_headerSide`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._config.entities.map(e=>e.entity);return n.length===0||n.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return vt(`flap`,this.hass?.language)}_commit(e){this._config=e,Fn(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Hn({...this._config,...e}))}get _stopCallbacks(){return jt(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return M;let{et:e}=this._i18n;return k`
      <div class="wl-editor">
    ...
    `}_stationBgOptions(){let{et:e}=this._i18n,t=[{value:`line`,label:e(`station_bg_line`)}],n=new Set;for(let e of this._config?.entities??[]){let t=this.hass?.states?.[e.entity]?.attributes,r=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(let e of r??[])typeof e==`string`&&e&&n.add(e)}if(n.size===0){let e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(let e of Object.keys(t??{}))n.add(e)}for(let e of[...n].sort())t.push({value:`line:${e}`,label:e});return t.push({value:`white`,label:e(`station_bg_white`)}),t.push({value:`black`,label:e(`station_bg_black`)}),t}static{this.styles=[gt,ht,_t]}};Y([Ie({attribute:!1})],X.prototype,`hass`,void 0),Y([R()],X.prototype,`_config`,void 0),Y([R()],X.prototype,`_tab`,void 0),Y([R()],X.prototype,`_headerSide`,void 0),X=Y([Ne(`wiener-linien-austria-flap-card-editor`)],X);function Un(e){return Wn(e,e=>typeof e.diva==`number`&&Array.isArray(e.departures)&&!!e.next_by_line&&typeof e.next_by_line==`object`)}function Wn(e,t){if(!e)return[];let n=[];for(let[r,i]of Object.entries(e.states??{}))r.startsWith(`sensor.`)&&t(i?.attributes??{})&&n.push(r);return n.sort()}function Gn(e,t){return!e||!t?{}:e.states?.[t]?.attributes?.line_colors??{}}function Kn(e,t){if(!e)return{};let n={};for(let r of t)for(let[t,i]of Object.entries(Gn(e,r)))t in n||(n[t]=i);return n}function qn(e){if(!e)return null;let t=Date.parse(e);if(!Number.isFinite(t))return null;let n=new Date(t);return`${String(n.getHours()).padStart(2,`0`)}:${String(n.getMinutes()).padStart(2,`0`)}`}function Z(e){return String(e).padStart(2,`0`)}function Jn(e,t,n=`de`){if(!t)return``;let r=n===`en`?`en-GB`:`de-AT`,i=()=>e.toLocaleDateString(r,{weekday:`long`}),a=()=>e.toLocaleDateString(r,{weekday:`short`}),o=()=>e.toLocaleDateString(r,{month:`long`}),s=()=>e.toLocaleDateString(r,{month:`short`}),c=``,l=0;for(;l<t.length;){let n=t[l];if(n===`\\`&&l+1<t.length){c+=t[l+1],l+=2;continue}switch(n){case`d`:c+=Z(e.getDate());break;case`j`:c+=String(e.getDate());break;case`D`:c+=a();break;case`l`:c+=i();break;case`m`:c+=Z(e.getMonth()+1);break;case`n`:c+=String(e.getMonth()+1);break;case`M`:c+=s();break;case`F`:c+=o();break;case`Y`:c+=String(e.getFullYear());break;case`y`:c+=Z(e.getFullYear()%100);break;case`H`:c+=Z(e.getHours());break;case`G`:c+=String(e.getHours());break;case`h`:c+=Z((e.getHours()+11)%12+1);break;case`g`:c+=String((e.getHours()+11)%12+1);break;case`i`:c+=Z(e.getMinutes());break;case`s`:c+=Z(e.getSeconds());break;default:c+=n??``}l++}return c}function Yn(e,t,n){if(!e||!t)return null;let r=Date.parse(e);return Number.isFinite(r)?Jn(new Date(r),t,n):null}function Xn(e,t,n,r,i){let a=M;if(e.exit===`regular`||e.exit===`accessible`){let n=e.exit===`regular`?`exit`:`exit-access`;a=Dt(n,{ariaLabel:r(`header.${Ct[n].labelKey}`),flipX:Ct[n].glyphPointsTo!==t})}else if(e.exit&&Et(e.exit)){let n=Tt[e.exit];a=Ot(e.exit,{ariaLabel:r(`header.${n.labelKey}`),flipX:n.glyphPointsTo!==void 0&&n.glyphPointsTo!==t})}let o=e.text?k`<span class="retro-station-header__text">${e.text}</span>`:M,s=e=>Dt(e,{ariaLabel:r(`header.${Ct[e].labelKey}`)}),c=e.show_wc?s(`wc`):M,l=e.show_escalator?s(`escalator`):M,u=e.show_elevator?s(`elevator`):M,d=(e.extra_icons??[]).map(e=>kt(e,e)),f=[...d].reverse(),p=(e.chips??[]).map(e=>k`<span class="retro-station-header__chip">${e}</span>`),m=[...p].reverse(),h=e.show_clock?qn(n):null,g=h?k`<span
      ...
      >
        ...
        ></ha-icon>
        <span>${h}</span>
      </span>`:M,_=e.show_date?Yn(n,e.date_format??`d.m.Y`,i):null,v=_?k`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${_}</span
      >`:M;return t===`left`?k`${a}${o}${u}${l}${c}${d}${p}${v}${g}`:k`${g}${v}${m}${f}${c}${l}${u}${o}${a}`}function Zn(e){let{left:t,right:n,serverTime:r,t:i,lang:a}=e;return!t&&!n?M:k`
  ...
  `}const Qn=`ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß`,$n=`0123456789`;function er(e,t,n){let r=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return r===e.length?n:e[r]}function tr(e,t){if(e===t)return t;let n=Qn.includes(e),r=$n.includes(e),i=Qn.includes(t),a=$n.includes(t);return(n||i)&&!r&&!a?er(Qn,e,t):(r||a)&&!n&&!i?er($n,e,t):t}function Q(e,t){return`row${e}-${t}`}const nr={small:22,medium:28,regular:32};function rr(e){let t=typeof e==`number`&&Number.isFinite(e)?e:null;return t===null?`--`:String(t<=0?0:t).padStart(2,` `)}{let e=window;e.customCards=e.customCards??[],e.customCards.some(e=>e.type===`wiener-linien-austria-flap-card`)||e.customCards.push({type:`wiener-linien-austria-flap-card`,name:`Wiener Linien Austria — Flap Board`,description:ut(`picker_flap`),preview:!0,getEntitySuggestion:(e,t)=>!t.startsWith(`sensor.`)||e?.entities?.[t]?.platform!==`wiener_linien_austria`?null:{config:{type:`custom:wiener-linien-austria-flap-card`,entities:[t]}}})}let $=class extends L{constructor(...e){super(...e),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card: 'entity' must be a string`);let t=Hn(e);if((Array.isArray(e.entities)?e.entities.length:typeof e.entity==`string`&&e.entity?1:0)>0&&t.entities.length===0)throw Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:`auto`,min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement(`wiener-linien-austria-flap-card-editor`)}static getStubConfig(e){let t=Un(e)[0];return t?{entity:t,direction:pn(e?.states?.[t]?.attributes?.departures)}:{}}connectedCallback(){super.connectedCallback(),We(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_versionMismatch`)||e.has(`_displayed`)||e.has(`_target`)||e.has(`_justFlipped`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._resolveStopEids();return n.length!==0&&n.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config||!e.has(`hass`)&&!e.has(`_config`))return;let t=this._gatherRows(),n=this._maxDestLen(t),r=this._maxLineLen(t);for(let e=0;e<t.length;e++){let i=t[e];i&&(this._diffFlipField(Q(e,`line`),(i.line??`?`).toUpperCase().padStart(r,` `)),this._diffFlipField(Q(e,`dest`),(i.towards??``).toUpperCase().padEnd(n,` `)),this._diffFlipField(Q(e,`cd`),rr(i.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Q(e,`line`),null),this._diffFlipField(Q(e,`dest`),null),this._diffFlipField(Q(e,`cd`),null)}_clearFlipTimer(){this._marchTimer!==null&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(t===null){if(e in this._displayed){let{[e]:t,...n}=this._displayed;this._displayed=n}if(e in this._target){let{[e]:t,...n}=this._target;this._target=n}if(e in this._justFlipped){let{[e]:t,...n}=this._justFlipped;this._justFlipped=n}return}if(this._displayed[e]===void 0){this._displayed={...this._displayed,[e]:t},this._target={...this._target,[e]:t};return}this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}_ensureMarchTimer(){this._marchTimer===null&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){let e={...this._displayed},t={},n=!1;for(let[r,i]of Object.entries(this._target)){let a=e[r]??``;if(a===i)continue;let o=Math.max(a.length,i.length),s=[],c={};for(let e=0;e<o;e++){let t=a[e]??` `,n=i[e]??` `;t===n?s.push(t):(c[e]=t,s.push(tr(t,n)))}e[r]=s.join(``),Object.keys(c).length>0&&(t[r]=c,n=!0)}this._displayed=e,this._justFlipped=t,n||this._clearFlipTimer()}async _checkCardVersion(){this._versionMismatch=await dt(this.hass,`wiener_linien_austria/flap_card_version`,`2.0.0`)}_resolveStopEids(){let e=this._config?.entities??[],t=this.hass?.states,n=e.map(e=>e.entity).filter(e=>t?.[e]);if(n.length===0&&e.length===0){let e=Un(this.hass)[0];e&&n.push(e)}return n.length===0&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(`, `)})`)),n}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??``).length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??`?`).length))}_gatherRows(){if(!this._config)return[];let e=this._config.entities??[],t=this._config.accessibility_only,n=[];for(let r of e){let e=this.hass?.states?.[r.entity]?.attributes??{},i=bn(Array.isArray(e.departures)?e.departures:[],{direction:r.direction,lines:r.lines,line_directions:r.line_directions,walk_times:r.walk_times,accessibility_only:t});n.push(...i)}let r=e=>Number.isFinite(e.countdown)?e.countdown:1/0;return n.sort((e,t)=>r(e)-r(t)),n.slice(0,this._config.max_rows)}_t(e,t){return U(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return M;let e=this._config,t=this._resolveStopEids(),n=this._gatherRows(),r=t[0]??``,i=r?this.hass?.states?.[r]?.attributes??{}:{},a=i.stop_name||i.friendly_name||``,o=i.server_time,s=Kn(this.hass,t),c=e.show_platform&&n.some(e=>e.platform),l=(n[0]?.type??``)===Sn,u=this._t(l?`gleis`:`steig`),d=this.hass?.themes?.darkMode===!1,f={flap:!0,[`flap--size-${e.size}`]:e.size!==`regular`,"flap--has-platform":c,"flap--light":d,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},p=this._resolveStationHeaderStyle(e.station_bg,e.entities,n,s),m=e.show_header?Zn({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):M,h=e.hide_attribution?``:typeof i.attribution==`string`&&i.attribution||`Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0`;return k`
    ...
    `}_resolveStationHeaderStyle(e,t,n,r){if(e===`white`)return{background:`#ffffff`,color:`#1a1410`};if(e===`black`)return{background:`#000000`,color:`var(--flap-cream-hi)`};let i;if(e===`line`?i=t[0]?.lines?.[0]??n[0]?.line:e.startsWith(`line:`)&&(i=e.slice(5)),!i)return{background:`var(--wl-orange)`};let a=tn(i,{},r);return{background:a.background===`var(--primary-color)`?`var(--wl-orange)`:a.background,color:`var(--flap-on-color-fg)`}}_renderBoard(e,t,n,r,i,a,o){let s=this._maxDestLen(t),c=this._maxLineLen(t);if(e.length===0)return k`<div class="flap-empty">${this._t(`no_entity`)}</div>`;if(t.length===0){let t=e.some(e=>{let t=this.hass?.states?.[e]?.attributes??{};return Array.isArray(t.departures)&&t.departures.length>0}),n=e.some(e=>{let t=this.hass?.states?.[e]?.attributes??{};return typeof t.stale_departures==`number`&&t.stale_departures>0}),r=t?`no_data`:n?`stale_feed`:`betriebsschluss`;return k`<div class="flap-empty">${this._t(r)}</div>`}let l=nr[this._config?.size??`regular`],u=s*l+Math.max(0,s-1)*2,d=i?u+6+l:u;return k`
      ...
      >
        <div class="flap-colheader" aria-hidden="true">
          ${a?M:k`<span class="flap-colheader__line"
    ...
    `}_renderRow(e,t,n,r,i,a,o){let s=this._config,c=Number.isFinite(e.countdown)?e.countdown:null,l=c!==null&&c<=0,u=(e.line??`?`).toUpperCase(),d=u.padStart(o,` `),f=(e.towards??``).toUpperCase(),p=[u,f,c===null?this._t(`no_data`):l?this._t(`at_platform`):this._t(`countdown_minutes`,{n:String(c)}),e.timetable?this._t(`timetable_title`):``].filter(Boolean).join(` — `),m=tn(u,{},n),h=m.background===`var(--primary-color)`?{blankSpace:!0}:{tileBg:m.background,blankSpace:!0},g=this._renderFlipString(rr(e.countdown),Q(t,`cd`),{blankSpace:!0}),_=r?k`<div class="flap-cell flap-cell--platform" aria-hidden="true">
      ...
      <div class="flap-row" role="listitem" aria-label=${p}>
        ${i?M:k`<div class="flap-cell flap-cell--line" aria-hidden="true">
        ...
        <div class="flap-cell flap-cell--cd" aria-hidden="true">
          ...
          ${s.show_min_unit&&c!==null?k`<span class="flap-cd-unit">${this._t(`unit_min`)}</span>`:M}
        </div>
      </div>
    ...
    >`}_renderTile(e,t,n,r={}){if(e===` `&&!r.blankSpace)return k`<span class="flap-space" aria-hidden="true">&nbsp;</span>`;let i=e===` `,a=i?void 0:r.tileBg,o=i?void 0:r.tileFg,s=t!==void 0,c=H({"--tile-i":String(n),...a?{"--tile-bg":a}:{},...o?{"--tile-fg":o}:{}}),l=V({"flap-tile":!0,"flap-tile--wide":r.wide===!0,"flap-tile--color":a!==void 0,"flap-tile--flipping":s,"flap-tile--blank":i}),u=e===` `?``:e;return k`<span class=${l} style=${c}>
      ...
      ${s?k`<span class="flap-tile__leaf"
          ...
          >`:M}
    </span>`}_renderPictogramTile(e,t,n=`a11y`){return k`<span
