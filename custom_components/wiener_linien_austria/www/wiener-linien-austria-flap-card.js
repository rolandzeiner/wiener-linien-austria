      ...
      <ha-card style="padding:0;overflow:hidden;">
        <div class=${we(p)}>
          ...
          <div class="flap-panel">
            ${this._renderBoard(t,s,n,a,h,c,o)}
          </div>
        </div>
      </ha-card>
    `}_renderBoard(e,t,i,n,s,r,a){if(!e)return j`<div class="flap-empty">${this._t("no_entity")}</div>`;if(0===t.length){const e=this._config.direction,t=this._config.line,n=i.filter(t=>t.direction===e);let s="no_data";return 0===i.length?s="betriebsschluss":i.length>0&&0===n.length?s="no_data_wrong_direction":t&&n.length>0&&(s="no_data_wrong_line"),j`<div class="flap-empty">${this._t(s)}</div>`}return j`
