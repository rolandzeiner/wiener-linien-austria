...
`,document.head.appendChild(e)}function dn(e){if(!e)return null;let t=Date.parse(e);if(!Number.isFinite(t))return null;let n=new Date(t);return`${String(n.getHours()).padStart(2,`0`)}:${String(n.getMinutes()).padStart(2,`0`)}`}function J(e){return String(e).padStart(2,`0`)}function fn(e,t,n=`de`){if(!t)return``;let r=n===`en`?`en-GB`:`de-AT`,i=()=>e.toLocaleDateString(r,{weekday:`long`}),a=()=>e.toLocaleDateString(r,{weekday:`short`}),o=()=>e.toLocaleDateString(r,{month:`long`}),s=()=>e.toLocaleDateString(r,{month:`short`}),c=``,l=0;for(;l<t.length;){let n=t[l];if(n===`\\`&&l+1<t.length){c+=t[l+1],l+=2;continue}switch(n){case`d`:c+=J(e.getDate());break;case`j`:c+=String(e.getDate());break;case`D`:c+=a();break;case`l`:c+=i();break;case`m`:c+=J(e.getMonth()+1);break;case`n`:c+=String(e.getMonth()+1);break;case`M`:c+=s();break;case`F`:c+=o();break;case`Y`:c+=String(e.getFullYear());break;case`y`:c+=J(e.getFullYear()%100);break;case`H`:c+=J(e.getHours());break;case`G`:c+=String(e.getHours());break;case`h`:c+=J((e.getHours()+11)%12+1);break;case`g`:c+=String((e.getHours()+11)%12+1);break;case`i`:c+=J(e.getMinutes());break;case`s`:c+=J(e.getSeconds());break;default:c+=n??``}l++}return c}function pn(e,t,n){if(!e||!t)return null;let r=Date.parse(e);return Number.isFinite(r)?fn(new Date(r),t,n):null}function mn(e,t,n,r,i){let a=I;if(e.exit===`regular`||e.exit===`accessible`){let n=e.exit===`regular`?`exit`:`exit-access`;a=Ot(n,{ariaLabel:r(`header.${wt[n].labelKey}`),flipX:wt[n].glyphPointsTo!==t})}else if(e.exit&&Dt(e.exit)){let n=Et[e.exit];a=kt(e.exit,{ariaLabel:r(`header.${n.labelKey}`),flipX:n.glyphPointsTo!==void 0&&n.glyphPointsTo!==t})}let o=e.text?P`<span class="retro-station-header__text">${e.text}</span>`:I,s=e=>Ot(e,{ariaLabel:r(`header.${wt[e].labelKey}`)}),c=e.show_wc?s(`wc`):I,l=e.show_escalator?s(`escalator`):I,u=e.show_elevator?s(`elevator`):I,d=(e.extra_icons??[]).map(e=>At(e,e)),f=[...d].reverse(),p=(e.chips??[]).map(e=>P`<span class="retro-station-header__chip">${e}</span>`),m=[...p].reverse(),h=e.show_clock?dn(n):null,g=h?P`<span
      ...
      >
        ...
        ></ha-icon>
        <span>${h}</span>
      </span>`:I,_=e.show_date?pn(n,e.date_format??`d.m.Y`,i):null,v=_?P`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${_}</span
      >`:I;return t===`left`?P`${a}${o}${u}${l}${c}${d}${p}${v}${g}`:P`${g}${v}${m}${f}${c}${l}${u}${o}${a}`}function hn(e){let{left:t,right:n,serverTime:r,t:i,lang:a}=e;return!t&&!n?I:P`
    <div class="retro-station-header" role="group">
      ...
      <div class="retro-station-header__side retro-station-header__side--right">
        ${n?mn(n,`right`,r,i,a):I}
      </div>
    </div>
  `}const gn=[[`A`,`A`,`B`],[`B`,`B`,`A`],[`A`,`B`,`B`],[`B`,`A`,`A`],[`A`,`B`,`A`],[`B`,`A`,`B`]],_n=1.08,vn=1.15,yn=[100,250],bn=[200,500],xn=[500,900],Sn=[.25,.5,.75],Cn=[3,2.5,2.5];function wn(e){let t=(e,t)=>e+Math.random()*(t-e),n=(e,t)=>e+(Math.random()*2-1)*t,r=Math.random()<.5?`A`:`B`,i=Math.random()<.3?r===`A`?`B`:`A`:r,a=gn.filter(e=>e[2]===i),o=a[Math.floor(Math.random()*a.length)],s=Math.random(),c=s<.4?t(yn[0],yn[1]):s<.75?t(bn[0],bn[1]):t(xn[0],xn[1]),l=t(2400,2700),u=l+c,d=l*t(_n,vn),f=u*t(_n,vn),p=r===`A`?d:f,m=r===`B`?d:f,h=r===`A`?l:u,g=r===`B`?l:u,_=e.a,v=e.b,y=e.finishCqw,b=Math.max(_,v),x=Math.max(20,92-b),S=(e,t)=>{let r=b+Sn[t]*x,i=o[t]===e,a=Cn[t];return n(r+(i?a:-a),.6)},C=S(`A`,0),ee=S(`A`,1),w=S(`A`,2),T=S(`B`,0),te=S(`B`,1),E=S(`B`,2),ne=(e,t,n)=>{let r=y-n,i=e-.75*t;if(r<=0||i<=1)return Math.max(n+5,102);let a=n+r*.25*t/i;return Math.max(102,Math.min(135,a))},D=ne(h,p,w),O=ne(g,m,E),k=(e,t,n,r,i,a)=>{let o=[[0,.25,e,t],[.25,.5,t,n],[.5,.75,n,r],[.75,1,r,i]];for(let[e,t,n,r]of o){if(n>=y)return e*a;if(r>=y)return(e+(y-n)/(r-n)*(t-e))*a}return 1/0},re=k(_,C,ee,w,D,p),A=k(v,T,te,E,O,m);return{winner:re<=A?`A`:`B`,winnerCrossT:Math.min(re,A),cssVars:{"--race-a-duration":`${p}ms`,"--race-b-duration":`${m}ms`,"--race-a-end":`${D-_}cqw`,"--race-b-end":`${O-v}cqw`,"--race-a-x-25":`${C-_}cqw`,"--race-a-x-50":`${ee-_}cqw`,"--race-a-x-75":`${w-_}cqw`,"--race-b-x-25":`${T-v}cqw`,"--race-b-x-50":`${te-v}cqw`,"--race-b-x-75":`${E-v}cqw`}}}const Tn=c`:host {
display: block;
}
.wl-editor {
display: flex;
...
outline-offset: -2px;
...
}`;function On(e,t){let n={hassLanguage:t};return{t:t=>G(`${e}.${t}`,n),et:t=>{let r=`${e}.editor.${t}`,i=G(r,n);if(i!==r)return i;let a=`common.editor.${t}`,o=G(a,n);return o===a?t:o}}}function kn(e,t,n){let r=(t,r)=>{let i=t.key===`ArrowRight`?1:t.key===`ArrowLeft`?-1:0;if(!i)return;t.preventDefault();let a=(r+i+e.length)%e.length,o=e[a];if(!o)return;n(o.key);let s=t.currentTarget.parentElement?.children[a];s instanceof HTMLElement&&s.focus()};return P`
  ...
  `}function Mn(e){return jn(e,P`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
...
* Copyright 2020 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/const Nn=Pe(class extends Fe{constructor(e){if(super(e),e.type!==H.PROPERTY&&e.type!==H.ATTRIBUTE&&e.type!==H.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Le(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===F||t===I)return t;let n=e.element,r=e.name;if(e.type===H.PROPERTY){if(t===n[r])return F}else if(e.type===H.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return F}else if(e.type===H.ATTRIBUTE&&n.getAttribute(r)===t+``)return F;return ze(e),t}});function Y(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function Pn(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}const Fn=[{key:`show_wc`,icon:`mdi:human-male-female`,labelKey:`show_wc_short`},{key:`show_escalator`,icon:`mdi:escalator`,labelKey:`show_escalator_short`},{key:`show_elevator`,icon:`mdi:elevator`,labelKey:`show_elevator_short`},{key:`show_clock`,icon:`mdi:clock-outline`,labelKey:`show_clock_short`},{key:`show_date`,icon:`mdi:calendar`,labelKey:`show_date_short`}],In=[{value:`regular`,icon:`mdi:exit-run`,labelKey:`header_exit_regular`},{value:`accessible`,icon:`mdi:wheelchair-accessibility`,labelKey:`header_exit_accessible`},...Tt.map(e=>({value:e,icon:e,labelKey:Et[e].labelKey})),{value:`none`,icon:`mdi:close-circle-outline`,labelKey:`header_exit_none`}];function Ln(e,t,n){let r=[];if(!e)return[{label:t,kind:`text`,name:t}];if(e.exit&&e.exit!==`none`){let t=In.find(t=>t.value===e.exit);r.push({label:``,icon:t?.icon??e.exit,kind:`icon`,name:t?n(t.labelKey):e.exit})}e.text&&r.push({label:e.text,kind:`text`,name:e.text});for(let t of Fn)e[t.key]&&r.push({label:``,icon:t.icon,kind:`icon`,name:n(t.labelKey)});for(let t of e.extra_icons??[])r.push({label:``,icon:t,kind:`icon`,name:t});for(let t of e.chips??[])r.push({label:t,kind:`chip`,name:t});return r.length||r.push({label:t,kind:`text`,name:t}),r}function Rn(e,t){let n=(e.selected===`header_left`?e.left:e.right)??{},r=e.et(`header_slot_empty`),i=(n,r)=>t.patch(e.selected,n,r);return P`
    <div class="wl-strip">
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${In.map(t=>{let r=(n.exit??`none`)===t.value,a=e.et(t.labelKey);return P`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${Fn.map(t=>{let r=!!n[t.key],a=e.et(t.labelKey);return P`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?`true`:`false`}
                aria-label=${a}
  ...
  `}function zn(e,t,n,r){let i=e===`header_left`?t.left:t.right,a=t.selected===e,o=Ln(i,r,t.et),s=t.et(e===`header_left`?`header_left`:`header_right`);return P`<button
    type="button"
  ...
  </button>`}function Bn(e,t,n){let r=e.chips??[],i=e.extra_icons??[];return P`
    <div class="wl-group">
      <span class="wl-label"
  ...
  `}function Vn(e,t){let n=e.filter((e,n)=>n!==t);return n.length?n:void 0}function Hn(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Un(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Wn(e,t){return e?.states?.[t]?.attributes}function Gn(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function Kn(e,t){return!e.singleLine&&$t(t.lines,t.picked).length>=2}function qn(e,t,n,r){let i=Wn(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=pt(e),l=e=>Kt(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=en(i),f=u.size?[...new Set([...d,...u])].sort():d,p=Jt(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return P`
    <section class="wl-section">
      <header class="wl-section-header">
      ...
      <div class="wl-stop-body">
        ...
        ${!a&&f.length?Kn(n,{lines:f,picked:u})?Zn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):Xn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):I}
        ${a?I:Qn(t,n,r,{attrs:i,picked:u,colorOf:l,lines:f,dirStrings:h})}
      </div>
    </section>
  `}function Jn(e,t,n){return P`
  ...
  `}function Yn(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return P`
    <div class="wl-group">
  ...
  `}function Xn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=$t(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=Qt(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>f.unknown||f.available.has(e)?Xt(Gn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,x=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return P`
    <div class="wl-group">
  ...
  </button>`}function Zn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=$t(s,o),d=e.line_directions??{},f=e.direction??null,p=e=>d[e]??f,m=(t,r)=>{let i={};for(let e of u){let n=e===t?r:p(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return P`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=Qt(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):Xt(Gn(a,n,e),l(n)));return P`
          <div class="wl-override-row">
            <span class="wl-badge" style=${W(Un(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
  ...
  `}function Qn(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=nn(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?P`
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=qt(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return P`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${W(Un(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
              ...
              <span class="wl-stepper">
                ...
                <input
                  ...
                  @keyup=${Y}
                  @keypress=${Y}
                  @change=${t=>n.setWalkTime(e.entity,i,Pn(t.target.value,`${e.entity}/${i}`))}
                />
                <button
                  type="button"
                  class="wl-step-btn"
  ...
  `:I}function $n(e,t,n){let r={...e??{},[t]:n};return n===void 0&&delete r[t],r}function er(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function tr(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let Q=class extends B{constructor(...e){super(...e),this._tab=`stops`,this._headerSide=`header_left`,this._pendingDirectionFix=!1,this._onEntityChanged=e=>{if(e.stopPropagation(),!this._config)return;let t=e.detail.value.entity,n=typeof t==`string`?t:void 0;if(n===this._config.entity)return;let r={...this._config,entity:n},i=this._availableDirections(n);i.size===1&&(r.direction=i.has(`H`)?`H`:`R`),r.line=Zt(this._attrs(n),r.direction)[0],this._commit(r)},this._computeLabel=e=>er(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n;return tr(this._i18n,e.name,{...this._config?.message_ticker?{}:{message_text:t(`message_text_requires`)},...this._config?.show_platform?{}:{platform_side:t(`platform_side_requires`)}})}}setConfig(e){this._config=Wt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`)||e.has(`_headerSide`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._config.entity;return!n||t.states[n]!==this.hass.states[n]}willUpdate(e){(e.has(`_config`)||e.has(`hass`))&&this._scheduleDirectionAutocorrect()}get _i18n(){return On(`retro`,this.hass?.language)}_attrs(e){return e?this.hass?.states?.[e]?.attributes:void 0}_commit(e){this._config=e,He(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Wt({...this._config,...e}))}get _stopView(){let e=this._config;return{entity:e.entity??``,lines:e.line?[e.line]:[],direction:e.direction,walk_times:e.walk_times}}get _stopCallbacks(){return{toggleLine:(e,t)=>{if(!this._config)return;let n={...this._config};n.line===t?delete n.line:n.line=t,this._commit(n)},setDirections:(e,t)=>{if(!this._config||t.direction===null)return;let n={...this._config,direction:t.direction},r=Zt(this._attrs(n.entity),t.direction);(!n.line||!r.includes(n.line))&&(n.line=r[0]),this._commit(n)},setWalkTime:(e,t,n)=>{if(!this._config)return;let r={...this._config.walk_times??{}};n===null?delete r[t]:r[t]=n;let i={...this._config};Object.keys(r).length?i.walk_times=r:delete i.walk_times,this._commit(i)}}}render(){if(!this._config)return I;let{et:e}=this._i18n;return P`
    ...
    `}_renderDisplay(){let e=this._config,{et:t}=this._i18n,n={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return P`
      ${jn({title:t(`section_header`),hint:t(`section_header_hint`)},P`
          <ha-form
            .hass=${this.hass}
          ...
          ></ha-form>
          ${e.show_header?Rn({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,n)=>this._patchHeaderSide(e,t,n)}):I}
        `)}
      ${Mn({...n,title:t(`section_station`),data:{show_station_name:e.show_station_name,station_bg:e.station_bg},schema:[{name:`show_station_name`,selector:{boolean:{}}},{name:`station_bg`,selector:{select:{mode:`dropdown`,options:[{value:`default`,label:t(`station_bg_default`)},{value:`white`,label:t(`station_bg_white`)},{value:`black`,label:t(`station_bg_black`)}]}}}]})}
      ${Mn({...n,title:t(`section_departure_row`),hint:t(`section_led_panel`),data:{show_platform:e.show_platform,platform_side:e.platform_side,accessibility_only:e.accessibility_only},schema:[{name:`show_platform`,selector:{boolean:{}}},{name:`platform_side`,disabled:!e.show_platform,selector:{select:{mode:`dropdown`,options:[{value:`auto`,label:t(`platform_side_auto`)},{value:`left`,label:t(`platform_side_left`)},{value:`right`,label:t(`platform_side_right`)}]}}},{name:`accessibility_only`,selector:{boolean:{}}}]})}
      ${Mn({...n,title:t(`section_extras`),hint:t(`section_extras_hint`),data:{message_ticker:e.message_ticker,message_text:e.message_text??``,wheelchair_race:e.wheelchair_race},schema:[{name:`message_ticker`,selector:{boolean:{}}},{name:`message_text`,disabled:!e.message_ticker,selector:{text:{}}},{name:`wheelchair_race`,selector:{boolean:{}}}]})}
