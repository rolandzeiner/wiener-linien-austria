...
*/const Pn=Pe(class extends Fe{constructor(e){if(super(e),e.type!==H.PROPERTY&&e.type!==H.ATTRIBUTE&&e.type!==H.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Le(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===F||t===I)return t;let n=e.element,r=e.name;if(e.type===H.PROPERTY){if(t===n[r])return F}else if(e.type===H.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return F}else if(e.type===H.ATTRIBUTE&&n.getAttribute(r)===t+``)return F;return ze(e),t}});function Y(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function Fn(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}const In=[{key:`show_wc`,icon:`mdi:human-male-female`,labelKey:`show_wc_short`},{key:`show_escalator`,icon:`mdi:escalator`,labelKey:`show_escalator_short`},{key:`show_elevator`,icon:`mdi:elevator`,labelKey:`show_elevator_short`},{key:`show_clock`,icon:`mdi:clock-outline`,labelKey:`show_clock_short`},{key:`show_date`,icon:`mdi:calendar`,labelKey:`show_date_short`}],Ln=[{value:`regular`,icon:`mdi:exit-run`,labelKey:`header_exit_regular`},{value:`accessible`,icon:`mdi:wheelchair-accessibility`,labelKey:`header_exit_accessible`},...Tt.map(e=>({value:e,icon:e,labelKey:Et[e].labelKey})),{value:`none`,icon:`mdi:close-circle-outline`,labelKey:`header_exit_none`}];function Rn(e,t,n){let r=[];if(!e)return[{label:t,kind:`text`,name:t}];if(e.exit&&e.exit!==`none`){let t=Ln.find(t=>t.value===e.exit);r.push({label:``,icon:t?.icon??e.exit,kind:`icon`,name:t?n(t.labelKey):e.exit})}e.text&&r.push({label:e.text,kind:`text`,name:e.text});for(let t of In)e[t.key]&&r.push({label:``,icon:t.icon,kind:`icon`,name:n(t.labelKey)});for(let t of e.extra_icons??[])r.push({label:``,icon:t,kind:`icon`,name:t});for(let t of e.chips??[])r.push({label:t,kind:`chip`,name:t});return r.length||r.push({label:t,kind:`text`,name:t}),r}function zn(e,t){let n=(e.selected===`header_left`?e.left:e.right)??{},r=e.et(`header_slot_empty`),i=(n,r)=>t.patch(e.selected,n,r);return P`
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${Ln.map(t=>{let r=(n.exit??`none`)===t.value,a=e.et(t.labelKey);return P`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${In.map(t=>{let r=!!n[t.key],a=e.et(t.labelKey);return P`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?`true`:`false`}
                aria-label=${a}
  ...
  `}function Bn(e,t,n,r){let i=e===`header_left`?t.left:t.right,a=t.selected===e,o=Rn(i,r,t.et),s=t.et(e===`header_left`?`header_left`:`header_right`);return P`<button
    type="button"
  ...
  </button>`}function Vn(e,t,n){let r=e.chips??[],i=e.extra_icons??[];return P`
    <div class="wl-group">
      <span class="wl-label"
  ...
  `}function Hn(e,t){let n=e.filter((e,n)=>n!==t);return n.length?n:void 0}function Un(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Wn(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Gn(e,t){return e?.states?.[t]?.attributes}function Kn(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function qn(e,t){return!e.singleLine&&en(t.lines,t.picked).length>=2}function Jn(e,t,n,r){let i=Gn(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=pt(e),l=e=>Kt(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=tn(i),f=u.size?[...new Set([...d,...u])].sort():d,p=Yt(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return P`
    <section class="wl-section">
      <header class="wl-section-header">
      ...
      <div class="wl-stop-body">
        ...
        ${!a&&f.length?qn(n,{lines:f,picked:u})?Qn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):Zn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):I}
        ${a?I:$n(t,n,r,{attrs:i,picked:u,colorOf:l,lines:f,dirStrings:h})}
      </div>
    </section>
  `}function Yn(e,t,n){return P`
  ...
  `}function Xn(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return P`
    <div class="wl-group">
  ...
  `}function Zn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=en(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=$t(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>f.unknown||f.available.has(e)?Zt(Kn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,x=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return P`
    <div class="wl-group">
  ...
  </button>`}function Qn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=en(s,o),d=e.line_directions??{},f=e.direction??null,p=e=>d[e]??f,m=(t,r)=>{let i={};for(let e of u){let n=e===t?r:p(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return P`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=$t(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):Zt(Kn(a,n,e),l(n)));return P`
          <div class="wl-override-row">
            <span class="wl-badge" style=${W(Wn(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${X({label:l(`H`).short,active:r===`H`||r===null&&n.oneWay===`H`,disabled:!d&&!o,compact:!0,title:Kn(a,`H`,e).join(` / `)||t.t(`dir_h`),ariaLabel:f(`H`),onClick:()=>m(e,`H`)})}
              ${X({label:l(`R`).short,active:r===`R`||r===null&&n.oneWay===`R`,disabled:!d&&!s,compact:!0,title:Kn(a,`R`,e).join(` / `)||t.t(`dir_r`),ariaLabel:f(`R`),onClick:()=>m(e,`R`)})}
  ...
  `}function $n(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=rn(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?P`
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=qt(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return P`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${W(Wn(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:I}function er(e,t,n){let r={...e??{},[t]:n};return n===void 0&&delete r[t],r}function tr(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function nr(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let Q=class extends B{constructor(...e){super(...e),this._tab=`stops`,this._headerSide=`header_left`,this._pendingDirectionFix=!1,this._onEntityChanged=e=>{if(e.stopPropagation(),!this._config)return;let t=e.detail.value.entity,n=typeof t==`string`?t:void 0;if(n===this._config.entity)return;let r={...this._config,entity:n},i=this._availableDirections(n);i.size===1&&(r.direction=i.has(`H`)?`H`:`R`),r.line=Qt(this._attrs(n),r.direction)[0],this._commit(r)},this._computeLabel=e=>tr(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n;return nr(this._i18n,e.name,{...this._config?.message_ticker?{}:{message_text:t(`message_text_requires`)},...this._config?.show_platform?{}:{platform_side:t(`platform_side_requires`)}})}}setConfig(e){this._config=Wt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`)||e.has(`_headerSide`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._config.entity;return!n||t.states[n]!==this.hass.states[n]}willUpdate(e){(e.has(`_config`)||e.has(`hass`))&&this._scheduleDirectionAutocorrect()}get _i18n(){return kn(`retro`,this.hass?.language)}_attrs(e){return e?this.hass?.states?.[e]?.attributes:void 0}_commit(e){this._config=e,He(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Wt({...this._config,...e}))}get _stopView(){let e=this._config;return{entity:e.entity??``,lines:e.line?[e.line]:[],direction:e.direction,walk_times:e.walk_times}}get _stopCallbacks(){return{toggleLine:(e,t)=>{if(!this._config)return;let n={...this._config};n.line===t?delete n.line:n.line=t,this._commit(n)},setDirections:(e,t)=>{if(!this._config||t.direction===null)return;let n={...this._config,direction:t.direction},r=Qt(this._attrs(n.entity),t.direction);(!n.line||!r.includes(n.line))&&(n.line=r[0]),this._commit(n)},setWalkTime:(e,t,n)=>{if(!this._config)return;let r={...this._config.walk_times??{}};n===null?delete r[t]:r[t]=n;let i={...this._config};Object.keys(r).length?i.walk_times=r:delete i.walk_times,this._commit(i)}}}render(){if(!this._config)return I;let{et:e}=this._i18n;return P`
    ...
    `}_renderActiveTab(){switch(this._tab){case`stops`:return this._renderStop();case`display`:return this._renderDisplay();case`tweaks`:return this._renderTweaks()}}_renderStop(){let e=this._config,{t,et:n}=this._i18n;return P`
      ...
      ></ha-form>
      ${e.entity?Jn(this.hass,this._stopView,{index:1,total:1,singleLine:!0,lineColorOverrides:{},t,et:n},this._stopCallbacks):I}
    `}_renderDisplay(){let e=this._config,{et:t}=this._i18n,n={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return P`
      ${Mn({title:t(`section_header`),hint:t(`section_header_hint`)},P`
          <ha-form
            .hass=${this.hass}
          ...
          ></ha-form>
          ${e.show_header?zn({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,n)=>this._patchHeaderSide(e,t,n)}):I}
        `)}
