...
`;function kt(e,t,i){return K`
  ...
  `}function St(e){return $t(e,K`<ha-form
    ...
    <div class="wl-strip">
      <div class="wl-strip-bar" role="group" aria-label=${e.et("header_bar_aria")}>
        ${Ct("header_left",e,t,r)}
        ${Ct("header_right",e,t,r)}
      </div>
  ...
  `}function Ct(e,t,i,r){const n="header_left"===e?t.left:t.right,a=t.selected===e,o=function(e,t){const i=[];if(!e)return[{label:t,kind:"text"}];if(e.exit&&"none"!==e.exit){const t=Et.find(t=>t.value===e.exit);i.push({label:"",icon:t?.icon??e.exit,kind:"icon"})}e.text&&i.push({label:e.text,kind:"text"});for(const t of At)e[t.key]&&i.push({label:"",icon:t.icon,kind:"icon"});for(const t of e.extra_icons??[])i.push({label:"",icon:t,kind:"icon"});for(const t of e.chips??[])i.push({label:t,kind:"chip"});return i.length||i.push({label:t,kind:"text"}),i}(n,r);return K`<button
    type="button"
  ...
  `}(t,i,r,{lines:c,picked:d,colorOf:l,typeByLine:p})}
        ${!a&&c.length?function(e,t){return!e.singleLine&&Pt(t.lines,t.picked).length>=2}(i,{lines:c,picked:d})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,c=Pt(o,a),d=e.line_directions??{},h=e.direction??null,p=e=>d[e]??h,u=(t,r)=>{const n={};for(const e of c){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(d))c.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${c.map(e=>{const i=Ht(n,e),r=p(e),a=i.has("H"),o=i.has("R"),c=1===i.size,d=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):ot(Mt(n,i,e),l(i)));return K`
          <div class="wl-override-row">
            <span class="wl-badge" style=${Ae({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${Bt({label:l("H").short,active:"H"===r||null===r&&c&&a,disabled:!a,compact:!0,title:Mt(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:d("H"),onClick:()=>u(e,"H")})}
              ${Bt({label:l("R").short,active:"R"===r||null===r&&c&&o,disabled:!o,compact:!0,title:Mt(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:d("R"),onClick:()=>u(e,"R")})}
              ${Bt({label:"",icon:"mdi:swap-horizontal",active:null===r&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:d(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:h,picked:d,lines:c,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=Pt(o,a),c=1===l.length?l[0]:void 0,d=e.direction??null,h=Ht(n,c),p=h.has("H"),u=h.has("R"),_=1===h.size,g="H"===d||null===d&&_&&p,m="R"===d||null===d&&_&&u,f=null===d&&!_,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===h.size||h.has(e)?ot(Mt(n,e,c),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,y=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${Bt({label:b("H"),active:g,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${Bt({label:b("R"),active:m,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?V:Bt({label:t.t("dir_both"),active:f,disabled:_,title:_?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
...
(t,i,r,{attrs:n,picked:d,colorOf:l})}
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStop();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStop(){const e=this._config,{t:t,et:i}=this._i18n;return K`
      ...
      ></ha-form>
      ${e.entity?Wt(this.hass,this._stopView,{index:1,total:1,singleLine:!0,lineColorOverrides:{},t:t,et:i},this._stopCallbacks):V}
