...
function Ie(e,t,i){e.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}let Ke=class extends ae{constructor(){super(...arguments),this._pendingDirectionFix=!1,this._computeLabel=e=>{const t=`ui.panel.lovelace.editor.card.generic.${e.name}`,i=this.hass?.localize?.(t);if(i)return i;const r=this._et(e.name);if(r!==`retro.editor.${e.name}`&&r!==e.name)return r;const n=this._t(e.name);return n!==`retro.${e.name}`&&n!==e.name?n:e.name},this._computeHelper=e=>{const t=`${e.name}_helper`,i=this._et(t);if(i!==`retro.editor.${t}`&&i!==t)return i},this._onFormChanged=e=>{if(!this._config)return;const t=this._config.entity,i=e.detail.value,r=qe({...this._config,...i});if(r.entity!==t){const e=this._attrs(r.entity),t=r.direction,i=new Set;for(const r of e?.departures??[])r.direction===t&&r.line&&i.add(r.line);const n=[...i].sort();r.line=n[0]}this._config=r,Ie(this,"config-changed",{config:r})}}setConfig(e){this._config=qe(e)}_t(e){return Pe(`retro.${e}`,{hassLanguage:this.hass?.language})}_et(e){return Pe(`retro.editor.${e}`,{hassLanguage:this.hass?.language})}_attrs(e){return e?this.hass?.states?.[e]?.attributes:void 0}_linesForCurrent(){if(!this._config)return[];const e=this._attrs(this._config.entity),t=this._config.direction,i=new Set;for(const r of e?.departures??[])r.direction===t&&r.line&&i.add(r.line);return[...i].sort()}_terminiForDirection(e){const t=this._attrs(this._config?.entity);if(!t)return[];const i=this._config?.line,r=new Set;for(const n of t.departures??[])n.direction===e&&n.towards&&(i&&n.line!==i||r.add(n.towards));return[...r].sort()}_directionLabel(e){const t=this._terminiForDirection(e);if(!t.length)return this._t("H"===e?"dir_h":"dir_r");return`${this._t("H"===e?"dir_h_short":"dir_r_short")}: ${t.slice(0,3).join(" / ")}${t.length>3?" +"+(t.length-3):""}`}_availableDirections(){const e=this._attrs(this._config?.entity),t=new Set;for(const i of e?.departures??[])"H"!==i.direction&&"R"!==i.direction||t.add(i.direction);return t}_schema(){const e=this._linesForCurrent(),t=this._config?.line,i=(t&&!e.includes(t)?[t,...e]:e).map(e=>({value:e,label:e})),r=this._availableDirections(),n=[];return(0===r.size||r.has("H"))&&n.push({value:"H",label:this._directionLabel("H")}),(0===r.size||r.has("R"))&&n.push({value:"R",label:this._directionLabel("R")}),[{name:"entity",required:!0,selector:{entity:{domain:"sensor",integration:"wiener_linien_austria"}}},{name:"direction",selector:{select:{mode:"dropdown",options:n}}},{name:"line",selector:{select:{mode:"dropdown",custom_value:!0,options:i}}},{type:"expandable",name:"station",title:this._et("section_station"),flatten:!0,schema:[{name:"show_station_name",selector:{boolean:{}}},{name:"station_bg",selector:{select:{mode:"dropdown",options:[{value:"default",label:this._et("station_bg_default")},{value:"white",label:this._et("station_bg_white")},{value:"black",label:this._et("station_bg_black")}]}}}]},{type:"expandable",name:"display",title:this._et("section_display"),flatten:!0,schema:[{name:"show_platform",selector:{boolean:{}}},{name:"accessibility_only",selector:{boolean:{}}},{name:"flicker",selector:{boolean:{}}},{name:"wheelchair_race",selector:{boolean:{}}},{name:"size",selector:{select:{mode:"dropdown",options:[{value:"small",label:this._et("size_small")},{value:"medium",label:this._et("size_medium")},{value:"regular",label:this._et("size_regular")}]}}},{name:"style",selector:{select:{mode:"dropdown",options:[{value:"classic",label:this._et("style_classic")},{value:"warm",label:this._et("style_warm")},{value:"pixel",label:this._et("style_pixel")}]}}}]}]}_formData(){return this._config?{...this._config}:{}}_setWalkTime(e,t){if(!this._config)return;const i=parseInt(t,10),r=Number.isFinite(i)&&i>0?Math.min(120,i):null,n={...this._config.walk_times??{}};null===r?delete n[e]:n[e]=r;const s={...this._config};Object.keys(n).length?s.walk_times=n:delete s.walk_times,this._config=s,Ie(this,"config-changed",{config:s})}_swallowKeys(e){e.stopPropagation()}render(){return this._config?(this._scheduleDirectionAutocorrect(),j`
      ...
      <ha-card style="background:#000;padding:0;overflow:hidden;">
        <div
          ...
          <div class="retro-led">
            ...
            ${p||_||f?j`<div class="retro-finish-line" aria-hidden="true"></div>`:I}
  ...
  `}};e([ue({attribute:!1})],tt.prototype,"hass",void 0),e([pe()],tt.prototype,"_config",void 0),e([pe()],tt.prototype,"_versionMismatch",void 0),e([pe()],tt.prototype,"_raceState",void 0),e([pe()],tt.prototype,"_countdownDigit",void 0),e([pe()],tt.prototype,"_raceWinner",void 0),tt=e([ce("wiener-linien-austria-retro-card")],tt);export{tt as WienerLinienAustriaRetroCard};
