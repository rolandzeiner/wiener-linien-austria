    ...
    `}_renderWalkTimeSection(){const e=this._config,t=this._attrs(e.entity),i=e.entity?function(e){const t=[],i=new Set;for(const r of e?.departures??[]){const e=Ne(r.line,String(r.direction??""),r.towards);i.has(e)||(i.add(e),t.push({line:r.line,direction:String(r.direction??""),towards:r.towards,type:r.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}(t).filter(t=>t.direction===e.direction):[],r=e.walk_times??{};return j`
      <div class="editor-section">
        ...
        <div class="walk-time-list">
          ${i.length?i.map(e=>{const t=Ne(e.line,e.direction,e.towards),i=r[t];return j`
      ...
      <ha-card style="background:#000;padding:0;overflow:hidden;">
        <div
          ...
          <div class="retro-led">
            ...
            ${_||f||g?j`<div class="retro-finish-line" aria-hidden="true"></div>`:I}
            ${m?j`<div class="retro-victory" role="status" aria-live="polite">
                  <div class="retro-victory-flag" aria-hidden="true"></div>
                  ${null!==w?j`<div class="retro-victory-winner" aria-hidden="true">
