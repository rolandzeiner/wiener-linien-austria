...
`,Xe={exit:{kind:"svg",viewBox:"0 0 36.29 29.04",glyphPointsTo:"left",labelKey:"icon_exit",shapes:()=>K`
    ...
    `}};function Ye(e,t){const i=Xe[e];if("text"===i.kind)return F`<span class="retro-station-header__tile" role="img" aria-label=${t.ariaLabel}>
    ...
    >${i.shapes()}</svg>
  </span>`}const Je=[["A","A","B"],["B","B","A"],["A","B","B"],["B","A","A"],["A","B","A"],["B","A","B"]],et=[100,250],tt=[200,500],it=[500,900],rt=[.25,.5,.75],nt=[3,2.5,2.5];function st(e){const t=(e,t)=>e+Math.random()*(t-e),i=Math.random()<.5?"A":"B",r=Math.random()<.3?"A"===i?"B":"A":i,n=Je.filter(e=>e[2]===r),s=n[Math.floor(Math.random()*n.length)],a=Math.random(),o=a<.4?t(et[0],et[1]):a<.75?t(tt[0],tt[1]):t(it[0],it[1]),l=t(2400,2700),c=l+o,h=l*t(1.08,1.15),d=c*t(1.08,1.15),p="A"===i?h:d,u="B"===i?h:d,_="A"===i?l:c,f="B"===i?l:c,g=e.a,m=e.b,w=e.finishCqw,b=Math.max(g,m),y=Math.max(20,92-b),v=(e,t)=>{const i=b+rt[t]*y,r=s[t]===e,n=nt[t];return a=.6,i+(r?n:-n)+(2*Math.random()-1)*a;var a},x=v("A",0),$=v("A",1),k=v("A",2),S=v("B",0),A=v("B",1),z=v("B",2),E=(e,t,i)=>{const r=w-i,n=e-.75*t;if(r<=0||n<=1)return Math.max(i+5,102);const s=i+.25*r*t/n;return Math.max(102,Math.min(135,s))},C=E(_,p,k),R=E(f,u,z),L=(e,t,i,r,n,s)=>{const a=[[0,.25,e,t],[.25,.5,t,i],[.5,.75,i,r],[.75,1,r,n]];for(const[e,t,i,r]of a){if(i>=w)return e*s;if(r>=w){return(e+(w-i)/(r-i)*(t-e))*s}}return Number.POSITIVE_INFINITY},T=L(g,x,$,k,C,p),M=L(m,S,A,z,R,u);return{winner:T<=M?"A":"B",winnerCrossT:Math.min(T,M),cssVars:{"--race-a-duration":`${p}ms`,"--race-b-duration":`${u}ms`,"--race-a-end":C-g+"cqw","--race-b-end":R-m+"cqw","--race-a-x-25":x-g+"cqw","--race-a-x-50":$-g+"cqw","--race-a-x-75":k-g+"cqw","--race-b-x-25":S-m+"cqw","--race-b-x-50":A-m+"cqw","--race-b-x-75":z-m+"cqw"}}}const at=a`
  :host {
    display: block;
  }
  .editor {
...
let ot=class extends ce{constructor(){super(...arguments),this._pendingDirectionFix=!1,this._computeLabel=e=>function(e,t){const i=`ui.panel.lovelace.editor.card.generic.${e.name}`,r=t.hass?.localize?.(i);if(r)return r;const n=t.et(e.name);if(n!==`${t.editorNamespace}.${e.name}`&&n!==e.name)return n;if(t.cardLookup&&t.cardNamespace){const i=t.cardLookup(e.name);if(i!==`${t.cardNamespace}.${e.name}`&&i!==e.name)return i}return e.name}(e,{hass:this.hass,et:e=>this._et(e),editorNamespace:"retro.editor",cardLookup:e=>this._t(e),cardNamespace:"retro"}),this._computeHelper=e=>function(e,t){const i=`${e.name}_helper`,r=t.et(i);if(r!==`${t.editorNamespace}.${i}`&&r!==i)return r}(e,{et:e=>this._et(e),editorNamespace:"retro.editor"}),this._onFormChanged=e=>{if(!this._config)return;const t=this._config.entity,i=e.detail.value,r=Ke({...this._config,...i});if(r.entity!==t){const e=Ie(this._attrs(r.entity),r.direction);r.line=e[0]}this._config=r,Ae(this,"config-changed",{config:r})}}setConfig(e){this._config=Ke(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config"))return!0;const t=e.get("hass");if(!t||!this.hass)return!0;const i=this._config.entity;return!i||t.states[i]!==this.hass.states[i]}_t(e){return Pe(`retro.${e}`,{hassLanguage:this.hass?.language})}_et(e){return Pe(`retro.editor.${e}`,{hassLanguage:this.hass?.language})}_attrs(e){return e?this.hass?.states?.[e]?.attributes:void 0}_linesForCurrent(){return this._config?Ie(this._attrs(this._config.entity),this._config.direction):[]}_terminiForDirection(e){const t=this._attrs(this._config?.entity);if(!t)return[];const i=this._config?.line,r=new Set;for(const n of t.departures??[])n.direction===e&&n.towards&&(i&&n.line!==i||r.add(n.towards));return[...r].sort()}_directionLabel(e){return function(e,t){if(!e.length)return t.full;const i=e.slice(0,3).join(" / "),r=e.length>3?" +"+(e.length-3):"";return`${t.short}: ${i}${r}`}(this._terminiForDirection(e),{full:this._t("H"===e?"dir_h":"dir_r"),short:this._t("H"===e?"dir_h_short":"dir_r_short")})}_availableDirections(){const e=this._attrs(this._config?.entity),t=new Set;if(e?.tracked_line_keys?.length){for(const i of e.tracked_line_keys){const[,e]=i.split("|",2);"H"!==e&&"R"!==e||t.add(e)}if(t.size>0)return t}for(const i of e?.departures??[])"H"!==i.direction&&"R"!==i.direction||t.add(i.direction);return t}_schema(){const e=this._linesForCurrent(),t=this._config?.line,i=(t&&!e.includes(t)?[t,...e]:e).map(e=>({value:e,label:e})),r=this._availableDirections(),n=[];return(0===r.size||r.has("H"))&&n.push({value:"H",label:this._directionLabel("H")}),(0===r.size||r.has("R"))&&n.push({value:"R",label:this._directionLabel("R")}),[{name:"entity",required:!0,selector:{entity:{domain:"sensor",integration:"wiener_linien_austria"}}},{name:"direction",selector:{select:{mode:"dropdown",options:n}}},{name:"line",selector:{select:{mode:"dropdown",custom_value:!0,options:i}}},{type:"expandable",name:"header",title:this._et("section_header"),flatten:!0,schema:[{type:"expandable",name:"header_left",title:this._et("header_left"),flatten:!1,schema:[{name:"exit",selector:{select:{mode:"dropdown",options:[{value:"none",label:this._et("header_exit_none")},{value:"regular",label:this._et("header_exit_regular")},{value:"accessible",label:this._et("header_exit_accessible")}]}}},{name:"text",selector:{text:{}}},{name:"show_wc",selector:{boolean:{}}},{name:"show_escalator",selector:{boolean:{}}},{name:"show_elevator",selector:{boolean:{}}}]},{type:"expandable",name:"header_right",title:this._et("header_right"),flatten:!1,schema:[{name:"exit",selector:{select:{mode:"dropdown",options:[{value:"none",label:this._et("header_exit_none")},{value:"regular",label:this._et("header_exit_regular")},{value:"accessible",label:this._et("header_exit_accessible")}]}}},{name:"text",selector:{text:{}}},{name:"show_wc",selector:{boolean:{}}},{name:"show_escalator",selector:{boolean:{}}},{name:"show_elevator",selector:{boolean:{}}}]}]},{type:"expandable",name:"station",title:this._et("section_station"),flatten:!0,schema:[{name:"show_station_name",selector:{boolean:{}}},{name:"station_bg",selector:{select:{mode:"list",options:[{value:"default",label:this._et("station_bg_default")},{value:"white",label:this._et("station_bg_white")},{value:"black",label:this._et("station_bg_black")}]}}}]},{type:"expandable",name:"display",title:this._et("section_display"),flatten:!0,schema:[{name:"show_platform",selector:{boolean:{}}},{name:"accessibility_only",selector:{boolean:{}}},{name:"flicker",selector:{boolean:{}}},{name:"wheelchair_race",selector:{boolean:{}}},{type:"grid",name:"",schema:[{name:"size",selector:{select:{mode:"list",options:[{value:"small",label:this._et("size_small")},{value:"medium",label:this._et("size_medium")},{value:"regular",label:this._et("size_regular")}]}}},{name:"style",selector:{select:{mode:"list",options:[{value:"classic",label:this._et("style_classic")},{value:"warm",label:this._et("style_warm")},{value:"pixel",label:this._et("style_pixel")}]}}}]}]}]}_formData(){return this._config?{...this._config}:{}}_setWalkTime(e,t){if(!this._config)return;const i=parseInt(t,10),r=Number.isFinite(i)&&i>0?Math.min(120,i):null,n={...this._config.walk_times??{}};null===r?delete n[e]:n[e]=r;const s={...this._config};Object.keys(n).length?s.walk_times=n:delete s.walk_times,this._config=s,Ae(this,"config-changed",{config:s})}_swallowKeys(e){e.stopPropagation()}render(){if(!this._config)return I;this._scheduleDirectionAutocorrect();const e=this._config,t=!!e.entity&&!this.hass?.states?.[e.entity];return F`
    ...
    `:I}_renderHeaderSide(e,t){const i="regular"===e.exit?"exit":"accessible"===e.exit?"exit-access":null,r=i?Ye(i,{ariaLabel:this._t(`header.${Xe[i].labelKey}`),flipX:Xe[i].glyphPointsTo!==t}):I,n=e.text?F`<span class="retro-station-header__text">${e.text}</span>`:I,s=e=>Ye(e,{ariaLabel:this._t(`header.${Xe[e].labelKey}`)}),a=e.show_wc?s("wc"):I,o=e.show_escalator?s("escalator"):I,l=e.show_elevator?s("elevator"):I;return"left"===t?F`${r}${n}${l}${o}${a}`:F`${a}${o}${l}${n}${r}`}_renderStationName(e,t,i,r,n,s){let a,o;if("white"===r)a="#fff",o="#000";else if("black"===r)a="#000",o="#fff";else{const e=t.length?t:i,r=s||e[0]?.line;if(r){const e=function(e,t,i={},r="var(--primary-color)"){const n=e.toUpperCase();if(void 0!==t[n])return{background:t[n]};if(/^N\d/.test(n))return{background:"#1b1464",color:"#fef200"};const s=i[e]??i[n];return s?.bg?s.fg?{background:`#${s.bg}`,color:`#${s.fg}`}:{background:`#${s.bg}`}:{background:r}}(r,{},n);a=e.background,o=e.color??"#fff","var(--primary-color)"===a&&(a="#fff",o="#000")}else a="#fff",o="#000"}return F`
  ...
  `}};e([_e({attribute:!1})],ct.prototype,"hass",void 0),e([fe()],ct.prototype,"_config",void 0),e([fe()],ct.prototype,"_versionMismatch",void 0),e([fe()],ct.prototype,"_raceState",void 0),e([fe()],ct.prototype,"_countdownDigit",void 0),e([fe()],ct.prototype,"_raceWinner",void 0),ct=e([de("wiener-linien-austria-retro-card")],ct);export{ct as WienerLinienAustriaRetroCard};
