...
`;function kt(e,t,i){return K`
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${Tt.map(t=>{const r=(i.exit??"none")===t.value,a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${Et.map(t=>{const r=Boolean(i[t.key]),a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?"true":"false"}
                aria-label=${a}
  ...
  `}function Lt(e,t,i,r){const n="header_left"===e?t.left:t.right,a=t.selected===e,o=function(e,t){const i=[];if(!e)return[{label:t,kind:"text"}];if(e.exit&&"none"!==e.exit){const t=Tt.find(t=>t.value===e.exit);i.push({label:"",icon:t?.icon??e.exit,kind:"icon"})}e.text&&i.push({label:e.text,kind:"text"});for(const t of Et)e[t.key]&&i.push({label:"",icon:t.icon,kind:"icon"});for(const t of e.extra_icons??[])i.push({label:"",icon:t,kind:"icon"});for(const t of e.chips??[])i.push({label:t,kind:"chip"});return i.length||i.push({label:t,kind:"text"}),i}(n,r);return K`<button
    type="button"
  ...
  `}
    ...
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return K`
      ${$t({title:t("section_header"),hint:t("section_header_hint")},K`
          ...
          ></ha-form>
          ${e.show_header?Ct({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,i)=>this._patchHeaderSide(e,t,i)}):V}
        `)}
