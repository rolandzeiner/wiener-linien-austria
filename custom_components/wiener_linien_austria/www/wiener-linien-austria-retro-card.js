  ...
  `}const Ke={retro:!1},Ie={retro:!1},Fe={retro:"regular"},Ve={retro:!1},Ge={retro:"default"},Ye={retro:!0},Ze=2,Xe={exit:{kind:"svg",viewBox:"0 0 36.29 29.04",glyphPointsTo:"left",labelKey:"icon_exit",shapes:()=>I`
    ...
    <ha-icon class="retro-station-header__mdi" icon=${e}></ha-icon>
      ...
      >
        ...
        ></ha-icon>
        <span>${m}</span>
      </span>`:V,f=e.show_date?$t(i,e.date_format??"d.m.Y",n):null,w=f?K`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${f}</span
      >`:V;return"left"===t?K`${a}${o}${d}${c}${l}${h}${u}${w}${g}`:K`${g}${w}${_}${p}${l}${c}${d}${o}${a}`}const zt=[["A","A","B"],["B","B","A"],["A","B","B"],["B","A","A"],["A","B","A"],["B","A","B"]],At=[100,250],Et=[200,500],Tt=[500,900],Ct=[.25,.5,.75],Lt=[3,2.5,2.5];function Rt(e){const t=(e,t)=>e+Math.random()*(t-e),i=Math.random()<.5?"A":"B",r=Math.random()<.3?"A"===i?"B":"A":i,n=zt.filter(e=>e[2]===r),a=n[Math.floor(Math.random()*n.length)],o=Math.random(),s=o<.4?t(At[0],At[1]):o<.75?t(Et[0],Et[1]):t(Tt[0],Tt[1]),l=t(2400,2700),c=l+s,d=l*t(1.08,1.15),h=c*t(1.08,1.15),p="A"===i?d:h,u="B"===i?d:h,_="A"===i?l:c,m="B"===i?l:c,g=e.a,f=e.b,w=e.finishCqw,b=Math.max(g,f),y=Math.max(20,92-b),v=(e,t)=>{const i=b+Ct[t]*y,r=a[t]===e,n=Lt[t];return o=.6,i+(r?n:-n)+(2*Math.random()-1)*o;var o},x=v("A",0),k=v("A",1),$=v("A",2),S=v("B",0),z=v("B",1),A=v("B",2),E=(e,t,i)=>{const r=w-i,n=e-.75*t;if(r<=0||n<=1)return Math.max(i+5,102);const a=i+.25*r*t/n;return Math.max(102,Math.min(135,a))},T=E(_,p,$),C=E(m,u,A),L=(e,t,i,r,n,a)=>{const o=[[0,.25,e,t],[.25,.5,t,i],[.5,.75,i,r],[.75,1,r,n]];for(const[e,t,i,r]of o){if(i>=w)return e*a;if(r>=w){return(e+(w-i)/(r-i)*(t-e))*a}}return Number.POSITIVE_INFINITY},R=L(g,x,k,$,T,p),D=L(f,S,z,A,C,u);return{winner:R<=D?"A":"B",winnerCrossT:Math.min(R,D),cssVars:{"--race-a-duration":`${p}ms`,"--race-b-duration":`${u}ms`,"--race-a-end":T-g+"cqw","--race-b-end":C-f+"cqw","--race-a-x-25":x-g+"cqw","--race-a-x-50":k-g+"cqw","--race-a-x-75":$-g+"cqw","--race-b-x-25":S-f+"cqw","--race-b-x-50":z-f+"cqw","--race-b-x-75":A-f+"cqw"}}}const Dt=o`
  :host {
    display: block;
  }
...
`;function Ht(e,t,i){return K`
  ...
  `}function Wt(e){return Pt(e,K`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
    ...
    ></ha-form>`)}const Bt=be(class extends ye{constructor(e){if(super(e),e.type!==fe&&e.type!==ge&&e.type!==we)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===F||t===V)return t;const i=e.element,r=e.name;if(e.type===fe){if(t===i[r])return F}else if(e.type===we){if(!!t===i.hasAttribute(r))return F}else if(e.type===ge&&i.getAttribute(r)===t+"")return F;return ke(e),t}});function Nt(e){e.stopPropagation()}const Ot=[{key:"show_wc",icon:"mdi:human-male-female",labelKey:"show_wc_short"},{key:"show_escalator",icon:"mdi:escalator",labelKey:"show_escalator_short"},{key:"show_elevator",icon:"mdi:elevator",labelKey:"show_elevator_short"},{key:"show_clock",icon:"mdi:clock-outline",labelKey:"show_clock_short"},{key:"show_date",icon:"mdi:calendar",labelKey:"show_date_short"}],qt=[{value:"regular",icon:"mdi:exit-run",labelKey:"header_exit_regular"},{value:"accessible",icon:"mdi:wheelchair-accessibility",labelKey:"header_exit_accessible"},...Qe.map(e=>({value:e,icon:e,labelKey:Je[e].labelKey})),{value:"none",icon:"mdi:close-circle-outline",labelKey:"header_exit_none"}];function jt(e,t){const i=("header_left"===e.selected?e.left:e.right)??{},r=e.et("header_slot_empty"),n=(i,r)=>t.patch(e.selected,i,r);return K`
    <div class="wl-strip">
      <div class="wl-strip-bar" role="group" aria-label=${e.et("header_bar_aria")}>
        ${Ut("header_left",e,t,r)}
        ${Ut("header_right",e,t,r)}
      </div>
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${qt.map(t=>{const r=(i.exit??"none")===t.value,a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${Ot.map(t=>{const r=Boolean(i[t.key]),a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?"true":"false"}
                aria-label=${a}
  ...
  `}function Ut(e,t,i,r){const n="header_left"===e?t.left:t.right,a=t.selected===e,o=function(e,t){const i=[];if(!e)return[{label:t,kind:"text"}];if(e.exit&&"none"!==e.exit){const t=qt.find(t=>t.value===e.exit);i.push({label:"",icon:t?.icon??e.exit,kind:"icon"})}e.text&&i.push({label:e.text,kind:"text"});for(const t of Ot)e[t.key]&&i.push({label:"",icon:t.icon,kind:"icon"});for(const t of e.extra_icons??[])i.push({label:"",icon:t,kind:"icon"});for(const t of e.chips??[])i.push({label:t,kind:"chip"});return i.length||i.push({label:t,kind:"text"}),i}(n,r);return K`<button
    type="button"
  ...
  `}(t,i,r):V}
    ...
    <div class="wl-group">
      ...
      ${n.length?K`<div class="wl-chips">
            ${n.map(r=>{const n=t.singleLine?a.has(r):0===a.size||a.has(r),l=function(e){switch(e){case yt:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}(s.get(r));return K`<button
                type="button"
                class="wl-chip"
  ...
  `}(t,i,r,{lines:c,picked:d,colorOf:l,typeByLine:p})}
        ${!a&&c.length?function(e,t){return!e.singleLine&&Gt(t.lines,t.picked).length>=2}(i,{lines:c,picked:d})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,c=Gt(o,a),d=e.line_directions??{},h=e.direction??null,p=e=>d[e]??h,u=(t,r)=>{const n={};for(const e of c){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(d))c.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${c.map(e=>{const i=Vt(n,e),r=p(e),a=i.has("H"),o=i.has("R"),c=1===i.size,d=0===i.size,h=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):gt(Ft(n,i,e),l(i)));return K`
          <div class="wl-override-row">
            <span class="wl-badge" style=${Ae({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${Zt({label:l("H").short,active:"H"===r||null===r&&c&&a,disabled:!d&&!a,compact:!0,title:Ft(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:h("H"),onClick:()=>u(e,"H")})}
              ${Zt({label:l("R").short,active:"R"===r||null===r&&c&&o,disabled:!d&&!o,compact:!0,title:Ft(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:h("R"),onClick:()=>u(e,"R")})}
              ${Zt({label:"",icon:"mdi:swap-horizontal",active:null===r&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:h(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:h,picked:d,lines:c,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=Gt(o,a),c=1===l.length?l[0]:void 0,d=e.direction??null,h=Vt(n,c),p=h.has("H"),u=h.has("R"),_=1===h.size,m="H"===d||null===d&&_&&p,g="R"===d||null===d&&_&&u,f=null===d&&!_,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===h.size||h.has(e)?gt(Ft(n,e,c),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,y=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${Zt({label:b("H"),active:m,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${Zt({label:b("R"),active:g,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?V:Zt({label:t.t("dir_both"),active:f,disabled:_,title:_?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
      ${y?K`<span class="wl-note">${y}</span>`:V}
    </div>
  `}(t,i,r,{triplets:h,picked:d,lines:c,dirStrings:u}):V}
        ${a?V:function(e,t,i,r){const{attrs:n,picked:a,colorOf:o,lines:s,dirStrings:l}=r,c=e.line_directions??{},d=e.direction??null,h=bt(n,{lines:s,picked:a,lineDirections:c,stopDirection:d});return h.length?K`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${h.map(r=>{const n=mt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.length?r.termini.join(" / "):"H"===r.direction||"R"===r.direction?l(r.direction).full:"",c=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),d=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(It,r))};return K`
...
(t,i,r,{attrs:n,picked:d,colorOf:l,lines:c,dirStrings:u})}
      </div>
    </section>
  ...
  `}
    ...
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return K`
      ${Pt({title:t("section_header"),hint:t("section_header_hint")},K`
          <ha-form
            .hass=${this.hass}
          ...
          ></ha-form>
          ${e.show_header?jt({left:e.header_left,right:e.header_right,selected:this._headerSide,et:t},{selectSide:e=>{this._headerSide=e},patch:(e,t,i)=>this._patchHeaderSide(e,t,i)}):V}
        `)}
      ...
      ${Wt({...i,title:t("section_extras"),hint:t("section_extras_hint"),data:{message_ticker:e.message_ticker,message_text:e.message_text??"",wheelchair_race:e.wheelchair_race},schema:[{name:"message_ticker",selector:{boolean:{}}},{name:"message_text",disabled:!e.message_ticker,selector:{text:{}}},{name:"wheelchair_race",selector:{boolean:{}}}]})}
  ...
  `}};e([_e({attribute:!1})],ei.prototype,"hass",void 0),e([me()],ei.prototype,"_config",void 0),e([me()],ei.prototype,"_versionMismatch",void 0),e([me()],ei.prototype,"_raceState",void 0),e([me()],ei.prototype,"_countdownDigit",void 0),e([me()],ei.prototype,"_raceWinner",void 0),e([me()],ei.prototype,"_tickerActive",void 0),e([me()],ei.prototype,"_viaPhase",void 0),ei=e([he("wiener-linien-austria-retro-card")],ei);export{ei as WienerLinienAustriaRetroCard};
