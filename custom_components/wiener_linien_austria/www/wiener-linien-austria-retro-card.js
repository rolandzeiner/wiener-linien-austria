  ...
  `}const Ke={retro:!1},Ie={retro:!1},Fe={retro:"regular"},Ve={retro:!1},Ge={retro:"default"},Ye={retro:!0},Ze=2,Xe={exit:{kind:"svg",viewBox:"0 0 36.29 29.04",glyphPointsTo:"left",labelKey:"icon_exit",shapes:()=>I`
    ...
    <ha-icon class="retro-station-header__mdi" icon=${e}></ha-icon>
      ...
      >
        ...
        ></ha-icon>
        <span>${g}</span>
      </span>`:V,f=e.show_date?kt(i,e.date_format??"d.m.Y",n):null,w=f?K`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${f}</span
      >`:V;return"left"===t?K`${a}${o}${d}${c}${l}${h}${u}${w}${m}`:K`${m}${w}${_}${p}${l}${c}${d}${o}${a}`}const St=[["A","A","B"],["B","B","A"],["A","B","B"],["B","A","A"],["A","B","A"],["B","A","B"]],zt=[100,250],At=[200,500],Et=[500,900],Tt=[.25,.5,.75],Ct=[3,2.5,2.5];function Lt(e){const t=(e,t)=>e+Math.random()*(t-e),i=Math.random()<.5?"A":"B",r=Math.random()<.3?"A"===i?"B":"A":i,n=St.filter(e=>e[2]===r),a=n[Math.floor(Math.random()*n.length)],o=Math.random(),s=o<.4?t(zt[0],zt[1]):o<.75?t(At[0],At[1]):t(Et[0],Et[1]),l=t(2400,2700),c=l+s,d=l*t(1.08,1.15),h=c*t(1.08,1.15),p="A"===i?d:h,u="B"===i?d:h,_="A"===i?l:c,g="B"===i?l:c,m=e.a,f=e.b,w=e.finishCqw,b=Math.max(m,f),y=Math.max(20,92-b),v=(e,t)=>{const i=b+Tt[t]*y,r=a[t]===e,n=Ct[t];return o=.6,i+(r?n:-n)+(2*Math.random()-1)*o;var o},x=v("A",0),k=v("A",1),$=v("A",2),S=v("B",0),z=v("B",1),A=v("B",2),E=(e,t,i)=>{const r=w-i,n=e-.75*t;if(r<=0||n<=1)return Math.max(i+5,102);const a=i+.25*r*t/n;return Math.max(102,Math.min(135,a))},T=E(_,p,$),C=E(g,u,A),L=(e,t,i,r,n,a)=>{const o=[[0,.25,e,t],[.25,.5,t,i],[.5,.75,i,r],[.75,1,r,n]];for(const[e,t,i,r]of o){if(i>=w)return e*a;if(r>=w){return(e+(w-i)/(r-i)*(t-e))*a}}return Number.POSITIVE_INFINITY},R=L(m,x,k,$,T,p),D=L(f,S,z,A,C,u);return{winner:R<=D?"A":"B",winnerCrossT:Math.min(R,D),cssVars:{"--race-a-duration":`${p}ms`,"--race-b-duration":`${u}ms`,"--race-a-end":T-m+"cqw","--race-b-end":C-f+"cqw","--race-a-x-25":x-m+"cqw","--race-a-x-50":k-m+"cqw","--race-a-x-75":$-m+"cqw","--race-b-x-25":S-f+"cqw","--race-b-x-50":z-f+"cqw","--race-b-x-75":A-f+"cqw"}}}const Rt=o`
  :host {
    display: block;
  }
...
`;function Mt(e,t,i){return K`
  ...
  `}function Pt(e){return Ht(e,K`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
    ...
    ></ha-form>`)}const Wt=be(class extends ye{constructor(e){if(super(e),e.type!==fe&&e.type!==me&&e.type!==we)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===F||t===V)return t;const i=e.element,r=e.name;if(e.type===fe){if(t===i[r])return F}else if(e.type===we){if(!!t===i.hasAttribute(r))return F}else if(e.type===me&&i.getAttribute(r)===t+"")return F;return ke(e),t}});function Bt(e){e.stopPropagation()}const Nt=[{key:"show_wc",icon:"mdi:human-male-female",labelKey:"show_wc_short"},{key:"show_escalator",icon:"mdi:escalator",labelKey:"show_escalator_short"},{key:"show_elevator",icon:"mdi:elevator",labelKey:"show_elevator_short"},{key:"show_clock",icon:"mdi:clock-outline",labelKey:"show_clock_short"},{key:"show_date",icon:"mdi:calendar",labelKey:"show_date_short"}],Ot=[{value:"regular",icon:"mdi:exit-run",labelKey:"header_exit_regular"},{value:"accessible",icon:"mdi:wheelchair-accessibility",labelKey:"header_exit_accessible"},...Qe.map(e=>({value:e,icon:e,labelKey:Je[e].labelKey})),{value:"none",icon:"mdi:close-circle-outline",labelKey:"header_exit_none"}];function qt(e,t){const i=("header_left"===e.selected?e.left:e.right)??{},r=e.et("header_slot_empty"),n=(i,r)=>t.patch(e.selected,i,r);return K`
    <div class="wl-strip">
      <div class="wl-strip-bar" role="group" aria-label=${e.et("header_bar_aria")}>
        ${jt("header_left",e,t,r)}
        ${jt("header_right",e,t,r)}
      </div>
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${Ot.map(t=>{const r=(i.exit??"none")===t.value,a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${Nt.map(t=>{const r=Boolean(i[t.key]),a=e.et(t.labelKey);return K`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?"true":"false"}
                aria-label=${a}
  ...
  `}function jt(e,t,i,r){const n="header_left"===e?t.left:t.right,a=t.selected===e,o=function(e,t){const i=[];if(!e)return[{label:t,kind:"text"}];if(e.exit&&"none"!==e.exit){const t=Ot.find(t=>t.value===e.exit);i.push({label:"",icon:t?.icon??e.exit,kind:"icon"})}e.text&&i.push({label:e.text,kind:"text"});for(const t of Nt)e[t.key]&&i.push({label:"",icon:t.icon,kind:"icon"});for(const t of e.extra_icons??[])i.push({label:"",icon:t,kind:"icon"});for(const t of e.chips??[])i.push({label:t,kind:"chip"});return i.length||i.push({label:t,kind:"text"}),i}(n,r);return K`<button
    type="button"
  ...
  `}(t,i,r):V}
    ...
    <div class="wl-group">
      ...
      ${n.length?K`<div class="wl-chips">
            ${n.map(r=>{const n=t.singleLine?a.has(r):0===a.size||a.has(r),l=function(e){switch(e){case bt:return"mdi:subway-variant";case"ptTram":return"mdi:tram";case"ptBusCity":case"ptBusNight":return"mdi:bus";default:return null}}(s.get(r));return K`<button
                type="button"
                class="wl-chip"
  ...
  `}(t,i,r,{lines:c,picked:d,colorOf:l,typeByLine:p})}
        ${!a&&c.length?function(e,t){return!e.singleLine&&Vt(t.lines,t.picked).length>=2}(i,{lines:c,picked:d})?function(e,t,i,r){const{triplets:n,picked:a,lines:o,colorOf:s,dirStrings:l}=r,c=Vt(o,a),d=e.line_directions??{},h=e.direction??null,p=e=>d[e]??h,u=(t,r)=>{const n={};for(const e of c){const i=e===t?r:p(e);i&&(n[e]=i)}for(const[e,t]of Object.entries(d))c.includes(e)||(n[e]=t);i.setDirections(e.entity,{direction:null,lineDirections:n})};return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      ${c.map(e=>{const i=Ft(n,e),r=p(e),a=i.has("H"),o=i.has("R"),c=1===i.size,d=i=>t.et("per_line_direction_aria").replace("{line}",e).replace("{direction}",null===i?t.t("dir_both"):mt(It(n,i,e),l(i)));return K`
          <div class="wl-override-row">
            <span class="wl-badge" style=${Ae({background:s(e)})}
              >${e}</span
            >
            <div class="wl-dirs">
              ${Yt({label:l("H").short,active:"H"===r||null===r&&c&&a,disabled:!a,compact:!0,title:It(n,"H",e).join(" / ")||t.t("dir_h"),ariaLabel:d("H"),onClick:()=>u(e,"H")})}
              ${Yt({label:l("R").short,active:"R"===r||null===r&&c&&o,disabled:!o,compact:!0,title:It(n,"R",e).join(" / ")||t.t("dir_r"),ariaLabel:d("R"),onClick:()=>u(e,"R")})}
              ${Yt({label:"",icon:"mdi:swap-horizontal",active:null===r&&!c,disabled:c,compact:!0,title:t.t("dir_both"),ariaLabel:d(null),onClick:()=>u(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}(t,i,r,{triplets:h,picked:d,lines:c,colorOf:l,dirStrings:u}):function(e,t,i,r){const{triplets:n,picked:a,lines:o,dirStrings:s}=r,l=Vt(o,a),c=1===l.length?l[0]:void 0,d=e.direction??null,h=Ft(n,c),p=h.has("H"),u=h.has("R"),_=1===h.size,g="H"===d||null===d&&_&&p,m="R"===d||null===d&&_&&u,f=null===d&&!_,w=t=>{const r={};for(const[t,i]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=i);i.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>0===h.size||h.has(e)?mt(It(n,e,c),s(e)):`${s(e).short}: ${t.et("direction_not_served")}`,y=!u&&l.length?t.et("direction_note_one_way").replace("{line}",l[0]??""):"";return K`
    <div class="wl-group">
      <span class="wl-label">${t.et("direction_label")}</span>
      <div class="wl-dirs">
        ${Yt({label:b("H"),active:g,disabled:!p,title:p?t.t("dir_h"):t.et("direction_unavailable"),onClick:()=>w("H")})}
        ${Yt({label:b("R"),active:m,disabled:!u,title:u?t.t("dir_r"):t.et("direction_unavailable"),onClick:()=>w("R")})}
        ${t.singleLine?V:Yt({label:t.t("dir_both"),active:f,disabled:_,title:_?t.et("direction_unavailable"):t.t("dir_both"),onClick:()=>w(null)})}
      </div>
      ${y?K`<span class="wl-note">${y}</span>`:V}
    </div>
  `}(t,i,r,{triplets:h,picked:d,lines:c,dirStrings:u}):V}
        ${a?V:function(e,t,i,r){const{attrs:n,picked:a,colorOf:o}=r,s=e.line_directions??{},l=e.direction??null,c=function(e){const t=new Map;for(const i of e?.departures??[]){const e=String(i.direction??""),r=gt(i.line,e);let n=t.get(r);n||(n={line:i.line,direction:e,type:i.type,termini:[]},t.set(r,n)),i.towards&&!n.termini.includes(i.towards)&&n.termini.push(i.towards)}const i=Array.from(t.values());return i.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),i}(n).filter(e=>{if(a.size>0&&!a.has(e.line))return!1;const t=s[e.line]??l;return!t||e.direction===t});return c.length?K`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${c.map(r=>{const n=gt(r.line,r.direction),a=e.walk_times?.[n],s=r.termini.join(" / "),l=t.et("walk_time_aria").replace("{line}",r.line).replace("{towards}",s),c=t=>{const r=(a??0)+t;i.setWalkTime(e.entity,n,r<1?null:Math.min(Kt,r))};return K`
...
(t,i,r,{attrs:n,picked:d,colorOf:l})}
  ...
  `}
    ...
    `;var t,i}_renderActiveTab(){switch(this._tab){case"stops":return this._renderStop();case"display":return this._renderDisplay();case"tweaks":return this._renderTweaks()}}_renderStop(){const e=this._config,{t:t,et:i}=this._i18n;return K`
      ...
      ></ha-form>
      ${e.entity?Gt(this.hass,this._stopView,{index:1,total:1,singleLine:!0,lineColorOverrides:{},t:t,et:i},this._stopCallbacks):V}
    `}_renderDisplay(){const e=this._config,{et:t}=this._i18n,i={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return K`
      ${Ht({title:t("section_header"),hint:t("section_header_hint")},K`
          <ha-form
            .hass=${this.hass}
  ...
  `}};e([_e({attribute:!1})],Jt.prototype,"hass",void 0),e([ge()],Jt.prototype,"_config",void 0),e([ge()],Jt.prototype,"_versionMismatch",void 0),e([ge()],Jt.prototype,"_raceState",void 0),e([ge()],Jt.prototype,"_countdownDigit",void 0),e([ge()],Jt.prototype,"_raceWinner",void 0),e([ge()],Jt.prototype,"_tickerActive",void 0),e([ge()],Jt.prototype,"_viaPhase",void 0),Jt=e([he("wiener-linien-austria-retro-card")],Jt);export{Jt as WienerLinienAustriaRetroCard};
